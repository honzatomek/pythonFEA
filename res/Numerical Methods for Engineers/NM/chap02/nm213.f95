PROGRAM nm213
!---Stabilized Bi-Conjugate Gradients for Unsymmetrical Systems
 USE nm_lib
 USE precision
 IMPLICIT NONE
 ...
 REAL(iwp),ALLOCATABLE::a(:,:),b(:),p(:),r(:),r0_hat(:),s(:),t(:),v(:),x(:)
 OPEN(10,FILE='nm95.dat')
 OPEN(11,FILE='nm95.res')
 READ(10,*)n
 ALLOCATE(x(n),v(n),r(n),b(n),r0_hat(n),p(n),s(n),t(n),a(n,n))
 READ(10,*)a
 READ(10,*)b
 READ(10,*)x,tol,limit
 WRITE(11,'(A)')"---Stabilized Bi-Conjugate Gradients---"
