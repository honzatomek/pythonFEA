...
class Geometry:
    ...
    def __init__(self, dictionary: list, gdls: list, types: list, nvn: int = 1, regions: list = None,
                 fast=False) -> None:
    ...
    def addRegions(self, regions: list) -> None:
...
class Geometry3D(Geometry):
    ...
    def __init__(self, dictionary: list, gdls: list, types: list, nvn: int = 1, regions: list = None, fast=False):
        """Creates a 2D geometry
