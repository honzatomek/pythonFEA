...
int ode_jac ( double t, const double y[], double *dfdy, double dfdt[], 
  void *params );
void timestamp ( );
...
/*
  Purpose:
    ...
    midpoint_gl_test() demonstrates the GSL midpoint ODE solver.
...
/*
  Purpose:
    ...
    ode_func() evaluates the right hand side of the ODE.
...
/*
  Purpose:
    ...
    ode_jac() evaluates the jacobian of the ODE.
