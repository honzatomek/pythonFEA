...
/*
  func() calculates the forces and accelerations.
  ...
  t, time
  yxx, input state: velocity and position
  v, output: calculated acceleration, copy of input velocity
*/
{
int i, j, k;
int ii, jj;
