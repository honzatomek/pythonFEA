...
*/
{
  ...
  int step_num = 630;
  double t;
  char t_filename[] = "three_body_ode_t.txt";
  double t_out;
  double t_start;
  double t_stop;
  double *ts;
  double *y;
  char y_filename[] = "three_body_ode_y.txt";
  double *yp;
  double *ys;
  ...
  for ( step = 1; step <= step_num; step++ )
  {
    ...
    {
      printf ( "\n" );
      printf ( "three_body_ode_RUN - Warning\n" );
