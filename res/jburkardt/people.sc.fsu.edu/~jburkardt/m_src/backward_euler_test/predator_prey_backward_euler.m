function predator_prey_backward_euler ( tspan, p0, n )

%*****************************************************************************80
%
%% predator_prey_backward_euler(): solve using backward_euler.
%
%  Discussion:
%
...
%
  fprintf ( 1, '\n' );
  fprintf ( 1, 'predator_prey_backward_euler():\n' );
...
%
  ...
  xlabel ( 'Rabbits' );
  ylabel ( 'Foxes' );
  title ( 'predator prey backward Euler: phase' )
