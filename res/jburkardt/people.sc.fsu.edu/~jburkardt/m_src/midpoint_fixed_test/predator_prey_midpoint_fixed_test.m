function predator_prey_midpoint_fixed_test ( tspan, p0, n )

%*****************************************************************************80
%
%% predator_prey_midpoint_fixed_test(): predator-prey system using midpoint_fixed().
%
%  Discussion:
%
...
%
  fprintf ( 1, '\n' );
  fprintf ( 1, 'predator_prey_midpoint_fixed_test\n' );
  fprintf ( 1, '\n' );
  ...
  [ t, pout ] = midpoint_fixed ( f, tspan, p0, n );
%
%  Plot the solution.
%
  ...
  xlabel ( 'Rabbits' );
  ylabel ( 'Foxes' );
  title ( 'midpoint\_fixed: Predator Prey Phase Plot' )
  filename = 'predator_prey_midpoint_fixed.png';
  print ( '-dpng', filename );
