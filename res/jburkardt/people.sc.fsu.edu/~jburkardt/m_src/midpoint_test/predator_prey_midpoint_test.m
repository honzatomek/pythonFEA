function predator_prey_midpoint_test ( tspan, p0, n )

%*****************************************************************************80
%
%% predator_prey_midpoint_test(): predator-prey system using midpoint().
%
%  Discussion:
%
...
%
  ...
  filename = 'predator_prey_midpoint.png';
  print ( '-dpng', filename );
