function predator_prey_trapezoidal_fixed ( tspan, y0, n )

%*****************************************************************************80
%
%% predator_prey_trapezoidal_fixed(): predator-prey system + trapezoidal_fixed().
%
%  Discussion:
%
...
%
  ...
  xlabel ( 'Rabbits' );
  ylabel ( 'Foxes' );
  title ( 'trapezoidal fixed(): Predator Prey Phase Plot' )
  filename = 'predator_prey_trapezoidal_fixed.png';
  print ( '-dpng', filename );
  fprintf ( 1, '  Graphics saved as "%s"\n', filename );

  fprintf ( 1, '\n' );
  fprintf ( 1, 'predator_prey_trapezoidal_fixed_test\n' );
