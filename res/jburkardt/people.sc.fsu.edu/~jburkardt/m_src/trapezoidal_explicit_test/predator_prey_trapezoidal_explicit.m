function predator_prey_trapezoidal_explicit ( tspan, y0, n )

%*****************************************************************************80
%
%% predator_prey_trapezoidal_explicit(): explicit trapezoidal for predator-prey ODE.
%
%  Discussion:
%
...
%
  ...
  xlabel ( 'Rabbits' );
  ylabel ( 'Foxes' );
  title ( 'trapezoidal explicit(): Predator Prey Phase Plot' )
  filename = 'predator_prey_trapezoidal_explicit.png';
  print ( '-dpng', filename );
