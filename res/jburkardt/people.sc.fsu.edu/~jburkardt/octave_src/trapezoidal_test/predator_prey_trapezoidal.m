function predator_prey_trapezoidal ( tspan, y0, n )

%*****************************************************************************80
%
%% predator_prey_trapezoidal: predator-prey system using trapezoidal().
%
%  Discussion:
%
...
%
  ...
  xlabel ( 'Rabbits' );
  ylabel ( 'Foxes' );
  title ( 'trapezoidal: Predator Prey Phase Plot' )
