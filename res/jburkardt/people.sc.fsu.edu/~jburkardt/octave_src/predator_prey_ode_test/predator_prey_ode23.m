function predator_prey_ode23 ( tspan, p0 )

%*****************************************************************************80
%
%% predator_prey_ode23 solves the predator-prey system using ode23().
%
%  Discussion:
%
...
%
  ...
  xlabel ( 'Time' );
  ylabel ( 'Population' );
  title ( 'ode23: Predator Prey Time Plot' )
  filename = 'predator_prey_ode23_plot.png';
  print ( '-dpng', filename );
  ...
  xlabel ( 'Rabbits' );
  ylabel ( 'Foxes' );
  title ( 'ode23: Predator Prey Phase Plot' )
  filename = 'predator_prey_ode23_phase.png';
  print ( '-dpng', filename );
  fprintf ( 1, '  Graphics saved as "%s"\n', filename );
  ...
  title ( 'ode23: H(T) conservation', 'fontsize', 24 );
  filename = 'predator_prey_ode23_conserved.png';
  print ( '-dpng', filename );
  fprintf ( 1, '  Graphics saved as "%s"\n', filename );
