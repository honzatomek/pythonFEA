function predator_prey_euler ( tspan, p0, n )
...
%
  ...
  xlabel ( 'Time' );
  ylabel ( 'Population' );
  title ( 'euler: Predator Prey Time Plot' )
  filename = 'predator_prey_euler_plot.png';
  print ( '-dpng', filename );
  ...
  xlabel ( 'Rabbits' );
  ylabel ( 'Foxes' );
  title ( 'euler: Predator Prey Phase Plot' )
  ...
  title ( 'euler: H(T) conservation', 'fontsize', 24 );
  filename = 'predator_prey_euler_conserved.png';
  print ( '-dpng', filename );
  fprintf ( 1, '  Graphics saved as "%s"\n', filename );
