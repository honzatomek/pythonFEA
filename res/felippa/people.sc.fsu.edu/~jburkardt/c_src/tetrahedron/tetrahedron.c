...
int tetrahedron_contains_point ( double tetra[3*4], double p[3] )

/******************************************************************************/
/*
  Purpose:

    tetrahedron_contains_point(): a tetrahedron contains a point in 3D.
  ...
  Parameters:
    ...
    Output, int TETRAHEDRON_CONTAINS_POINT, is TRUE if the point is inside
