...
double sphere01_monomial_int ( int e[3] )

/******************************************************************************/
/*
  Purpose:

    SPHERE01_MONOMIAL_INT integrates a monomial on the unit sphere.
  ...
  Parameters:
    ...
    Output, double SPHERE01_MONOMIAL_INT, the integral.
*/
{
  int i;
  double integral;
  ...
  if ( e[0] == 0 && e[1] == 0 && e[2] == 0 )
  {
    integral = 2.0 * sqrt ( pi * pi * pi ) / tgamma ( 1.5 );
  }
  else if ( ( e[0] % 2 ) == 1 ||
            ( e[1] % 2 ) == 1 ||
            ( e[2] % 2 ) == 1 )
