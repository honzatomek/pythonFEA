...
*/
  ...
  {
    fprintf ( stderr, "\n" );
    fprintf ( stderr, "I4_TO_HALTON_NUMBER_SEQUENCE - Fatal error!\n" );
...
//
{
  ...
  x = ( double * ) malloc ( int_num * sizeof ( double ) );
...
//
{
  ...
  if ( x_max == 0.0 )
  {
    x_max = sqrt ( log ( fmax ( DBL_EPSILON, 1.0E-10 ) ) 
      / ( - 50.0 * r8_pi ) );
  }
...
void p36_param ( char *action, char *name, double *value )
...
//
{
  ...
  if ( s_eqi ( action, "get" ) )
  {
    ...
    {
      fprintf ( stderr, "\n" );
      fprintf ( stderr, "P36_PARAM - Fatal error!\n" );
      fprintf ( stderr, "  Unrecognized name.\n" );
      exit ( 1 );
    }
  }
...
void p37_param ( char *action, char *name, double *value )
...
//
{
  ...
  if ( s_eqi ( action, "get" ) )
  {
    ...
    {
      fprintf ( stderr, "\n" );
      fprintf ( stderr, "P37_PARAM - Fatal error!\n" );
      fprintf ( stderr, "  Unrecognized name.\n" );
      exit ( 1 );
    }
  }
...
void p38_param ( char *action, char *name, double *value )
...
//
{
  ...
  if ( s_eqi ( action, "get" ) )
  {
    ...
    {
      fprintf ( stderr, "\n" );
      fprintf ( stderr, "P38_PARAM - Fatal error!\n" );
      fprintf ( stderr, "  Unrecognized name.\n" );
      exit ( 1 );
    }
  }
...
//
{
  ...
  for ( i = 0; i < n; i++ )
  {
    ...
    {
      fx[i] = pow ( fabs ( x[i] - 1.0 / 3.0 ), alpha );
    }
  }
  return fx;
}
...
void p39_param ( char *action, char *name, double *value )
...
//
{
  ...
  if ( s_eqi ( action, "get" ) )
  {
    ...
    {
      fprintf ( stderr, "\n" );
      fprintf ( stderr, "P39_PARAM - Fatal error!\n" );
      fprintf ( stderr, "  Unrecognized name.\n" );
      exit ( 1 );
    }
  }
...
//
{
  ...
  for ( i = 0; i < n; i++ )
  {
    fx[i] = pow ( fabs ( x[i] - 0.25 * r8_pi ), alpha );
  }
  return fx;
}
/******************************************************************************/
...
void p40_param ( char *action, char *name, double *value )
...
//
{
  ...
  if ( s_eqi ( action, "get" ) )
  {
    ...
    {
      fprintf ( stderr, "\n" );
      fprintf ( stderr, "P40_PARAM - Fatal error!\n" );
      fprintf ( stderr, "  Unrecognized name.\n" );
      exit ( 1 );
    }
  }
...
void p41_param ( char *action, char *name, double *value )
...
//
{
  ...
  if ( s_eqi ( action, "get" ) )
  {
    ...
    {
      fprintf ( stderr, "\n" );
      fprintf ( stderr, "P41_PARAM - Fatal error!\n" );
      fprintf ( stderr, "  Unrecognized name.\n" );
      exit ( 1 );
    }
  }
...
//
{
  ...
  exact = pow ( 2.0, alpha - 2.0 ) * pow ( tgamma ( alpha / 2.0 ), 2 )
    / tgamma ( alpha );
...
void p42_param ( char *action, char *name, double *value )
...
//
{
  ...
  if ( s_eqi ( action, "get" ) )
  {
    ...
    {
      fprintf ( stderr, "\n" );
      fprintf ( stderr, "P42_PARAM - Fatal error!\n" );
      fprintf ( stderr, "  Unrecognized name.\n" );
      exit ( 1 );
    }
  }
...
void p43_param ( char *action, char *name, double *value )
...
//
{
  ...
  if ( s_eqi ( action, "get" ) )
  {
    ...
    {
      fprintf ( stderr, "\n" );
      fprintf ( stderr, "P43_PARAM - Fatal error!\n" );
      fprintf ( stderr, "  Unrecognized name.\n" );
      exit ( 1 );
    }
  }
...
void p44_param ( char *action, char *name, double *value )
...
//
{
  ...
  if ( s_eqi ( action, "get" ) )
  {
    ...
    {
      fprintf ( stderr, "\n" );
      fprintf ( stderr, "P44_PARAM - Fatal error!\n" );
      fprintf ( stderr, "  Unrecognized name.\n" );
      exit ( 1 );
    }
  }
...
void p45_param ( char *action, char *name, double *value )
...
//
{
  ...
  if ( s_eqi ( action, "get" ) )
  {
    ...
    {
      fprintf ( stderr, "\n" );
      fprintf ( stderr, "P45_PARAM - Fatal error!\n" );
      fprintf ( stderr, "  Unrecognized name.\n" );
      exit ( 1 );
    }
  }
...
void p46_param ( char *action, char *name, double *value )
...
//
{
  ...
  if ( s_eqi ( action, "get" ) )
  {
    ...
    {
      fprintf ( stderr, "\n" );
      fprintf ( stderr, "P46_PARAM - Fatal error!\n" );
      fprintf ( stderr, "  Unrecognized name.\n" );
      exit ( 1 );
    }
  }
...
//
{
  ...
  for ( i = 0; i < n; i++ )
  {
    ...
    {
      fx[i] = pow ( x[i], 3 ) * log ( fabs ( ( x[i] * x[i] - 1.0 ) 
        * ( x[i] * x[i] - 2.0 ) ) );
    }
  }
  return fx;
...
//
{
  ...
  for ( i = 0; i < n; i++ )
  {
    fx[i] = 1.0 / sqrt ( fabs ( x[i] * x[i] + 2.0 * x[i] - 2.0 ) );
  }
  return fx;
}
/******************************************************************************/
...
void p55_param ( char *action, char *name, double *value )
...
//
{
  ...
  if ( s_eqi ( action, "get" ) )
  {
    ...
    {
      fprintf ( stderr, "\n" );
      fprintf ( stderr, "P55_PARAM - Fatal error!\n" );
      fprintf ( stderr, "  Unrecognized name.\n" );
      exit ( 1 );
    }
  }
...
*/
{
  ...
  if ( nalgm == 0 )
  {
    ...
    xmax = exp ( fmin ( log ( r8_mach ( 2 ) / 12.0 ), 
      - log ( 12.0 * r8_mach ( 1 ) ) ) );
  }
