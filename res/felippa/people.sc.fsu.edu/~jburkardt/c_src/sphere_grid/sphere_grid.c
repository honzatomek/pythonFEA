...
*/
{
  ...
  line_data = ( double * ) malloc ( 3 * 2 * line_num );
  l = 0;
/*
  If N = 1, the corners form 12 lines.
*/
...
*/
  ...
  {
    fprintf ( stderr, "\n" );
    fprintf ( stderr, "SPHERE_CUBED_LINES - Fatal error!\n" );
...
*/
{
  ...
  xyz = ( double * ) malloc ( 3 * ns * sizeof ( double ) );
...
*/
  ...
  {
    fprintf ( stderr, "\n" );
    fprintf ( stderr, "SPHERE_CUBED_POINTS - Fatal error\n" );
    fprintf ( stderr, "  Expected to generated NS = %d points.\n", ns );
...
*/
{
  ...
  rectangle_node = ( int * ) 
    malloc ( ( 4 * lat_num * long_num ) * sizeof ( int ) );
...
*/
{
  ...
  triangle_node = ( int * ) 
    malloc ( 3 * 2 * ( lat_num + 1 ) * long_num * sizeof ( int ) );
...
/*
  Set the icosahedron.
*/
  point_coord = ( double * ) malloc ( 3 * point_num * sizeof ( double ) );
...
# define TIME_NUM 40
  ...
  strftime ( time_buffer, TIME_NUM, "%d %B %Y %I:%M:%S %p", tm );
