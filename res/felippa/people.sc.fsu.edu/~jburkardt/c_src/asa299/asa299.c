...
*/
{
  ...
  if ( !(*more) )
  {
    ...
    {
      printf ( "\n" );
      printf ( "SIMPLEX_LATTICE_POINT_NEXT - Fatal error!\n" );
      printf ( "  N < 1.\n" );
      exit ( 1 );
    }
...
*/
    ...
    if ( j == n - 1 )
    {
      printf ( "\n" );
      printf ( "SIMPLEX_LATTICE_POINT_NEXT - Fatal error!\n" );
      printf ( "  The input X vector is nonpositive in all entries\n" );
      printf ( "  except possibly the last one.\n" );
      printf ( "\n" );
      printf ( "  Perhaps the user has miscalled the routine\n" );
      printf ( "  or altered data between calls.\n" );
      printf ( "\n" );
