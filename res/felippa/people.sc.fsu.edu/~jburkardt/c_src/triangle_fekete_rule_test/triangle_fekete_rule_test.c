...
*/
{
  timestamp ( );
  printf ( "\n" );
  printf ( "TRIANGLE_FEKETE_RULE_TEST:\n" );
  printf ( "  C version\n" );
  printf ( "  Test the TRIANGLE_FEKETE_RULE library.\n" );
...
*/
{
  ...
  printf ( "\n" );
  printf ( "TEST01\n" );
  printf ( "  FEKETE_RULE_NUM returns the number of rules;\n" );
  printf ( "  FEKETE_DEGREE returns the degree of a rule;\n" );
  printf ( "  FEKETE_ORDER_NUM returns the order of a rule.\n" );
...
*/
{
  ...
  printf ( "\n" );
  printf ( "TEST02\n" );
  printf ( "  FEKETE_RULE returns the points and weights\n" );
  printf ( "  of a Fekete rule for the triangle.\n" );
  printf ( "\n" );
...
*/
{
  ...
  printf ( "\n" );
  printf ( "TEST04\n" );
  printf ( "  FEKETE_RULE returns the points and weights of\n" );
  printf ( "  a Fekete rule for the unit triangle.\n" );
  printf ( "\n" );
