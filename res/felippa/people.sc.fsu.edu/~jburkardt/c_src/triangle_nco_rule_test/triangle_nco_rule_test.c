...
/*
  Purpose:
    ...
    triangle_nco_rule_test() tests triangle_nco_rule().
...
*/
{
  timestamp ( );
  printf ( "\n" );
  printf ( "TRIANGLE_NCO_RULE_TEST:\n" );
  printf ( "  C version\n" );
  printf ( "  Test the TRIANGLE_NCO_RULE library.\n" );
...
*/
{
  ...
  printf ( "\n" );
  printf ( "TEST01\n" );
  printf ( "  TRIANGLE_NCO_RULE_NUM returns the number of rules;\n" );
  printf ( "  TRIANGLE_NCO_DEGREE returns the degree of a rule;\n" );
  printf ( "  TRIANGLE_NCO_ORDER_NUM returns the order of a rule.\n" );
...
*/
{
  ...
  printf ( "\n" );
  printf ( "TEST02\n" );
  printf ( "  TRIANGLE_NCO_RULE returns the points and weights\n" );
  printf ( "  of an NCO rule for the triangle.\n" );
  printf ( "\n" );
  ...
  for ( rule = 1; rule <= rule_num; rule++ )
  {
    ...
    triangle_nco_rule ( rule, order_num, xytab, wtab );
...
*/
{
  ...
  printf ( "\n" );
  printf ( "TEST04\n" );
  printf ( "  TRIANGLE_NCO_RULE returns the points and weights of\n" );
  printf ( "  an NCO rule for the unit triangle.\n" );
  printf ( "\n" );
...
# define NODE_NUM 3
  ...
  triangle_nco_rule ( rule, order_num, xy, w );
/*
