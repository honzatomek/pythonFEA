...
%  Input:
%
%    real XVAL(3), YVAL(3), the coordinates of the nodes.
%
%    integer NORDER, the order of the rule.
%
%    real XTAB(NORDER), YTAB(NORDER), the abscissas for
%    a unit triangle.
%
%    real WEIGHT(NORDER), the weights for a unit triangle.
%
%  Output:
%
%    real XTAB_NEW(NORDER), YTAB_NEW(NORDER), the adjusted
%    abscissas.
%
%    real WEIGHT_NEW(NORDER), the adjusted weights.
%
