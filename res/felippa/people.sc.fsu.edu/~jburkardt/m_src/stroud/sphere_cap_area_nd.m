function area = sphere_cap_area_nd ( ndim, r, h )
...
%  Input:
%
%    integer NDIM, the dimension of the space.
%
%    real R, the radius of the sphere.
%
%    real H, the "thickness" of the spherical cap,
%    which is normally between 0 and 2 * R.
%
%  Output:
%
%    real AREA, the area of the spherical cap.
%
  if ( h <= 0.0 )
    area = 0.0;
    return
