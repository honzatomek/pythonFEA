...
%  Input:
%
%    external FUNC, name of the function, of the form:
%      function value = func ( x, y, z )
%
%    real X(4), Y(4), Z(4), the coordinates of the vertices.
%
%    integer NORDER, the order of the rule.
%
%    real XTAB(NORDER), YTAB(NORDER), ZTAB(NORDER), the
%    abscissas.
%
%    real WEIGHT(NORDER), the weights.
%
%  Output:
%
