...
%  Input:
%
%    integer N_DATA, set to 0 on first call.
%
%  Output:
%
%    integer N_DATA.  On each call, N_DATA is incremented and that 
%    test data is returned.  When there is no more test data, 
%    N_DATA is set to 0.
%
%    integer N, the spatial dimension.
%
%    real AREA, the area of the unit sphere in that dimension.
%
  n_max = 20;
