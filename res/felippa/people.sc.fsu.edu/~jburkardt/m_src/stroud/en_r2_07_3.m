function [ o, x, w ] = en_r2_07_3 ( n, option )
...
%    3 <= N <= 6.
%
%    integer OPTION, chooses rule option 1 or 2.
%
%  Output:
%
%    integer O, the order.
%
%    real X(N,O), the abscissas.
%
%    real W(O), the weights.
%
  if ( n < 3 | 6 < n )
    fprintf ( 1, '\n' );
    fprintf ( 1, 'EN_R2_07_3 - Fatal error!\n' );
    fprintf ( 1, '  3 <= N <= 6 required.\n' );
    error ( 'EN_R2_07_3 - Fatal error!' )
  end
