...
%  Input:
%
%    external FUNC, the name of the user supplied function of two
%    variables which is to be integrated, of the form:
%      function value = func ( x, y )
%
%    real XC, YC, the center of the circle.
%
%    real RADIUS, the radius of the circle.
%
%    real THETA1, THETA2, the angles defining the sector.
%    The sector is measured from THETA1 to THETA2.
%
%    integer NR, the number of radial values used in the approximation
...
%  Output:
%
%    real RESULT, the approximation to the integral.
%
