...
%  Input:
%
%    external FUNC, the name of the user supplied function of
%    two variables which is to be integrated, of the form:
%      function value = func ( x, y )
%
%    real XVAL(3), YVAL(3), the coordinates of the triangle vertices.
%
%    integer NSUB, the number of subdivisions of each side of the
