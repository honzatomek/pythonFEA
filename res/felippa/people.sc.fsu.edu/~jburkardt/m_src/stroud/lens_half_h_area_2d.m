...
%    its endpoints.  This particular half lens is described by the "height" 
%    of the region.  In other words, it is the area that would be submerged
...
%
%    real H, the height of the half lens.
%
%  Output:
%
