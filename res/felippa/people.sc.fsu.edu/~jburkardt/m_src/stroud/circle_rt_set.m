...
%      9, 0 + 5 * 20 points.
%
%    integer NR, the number of R abscissas.
%
%    integer NT, the number of Theta abscissas.
%
%    integer NC, the number of center abscissas.
%
%  Output:
%
%    real RA(NR), RW(NR), the R abscissas and weights.
%
%    real TA(NT), TW(NT), the THETA abscissas and weights.
%
%    real ZW, the weight to use for the center.
%
  if ( rule == 1 )
