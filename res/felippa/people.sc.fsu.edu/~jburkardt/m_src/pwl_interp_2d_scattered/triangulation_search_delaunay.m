...
%
%    real NODE_XY(2,NODE_NUM), the vertices.
%
...
%
%    integer TRIANGLE_NEIGHBOR(3,TRIANGLE_NUM), the triangle 
%    neighbor list.
%
%    real P(2), the coordinates of a point.
%
%  Output:
%
%    integer TRIANGLE_INDEX, the index of the triangle where the 
%    search ended.  If a cycle occurred, then TRIANGLE_INDEX = -1.
%
%    real ALPHA, BETA, GAMMA, the barycentric
%    coordinates of the point relative to triangle TRIANGLE_INDEX.
%
%    integer EDGE, indicates the position of the point P in
