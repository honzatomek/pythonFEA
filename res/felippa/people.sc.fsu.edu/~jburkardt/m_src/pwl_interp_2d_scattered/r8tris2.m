...
%
%    real P(2,POINT_NUM), the vertices.
%
%  Output:
%
%    integer TRI_NUM, the number of triangles in the triangulation;
%    TRI_NUM is equal to 2*POINT_NUM - NB - 2, where NB is the number
%    of boundary vertices.
%
%    integer TRI_VERT(3,TRI_NUM), the nodes that make up each triangle.
