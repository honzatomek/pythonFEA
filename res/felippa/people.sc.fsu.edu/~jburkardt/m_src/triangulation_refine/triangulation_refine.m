...
%  Input:
%
%    character PREFIX, the common filename prefix.
%
  debug = 1;
...
%
%    integer A(M,N), an array of N columns of vectors of length M.
%
%    integer I, J, the columns to be compared.
...
%  Input:
%
%    integer M, the number of rows of A, and the length of
%    a vector of data.
%
...
%  Output:
%
%    integer A(M,N), the columns of A have been sorted in ascending
%    lexicographic order.
%
  if ( m <= 0 )
    return
...
%
%    integer A(M,N), an array of N columns of length M.
%
%    integer I, J, the columns to be swapped.
%
%  Output:
%
%    integer A(M,N), the array, with columns I and J swapped.
%
  if ( i < 1 || n < i || j < 1 || n < j )
    fprintf ( 1, '\n' );
...
%  Input:
%
%    integer I1, I2, the values to sort.
%
%  Output:
%
%    integer J1, J2, the sorted values.
%
  j1 = min ( i1, i2 );
  j2 = max ( i1, i2 );
...
%
%    logical HEADER, is TRUE if the header is to be included.
%
...
%  Input:
%
%    integer NODE_NUM1, the number of nodes.
%
%    integer TRIANGLE_NUM1, the number of triangles.
%
%    real NODE_XY1(2,NODE_NUM1), the nodes.
%
%    integer TRIANGLE_NODE1(3,TRIANGLE_NUM1), the nodes that make up the
%    triangles.  These should be listed in counterclockwise order.
%
%    integer NODE_NUM2, the number of nodes in the refined mesh.
%
%    integer TRIANGLE_NUM2, the number of triangles in the refined mesh.
%
%    integer EDGE_DATA(5,3*TRIANGLE_NUM1), edge information computed
%    by TRIANGULATION_ORDER3_REFINE_SIZE.
%
%  Output:
%
%    real NODE_XY2(2,NODE_NUM2), the refined nodes.
%
%    integer TRIANGLE_NODE2(3,TRIANGLE_NUM2), the nodes that make up the
...
%    real NODE_XY1(2,NODE_NUM1), the nodes.
%
%    integer TRIANGLE_NODE1(6,TRIANGLE_NUM1), the nodes that make up the
%    triangles.  These should be listed in counterclockwise order.
%
%    integer NODE_NUM2, the number of nodes in the refined mesh.
%
%    integer TRIANGLE_NUM2, the number of triangles in the refined mesh.
%
%    integer EDGE_DATA(5,3*TRIANGLE_NUM1), edge data.
%
%  Output:
%
%    real NODE_XY2(2,NODE_NUM2), the refined nodes.
%
%    integer TRIANGLE_NODE2(6,TRIANGLE_NUM2), the nodes that make up the
%    triangles in the refined mesh.
%
...
%  Output:
%
%    integer EDGE_DATA(5,3*TRIANGLE_NUM1), edge data needed by
