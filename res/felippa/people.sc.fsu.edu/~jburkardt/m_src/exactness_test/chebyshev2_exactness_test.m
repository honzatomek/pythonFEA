function chebyshev2_exactness_test ( )

%*****************************************************************************80
%
%% chebyshev2_exactness_test() tests Gauss-Chebyshev2 rules for the Chebyshev2 integral.
%
%  Licensing:
%
...
%
  fprintf ( 1, '\n' );
  fprintf ( 1, 'CHEBYSHEV2_EXACTNESS_TEST\n' );
