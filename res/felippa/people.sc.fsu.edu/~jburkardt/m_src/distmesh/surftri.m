...
%  Input:
%
%    real P(NP,3), the coordinates of a set of nodes.
%
%    integer T(NT,1:4), a list of the nodes which make up each 
%    tetrahedron in the mesh.
%
%  Output:
%
%    integer tri(NTRI,3), nodes that form surface triangles.
%
