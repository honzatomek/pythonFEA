...
%  Input:
%
%    real P(NP,3), the coordinates of a set of nodes in 3D.
%
%    integer T(NT,1:4), a list of the nodes which make up 
%    each tetrahedron in the mesh.
%
%    ? EXPR, ?
%
%    real BCOLOR(3), the RGB color to use for faces.
%
%    real ICOLOR(3), the RGB color to use for selected faces.
%
  if ( nargin < 4 )
    bcolor = 0.9 * ones ( 1, 3 );
  end
