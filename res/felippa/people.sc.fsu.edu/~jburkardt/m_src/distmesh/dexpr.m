...
%
%    string FIN, the expression that defines F(X,Y).
%
%    integer NIT, the number of iterations.  The default value of NIT is 20.
%
%    real ALPHA, the damping parameter for the Newton method.  
%    The default value of ALPHA is 0.1.
%
%  Output:
%
%    real D(NP), the signed distance of each point to the boundary.
%
  if ( nargin < 3 ) 
    nit = 20; 
  end
