...
%*****************************************************************************80
%
%% mytsearch() finds the enclosing triangle for points in a 2D plane.
%
%  Discussion:
%
...
%  Input:
%
%    I is an optional initial guess for the indicies. A full search is
...
%% sameside() tests if [x1(i),y1(i)] and [x2(i),y2(i)] lie on the same side of the line
% AB(i).
