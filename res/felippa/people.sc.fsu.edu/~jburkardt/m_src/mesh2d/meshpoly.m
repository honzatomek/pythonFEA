...
%% cdt() approximates geometry-constrained Delaunay triangulation.
...
%% initmesh() initialises the mesh nodes
...
%% getedges() gets the unique edges and boundary nodes in a triangulation.
...
%% tricentre() interpolates nodal F to the centroid of the triangles T.
...
%% longest() returns the length of the longest edge in each triangle.
