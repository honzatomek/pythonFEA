...
%*****************************************************************************80
%
%% minrectangle() finds the rotation angle that must be applied to the 2D points in P so
...
%*****************************************************************************80
%
%% rotate() rotates the 2D points in P through the angle THETA (radians).
...
%*****************************************************************************80
%
%% userhfun() evaluates user defined size function.
...
%*****************************************************************************80
%
%% gethdata() checks the user defined size functions
