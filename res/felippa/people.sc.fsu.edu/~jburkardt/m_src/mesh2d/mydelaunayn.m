...
%*****************************************************************************80
%
%% mydelaunayn(): my version of the MATLAB delaunayn() function.
%
%  Discussion:
%
...
%
%  MATLAB strikes again!
%  DELAUNAYN will complain bitterly if P contains nonunique data.
%  However, if you follow their recommendations, and UNIQUE the data,
%  your 2D array becomes a 1D array!
%  If you think for a while, and try UNIQUE(P,'ROWS'), your output
%  will be correct, in that it will have the right shape...but it will
%  be SORTED.  And that screws up all the indexing elsewhere. 
%  I have tried the "Joggled Input" option and it doesn't help.
%
   t = delaunayn(p);
catch
