function [ area, radout, side ] = polygon_data_inrad ( n, radin )

%*****************************************************************************80
%
%% polygon_data_inrad() determines polygonal data from its inner radius in 2D.
%
%  Licensing:
%
