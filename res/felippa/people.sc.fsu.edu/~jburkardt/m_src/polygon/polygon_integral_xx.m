function result = polygon_integral_xx ( n, v )

%*****************************************************************************80
%
%% polygon_integral_xx() integrates the function X*X over a polygon in 2D.
%
%  Discussion:
%
