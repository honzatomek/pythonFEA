function s = polygon_sample ( nv, v, n )
...
%
  for i = 1 : nv - 2
    t = [ ...
      v(1,triangles(1,i)),  v(1,triangles(2,i)),  v(1,triangles(3,i));
      v(2,triangles(1,i)),  v(2,triangles(2,i)),  v(2,triangles(3,i)) ];
    area_triangle(i) = triangle_area ( t );
  end
%
%  Normalize the areas.
%
