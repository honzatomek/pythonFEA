...
%
%    integer G(M+1,NG), the grid indices of 1 or more points.
%
%    real V(M,M+1), the coordinates of the vertices of the simplex.
%
%  Output:
%
%    real X(M,NG), the coordinates of one or more points.
%
