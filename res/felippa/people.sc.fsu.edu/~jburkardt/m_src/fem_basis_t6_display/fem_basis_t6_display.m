...
%  Input:
%
%    character PREFIX, the common filename prefix for the data files.
%
  timestamp ( );
  fprintf ( 1, '\n' );
...
%  Input:
%
%    real T(2,6), the coordinates of the nodes.
%
...
%  Output:
%
%    real BI, DBIDX, DBIDY, the values of the basis function
