...
%
%    string ANIMATE, is 'y' if the user wants to see the triangulation
%    process animated.
%
  timestamp ( );
  fprintf ( 1, '\n' );
...
%  Input:
%
%    real VA, VB, VC, the vertices.
%
%  Output:
%
%    integer VALUE, is 1 if VC is between VA and VB,
%    and 0 otherwise.
%
...
%  Output:
%
%    logical VALUE, is 1 if the points are judged to be collinear,
%    and 0 otherwise.
%
...
%  Output:
%
%    integer VALUE, the value of the test.
%
...
%  Output:
%
%    vertex array VERTEX(*).  The "ear" field has been initialized.
%
  im1 = vertex(1).prev;
  i   = vertex(1).index;
  ip1 = vertex(1).next;
...
%  Output:
%
%    int VALUE, the value of the test.
%
  im2 = vertex(im1).prev;
  i = vertex(im1).next;
...
%  Input:
%
%    vertex VA, VB, VC, VD, four vertices.
%
%  Output:
%
%    integer VALUE, the value of the test.
...
%  Output:
%
%    integer VALUE, the result of the test.
%
  if ( collinear ( va, vb, vc ) || ...
       collinear ( va, vb, vd ) || ...
       collinear ( vc, vd, va ) || ...
...
%  Input:
%
%    vertex VA, VB, VC, three vertices.
%
%  Output:
%
%    integer VALUE, the result of the test.
...
%
%    integer DIRECTION, the ordering for the vertices.
...
%  Input:
%
%    vertex V1, V2, V3, three vertices.
%
%  Output:
%
