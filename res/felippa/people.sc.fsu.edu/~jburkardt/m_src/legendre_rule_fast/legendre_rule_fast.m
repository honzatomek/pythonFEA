...
%  Input:
%
%    integer n is the number of points in the rule;
%
...
%  Input:
%
%    integer N, the order of the Legendre polynomial.
%
%  Output:
%
%    real P, PP, the value of the N-th Legendre polynomial
...
%    integer N, the order of the Legendre polynomial.
%
%    real X(N), a starting value
%    has been set in one entry.
%
%    real DERS(N), a starting value
%    has been set in one entry.  
%
%  Output:
%
%    real X(N), the roots of the Legendre 
%    polynomial.
%
%    real DERS(N), the derivatives of the Legendre 
%    polynomial at the zeros.
%
%  Local:
%
%    integer M, the number of terms in the Taylor expansion.
%
  if ( mod ( n, 2 ) == 1 )
    N = ( n - 1 ) / 2; 
    s = 1;
...
function [x1 d1] = legendre_compute_glr2 ( Pn0, n )
...
%  Input:
%
%    real PN0, the value of the N-th Legendre polynomial
%    at 0.
%
%    integer N, the order of the Legendre polynomial.
%
%  Output:
%
%    real X1, the first real root.
%
%    real D1, the derivative at X1.
%
%  Local:
%
%    integer M, the number of terms in the Taylor expansion.
...
%    integer N, the order.
%
%    real A, B, the endpoints of the new interval.
%
%    real X(N), the abscissas for [-1,+1].
%
%    real W(N), the weights for [-1,+1].
%
%  Output:
%
%    real X(N), the abscissas for [A,B].
%
%    real W(N), the weights for [A,B].
%
