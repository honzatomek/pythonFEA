...
%
%    real NODE_XY(DIM_NUM,NODE_NUM), the point set.
%
...
%
%    real Z(DIM_NUM,N), the points.
%
%    integer TRIANGLE_ORDER, the order of the triangles.
%
%    integer TRIANGLE_NUM, the number of triangles.
%
%    integer TRIANGLE_NODE(TRIANGLE_ORDER,TRIANGLE_NUM), the triangulation.
%
%  Output:
%
%    real ALPHA_MIN, the minimum value of ALPHA over all
%    triangles.
%
%    real ALPHA_AVE, the value of ALPHA averaged over
%    all triangles.
%
%    real ALPHA_AREA, the value of ALPHA averaged over
...
%  Output:
%
%    real AREA_MIN, AREA_MAX, the minimum and maximum 
%    areas.
%
%    real AREA_RATIO, the ratio of the minimum to the
%    maximum area.
%
%    real AREA_AVE, the average area.
%
%    real AREA_STD, the standard deviation of the areas.
%
%    integer AREA_NEGATIVE, the number of triangles with negative area.
%
%    intgeger AREA_ZERO, the number of triangles with zero area.
%
  area_max = 0.0;
  area_min = Inf;
  area_ave = 0.0;
...
%  Output:
%
%    real  Q_MIN, Q_MAX, the minimum and maximum values
%    of Q over all triangles.
%
%    real Q_AVE, the average value of Q.
%
%    real Q_AREA, the average value of Q, weighted by
