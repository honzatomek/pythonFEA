...
%  Input:
%
%    integer NPTSOUT, the number of points expanded.
%
%    real XSOUT(NPTSOUT), YSOUT(NPTSOUT), WSOUT(NPTSOUT),
%    the coordinates and weights of the points to be expanded.
%
%  Output:
%
%    integer NPTS, the number of points in the expanded set.
%
%    real XS2(NPTSOUTOUT), YS2(NPTSOUTOUT), WS2(NPTSOUTOUT),
