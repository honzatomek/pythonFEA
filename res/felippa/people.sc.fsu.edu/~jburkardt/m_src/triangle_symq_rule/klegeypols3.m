...
%
%    real Y, the parameter value.
%
%    integer N, the highest degree to be evaluated.
%
%  Output:
%
%    real POLS(N+1), the polynomial values.
%
%    real DERSX(N+1), the derivatives with respect to X.
%
%    real DERSY(N+1), the derivatives with respect to Y.
%
  pkp1 = 1.0;
  pols(1) = pkp1;
  dkp1 = 0.0;
