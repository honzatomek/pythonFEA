function triangle_lyness_rule_test06 ( )

%*****************************************************************************80
%
%% triangle_lyness_rule_test06() tests the Lyness rules for exact integration of monomials.
%
%  Licensing:
%
...
%
  ...
  fprintf ( 1, '\n' );
  fprintf ( 1, 'TRIANGLE_LYNESS_RULE_TEST06\n' );
