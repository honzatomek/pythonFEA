...
%  Input:
%
%    real P1(2,1), the endpoint of the original vector.
%
%    real PB(2,1), the location of the base point.
%
%    real ANGLE, the angle, in radians, of the rotation to be
%    carried out.  A positive angle rotates the vector in the
%    counterclockwise direction.
%
%  Output:
%
%    real P2(2,1), the endpoint of the rotated vector.
%
