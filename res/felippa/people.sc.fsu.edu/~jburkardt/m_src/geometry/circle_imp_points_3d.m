...
%
%    real PC(3,1), the center of the circle.
%
%    real NC(3,1), a nonzero vector that is normal to
...
%  Output:
%
%    real P(3,N), the coordinates of points on the circle.
%

%
%  Get unit vectors N1 and N2 which are orthogonal to each other, and to NC.
%
