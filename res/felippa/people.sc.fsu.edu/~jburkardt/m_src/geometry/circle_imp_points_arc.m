function p = circle_imp_points_arc ( r, center, theta1, theta2, n )

%*****************************************************************************80
%
%% circle_imp_points_arc() returns N points on an arc of an implicit circle.
%
%  Discussion:
%
%    The first point is
...
%  Output:
%
%    real P(2,N), the points on the circle.
%
