...
%  Input:
%
%    character AXIS, the coordinate axis to be projected.
%    AXIS should be 'X', 'Y', or 'Z'.
%
%    real THETA, the presentation angle in degrees.
%
%    integer N, the number of points.
%
%    real COR3(3,N), the 3D points.
%
%  Output:
%
%    real COR2(2,N), the 2D projections.
%
