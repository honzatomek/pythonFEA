...
%  Input:
%
%    integer V1(3), the coordinates of the base voxel from
%    which the line begins.
%
%    integer V2(3), the coordinates of the current voxel
%    on the line.  For the first call, these might be equal to V1.
%
%    integer INC, JNC, KNC, the increments to the voxels.
...
%  Output:
%
%    integer V3(3), the coordinates of the next voxel along the line.
%
  v3(1:3) = v2(1:3);
%
