...
%  Input:
%
%    real F1, G1, X1, Y1, define the first parametric line.
%
%    real F2, G2, X2, Y2, define the second parametric line.
%
%  Output:
%
%    real T1, T2, the T parameters on the first and second
%    lines of the intersection point.
%
%    real PI(2,1), the intersection point.
%
  det = f2 * g1 - f1 * g2;
