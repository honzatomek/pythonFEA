...
%  Input:
%
%    real P1(2,1), P2(2,1), two points on line 1.
%
%    real Q1(2,1), Q2(2,1), two points on line 2.
%
%    real R, the radius of the circle.
%
%  Output:
%
%    real PC(2,4), the centers of the circles.
%

%
%  Compute the normals N1 and N2.
%
  n1 = line_exp_normal ( p1, p2 );

  n2 = line_exp_normal ( q1, q2 );
%
