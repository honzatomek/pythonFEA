...
%  Input:
%
%    real COSPITCH, COSROLL, COSYAW, the cosines of
%    the pitch, roll and yaw angles.
%
%    real SINPITCH, SINROLL, SINYAW, the sines of the pitch,
%    roll and yaw angles.
%
%    real GLOBAS(3), the X, Y, and Z coordinates of the
%    global base vector.
%
%    real GLOPTS(3), the global ( X, Y and Z ) coordinates
%    of the point whose coordinates are to be transformed.
%
%  Output:
%
%    real LOCPTS(3), the local coordinates of the point
