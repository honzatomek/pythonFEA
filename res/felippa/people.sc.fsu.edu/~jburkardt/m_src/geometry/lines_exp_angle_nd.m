...
%
%    real P1(DIM_NUM,1), P2(DIM_NUM,1), two points on the first line.
%
%    real Q1(DIM_NUM,1), Q2(DIM_NUM,1), two points on the second line.
%
%  Output:
%
%    real ANGLE, the angle in radians between the two
