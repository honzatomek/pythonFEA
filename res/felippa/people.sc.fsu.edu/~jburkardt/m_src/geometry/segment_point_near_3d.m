...
%  Input:
%
%    real P1(3,1), P2(3,1), the endpoints of the segment.
%
%    real P(3,1), the point whose nearest neighbor
%    on the line segment is to be determined.
%
%  Output:
%
%    real PN(3,1), the point on the line segment
%    nearest to P.
%
%    real DIST, the distance from the point to the
%    nearest point on the line segment.
%
%    real T, the relative position of the nearest point
