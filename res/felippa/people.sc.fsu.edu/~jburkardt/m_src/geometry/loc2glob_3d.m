...
%  Input:
%
%    real COSPITCH, COSROLL, COSYAW, the cosines of the
%    pitch, roll and yaw angles.
%
%    real SINPITCH, SINROLL, SINYAW, the sines of the pitch,
%    roll and yaw angles.
%
%    real GLOBAS(3,1), the global coordinates of the base
%    vector.
%
%    real LOCPTS(3,1), the local coordinates of the point.
%
%  Output:
%
%    real GLOPTS(3,1), the global coordinates of the point.
%
