...
%  Input:
%
%    real P1(3,1), P2(3,1), two points on the line.
%
%    real P(3,1), the point whose nearest neighbor on
%    the line is to be determined.
%
%  Output:
%
%    real PN(3,1), the point which is the nearest
%    point on the line to P.
%
%    real DIST, the distance from the point to the
%    nearest point on the line.
%
%    real T, the relative position of the point
%    PN to P1 and P2.
%
  dim_num = 3;
