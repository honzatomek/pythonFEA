...
%  Input:
%
%    integer N, the number of entries of A.
%
%    real A(2,N), the array to be checked.
%
%  Output:
%
%    real A(2,N), has been reordered as described above.
%
%    integer L, R, the indices of A that define the three segments.
