...
%
%    real LAT[N], LON[N], the latitudes and longitudes
%    of the vertices of the spherical polygon.
%
%  Output:
%
%    real AREA, the area of the spherical polygon, measured in 
%    spherical radians.
%
  ...
  for j = 1 : n + 1
    ...
    if ( lam1 ~= lam2 )
      ...
      hav_a = r8_haversine ( beta2 - beta1 ) ...
        + cos_b1 * cos_b2 * r8_haversine ( lam2 - lam1 );
