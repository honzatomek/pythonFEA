function [ num_int, p ] = circles_intersect_points_2d ( r1, center1, r2, center2 )
...
%
%    real CENTER1(2,1), the center of the first circle.
%
%    real R2, the radius of the second circle.
%
%    real CENTER2(2,1), the center of the second circle.
%
%  Output:
%
