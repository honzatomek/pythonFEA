function [ ngrid, g ] = triangle_gridpoints ( t, nsub, maxgrid )

%*****************************************************************************80
%
%% triangle_gridpoints() computes gridpoints within a triangle.
%
%  Discussion:
%
...
%
%    integer NSUB, the number of subdivisions.
%
%    integer MAXGRID, the maximum number of grid points.
%
%  Output:
%
%    integer NGRID, the number of grid points returned.
%
%    real G(2,MAXGRID), the grid points.
%
  dim_num = 2;
  ngrid = 0;
%
