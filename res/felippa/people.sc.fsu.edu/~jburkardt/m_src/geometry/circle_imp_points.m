function p = circle_imp_points ( r, center, n )

%*****************************************************************************80
%
%% circle_imp_points() returns N equally spaced points on an implicit circle.
%
%  Discussion:
%
...
%  Output:
%
%    real P(2,N), the coordinates of points on the circle.
%
  for i = 1 : n
    theta = ( 2.0 * pi * ( i - 1 ) ) / n;
