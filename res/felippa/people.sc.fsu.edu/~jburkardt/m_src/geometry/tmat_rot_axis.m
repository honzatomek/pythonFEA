...
%  Input:
%
%    real A(4,4), the current geometric transformation
%    matrix.
%
%    real ANGLE, the angle, in degrees, of the rotation.
%
%    character AXIS, is 'X', 'Y' or 'Z', specifying the coordinate
%    axis about which the rotation occurs.
%
%  Output:
%
%    real B(4,4), the modified geometric 
