...
%  Output:
%
%    real POINT_COORD2(3,POINT_NUM2), the point coordinates
%    of the dual.
%
%    integer FACE_ORDER2(FACE_ORDER_MAX2), the number of vertices per face.
%
%    integer FACE_POINT2(FACE_ORDER_MAX2,FACE_NUM2), the vertices
...
%
    ...
    if ( irow <= 0 )
      fprintf ( 1, '\n' );
      fprintf ( 1, 'dual_shape(): Fatal error!\n' );
      fprintf ( 1, '  Could not find an edge using node %d\n', face );
      error ( 'dual_shape(): Fatal error!' );
    end
%
