...
%  Input:
%
%    real DIST, the radius of the tube.
%
%    integer N, the number of points defining the line.
%    N must be at least 2.
%
%    real P(2,N), the points which comprise the broken
...
%  Output:
%
%    real P1(2,N), P2(2,N), the points P1 form
