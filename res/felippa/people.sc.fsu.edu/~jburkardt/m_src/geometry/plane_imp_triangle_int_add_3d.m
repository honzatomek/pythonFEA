...
%  Input:
%
%    real P1(3), P2(3), the coordinates of two vertices 
%    of a triangle.
%
%    real DIST1, DIST2, the signed distances of the 
%    two vertices from a plane.
%
%    integer NUM_INT, the number of intersection points.
%
%    real PINT(3,NUM_INT), the intersection points.
%
%  Output:
%
%    integer NUM_INT, the updated number of intersection points.
%
%    real PINT(3,NUM_INT), the updated intersection points.
%
  dim_num = 3;
