function dist = lines_exp_dist_3d_2 ( p1, p2, q1, q2 )
...
%  Input:
%
%    real P1(3,1), P2(3,1), two points on the first line.
%
%    real Q1(3,1), Q2(3,1), two points on the second line.
%
%  Output:
%
%    real DIST, the distance between the lines.
%
  p1 = p1(:);
  p2 = p2(:);
  q1 = q1(:);
