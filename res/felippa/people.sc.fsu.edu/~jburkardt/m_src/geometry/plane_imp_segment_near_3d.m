...
%  Output:
%
%    real DIST, the distance between the line segment and
%    the plane.
%
%    real P(3), the nearest point on the plane.
%
%    real PN(3), the nearest point on the line
