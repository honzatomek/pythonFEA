...
%
%    integer NK, the number of points defining the polyline.
%
%    real PK(DIM_NUM,NK), the points defining the polyline.
%
%    real T, the desired arclength coordinate.
%
%  Output:
%
%    real PT(DIM_NUM), the point corresponding to the arclength.
%
  if ( nk <= 0 )
    fprintf ( 1, '\n' );
...
%
      if ( t <= t2 | i == nk - 1 )
        ...
        pt(1:dim_num,1) = ( ( t2 - t      ) * pk(1:dim_num,i)     ...
