...
%  Input:
%
%    real CENTER(2), the center of the superellipse.
%
%    real R1, R2, the "radius" of the superellipse
%    in the major and minor axis directions.  A circle has these values equal.
%
%    real EXPO, the exponent of the superellipse. 
%    0 = a rectangle;
...
%    > 2.0 a pinched shape.
%
%    real PSI, the angle that the major axis of the
...
%  Output:
%
%    real P(2,N), the coordinates of points 
%    on the superellipse.
%
  for i = 1 : n
