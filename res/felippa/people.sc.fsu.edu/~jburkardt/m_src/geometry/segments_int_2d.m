...
%  Input:
%
%    real P1(2), P2(2), the endpoints of the first
%    segment.
%
%    real Q1(2), Q2(2), the endpoints of the second
%    segment.
%
%  Output:
%
%    integer FLAG, records the results.
%    0, the line segments do not intersect.
%    1, the line segments intersect.
%
%    real R(2), an intersection point, if there is one.
%
  dim_num = 2;
  tol = 0.001;
%
