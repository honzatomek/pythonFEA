...
%  Input:
%
%    real A, the rate at which Z advances with THETA.
%
%    integer N, the number of points to compute on the helix.
%
%    real R, the radius of the helix.
%
%    real THETA1, THETA2, the first and last THETA values at
