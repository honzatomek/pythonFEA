function pn = cylinder_point_near ( p1, p2, r, p )

%*****************************************************************************80
%
%% cylinder_point_near() determines the nearest point on a cylinder to a point.
%
%  Discussion:
%
...
%
%    real P(3,1), the point.
%
%  Output:
%
%    real PN(3,1), the nearest point on the cylinder.
%
  ...
  off_axis_component = norm ( off_axis );
%
