function gen_hermite_ek_compute_test ( )
...
%
  ...
  fprintf ( 1, '\n' );
  fprintf ( 1, 'GEN_HERMITE_EK_COMPUTE_TEST\n' );
  fprintf ( 1, '  GEN_HERMITE_EK_COMPUTE computes \n' );
  fprintf ( 1, '  a generalized Hermite quadrature rule\n' );
