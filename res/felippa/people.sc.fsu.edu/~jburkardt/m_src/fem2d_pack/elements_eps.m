...
%
%    real NODE_X(NODE_NUM), NODE_Y(NODE_NUM), the
%    coordinates of the nodes.
%
%    string CODE, the code for the element.
%
%    integer ELEMENT_ORDER, the element order.
%
%    integer ELEMENT_NUM, the number of elements.
%
%    logical ELEMENT_MASK(ELEMENT_NUM), a mask for the elements.
%
%    integer ELEMENT_NODE(ELEMENT_ORDER,ELEMENT_NUM), the
%    element->node data.
%
