...
%  Input:
%
%    real T(2,6), the nodal oordinates of the element.
%    It is common to list these points in counter clockwise order.
%
%    real P(2,N), the evaluation points.
%
%  Output:
%
%    real PHI(6,N), the basis functions at the evaluation points.
%
%    real DPHIDX(6,N), DPHIDY(6,N), the basis derivatives at the 
%    evaluation points.
%
%  Local:
%
