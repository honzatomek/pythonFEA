...
%  Input:
%
%    real T(2,4), the coordinates of the vertices
...
%
%    real P(2), the points where the basis function
%    is to be evaluated.
%
%  Output:
%
%    real PHI, the value of the basis function
%    at the evaluation point.
%
%    real DPHIDX, DPHIDY, the value of the
