...
%  Input:
%
%    real T(2,3), the vertices of the triangle.  It is common to list 
%    these points in counter clockwise order.
%
%    integer N, the number of evaluation points.
%
%    real P(2,N), the coordinates of the evaluation points.
%
%  Output:
%
%    real PHI(3,N), the basis functions at the evaluation points.
%
%    real DPHIDX(3,N), DPHIDY(3,N), the basis derivatives 
%    at the evaluation points.
%
%  Local:
%
%    real AREA, is (twice) the area of the triangle.
%
