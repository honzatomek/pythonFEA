...
%  Input:
%
%    character CODE(*), identifies the element.
%    Legal values include 'Q4', 'Q8', 'Q9', 'Q12', 'Q16', 'QL',
%    'T3', 'T6' and 'T10'.
%
%    integer ELEMENT_ORDER, the order associated with the code.
%
%  Output:
%
%    real W(ELEMENT_ORDER,ELEMENT_ORDER), the interpolation matrix.
%
