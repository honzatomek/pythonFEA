...
%  Input:
%
%    string CODE, identifies the element.
%    Legal values include 'Q4', 'Q8', 'Q9', 'Q12', 'Q16', 'QL',
%    'T3', 'T4', 'T6' and 'T10'.
%
%    real R, S, the reference coordinates of a point.
%
%  Output:
%
%    real T(ELEMENT_ORDER), the basis functions at the point.
%
%    real DTDR(ELEMENT_ORDER), the R basis derivatives at the point.
%
%    real DTDS(ELEMENT_ORDER), the S basis derivatives at the point.
%
  if ( s_eqi ( code, 'Q4' ) )
