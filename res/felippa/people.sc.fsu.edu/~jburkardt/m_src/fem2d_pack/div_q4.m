...
%  Input:
%
%    integer M, the number of data rows.  M must be at least 2.
%
%    integer N, the number of data columns.  N must be at least 2.
%
%    real U(M,N), V(M,N), the value of the components
