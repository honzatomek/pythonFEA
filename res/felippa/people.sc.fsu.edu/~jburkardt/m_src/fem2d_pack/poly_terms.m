function [ rexp, sexp ] = poly_terms ( code )

%*****************************************************************************80
%
%% poly_terms() returns the polynomial terms associated with any available element.
%
%  Discussion:
%
...
%  Input:
%
%    character CODE(*), identifies the element desired.
%    Legal values include 'Q4', 'Q8', 'Q9', 'Q12', 'Q16', 'QL', 'T3',
%    'T6' and 'T10'.
%
%  Output:
%
%    integer REXP(N), SEXP(N), the powers of R and S associated
...
%
  ...
  elseif ( s_eqi ( code, 'T10' ) )
    ...
    fprintf ( 1, '\n' );
    fprintf ( 1, 'poly_terms - Fatal error!\n' );
    fprintf ( 1, '  Illegal value of CODE = "%s"\n', code );
    error ( 'poly_terms - Fatal error!' );
