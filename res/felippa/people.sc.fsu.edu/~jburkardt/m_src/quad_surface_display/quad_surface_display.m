...
%
%    integer NODE_XY(2,NODE_NUM), the coordinates of the nodes.
%
%    integer QUAD_NUM, the number of quadrilaterals.
%
%    integer QUAD_NODE(4,QUAD_NUM), the nodes of each quadrilateral.
%
%    real VALUE(NODE_NUM), the value assigned to each node.
%
  fprintf ( 1, '\n' );
  fprintf ( 1, 'QUAD_SURFACE_DISPLAY:\n' );
  fprintf ( 1, '  Display a surface defined by a quadrilateral mesh.\n' );
