...
%*****************************************************************************80
%
%% product_rule() computes a product quadrature rule.
%
%  Licensing:
%
...
%  Input:
%
%    character LIST_FILENAME, the name of the file listing the factors.
%
%    character QUAD_FILENAME, the prefix to use for the product rule files.
%
  timestamp ( );
  fprintf ( 1, '\n');
...
%  Input:
%
%    string LIST_FILENAME, a file containing a list
%    of prefixes defining quadrature rules.
%
%    integer LIST_NUM, the number of prefixes in the file.
%
%  Output:
%
%    integer POINT_NUM, the number of points in the product rule.
%
  point_num = 1;
