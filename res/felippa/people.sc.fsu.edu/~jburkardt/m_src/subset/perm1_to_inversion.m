function ins = perm1_to_inversion ( n, p )

%*****************************************************************************80
%
%% perm1_to_inversion(): permutation (1,...,N) to inversion sequence.
%
%  Discussion:
%
...
%
  ...
  if ( ierror )
    fprintf ( 1, '\n' );
    fprintf ( 1, 'PERM1_TO_INVERSION - Fatal error!\n' );
    ...
    error ( 'PERM1_TO_INVERSION - Fatal error!' );
  end
