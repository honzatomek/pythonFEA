...
%  Input:
%
%    integer N, number of elements in the partially ordered set.
%
%    integer A(N,N).  A(I,J) = 1 if I is covered by J,
%    0 otherwise.
%
%  Output:
%
%    integer MU(N,N), the Moebius matrix as computed by the routine.
%
