...
%  Input:
%
%    integer N, the number of matrices to be multiplied.
%
%    integer RANK(N+1), the rank information for the matrices.
%    Matrix I has RANK(I) rows and RANK(I+1) columns.
%
%  Output:
%
%    integer COST, the cost of the multiplication if the optimal
%    order is used.
%
%    integer ORDER(N-1), indicates the order in which the N-1
