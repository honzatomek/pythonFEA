function [ lambda, a ] = perm1_to_ytb ( n, p )

%*****************************************************************************80
%
%% perm1_to_ytb() converts a permutation of (1,...,N) to a Young tableau.
%
%  Discussion:
%
...
%  Output:
%
%    integer LAMBDA(N).  LAMBDA(I) is the length of the I-th row.
%
