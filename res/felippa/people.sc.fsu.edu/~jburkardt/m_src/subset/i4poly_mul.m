...
%
%    integer A(1:NA+1), the coefficients of the first polynomial factor.
%
%    integer NB, the dimension of B.
%
%    integer B(1:NB+1), the coefficients of the second polynomial factor.
%
%  Output:
%
%    integer C(1:NA+NB+1), the coefficients of A * B.
%
  c(1:na+nb+1) = 0;
