function [ npart, jarray, iarray ] = perm1_to_equiv ( n, p )

%*****************************************************************************80
%
%% perm1_to_equiv() computes the partition induced by a permutation of (1,...,N).
%
%  Example:
%
%    Input:
...
%
  ...
  if ( ierror ~= 0 )
    fprintf ( 1, '\n' );
    fprintf ( 1, 'PERM1_TO_EQUIV - Fatal error!\n' );
    ...
    error ( 'PERM1_TO_EQUIV - Fatal error!' );
  end
%
%  Initialize.
%
