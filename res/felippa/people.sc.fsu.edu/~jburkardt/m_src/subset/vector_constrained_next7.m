...
%
%    integer X_MAX(N), the maximum values allowed in each component.
%
...
%
%    real Q_MIN, Q_MAX, the lower and upper limits on the sum.
%
%    logical MORE.  If the user has set MORE
...
%    in the list.
%
%    logical MORE is TRUE if the next value of X was found, and
