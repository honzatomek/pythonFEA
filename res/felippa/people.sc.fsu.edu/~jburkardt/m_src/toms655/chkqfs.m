...
%    comments in CAWIQ.
%
%    integer KEY, indicates the structure of the WTS
...
%    in CAWIQ.
%
%    integer MOP, the expected order of precision of the
%    quadrature formula.
%
%    integer MEX, the number of moments to be tested.
...
%
%    integer LO, selects the action to carry out.
%     > 0, print weights and moment tests.
%     = 0, print nothing. compute moment test.
%     < 0, print weights only. don't compute moment tests.
%
%    real W(MEX), the moments array.  This is input
%    only if KIND = 0.
%
%  Output:
%
%    real W(MEX), the moments array.
%
%    real E(MEX), ER(MEX), the absolute and relative
%    errors of the quadrature formula applied to (x-del)^n.
%
%    real QM(MEX), the values of the quadrature formula
%    applied to (X-DEL)^N.
%
