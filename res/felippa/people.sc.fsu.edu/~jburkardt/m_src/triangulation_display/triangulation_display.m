...
%  Input:
%
%    character prefix, the common prefix for the node and element files:
%
%    integer node_show, indicates the node visibility:
%
%    integer element_show, indicates the element visibility:
%
%    integer neighbor_show, indicates the element neighbor visibility,
%    if the element neighbor file exists:
%
  timestamp ( );
  fprintf ( 1, '\n' );
...
%  Input:
%
%    character FILE_NAME, the name of the file.
%
%  Output:
%
...
%  Input:
%
%    string TITLE_STRING, a title for the plot.
%
...
%    integer ELEMENT_NUM, the number of elements.
%
%    integer ELEMENT_NODE(ELEMENT_ORDER,ELEMENT_NUM), lists, 
%    for each element, the indices of the points that form the vertices 
%    of the element.
%
%    integer ELEMENT_NEIGHBOR(3,ELEMENT_NUM).  ELEMENT_NEIGHBOR(I,J)
