...
%  Output:
%
%    integer TRIANGLES(3,N-2), the triangles of the triangulation.
%
  angle_tol = 5.7E-05;
%
...
%  Input:
%
%    real XA, YA, XB, YB, XC, YC, the coordinates of the vertices.
%
%  Output:
%
%    integer VALUE, is true if C is between A and B,
%    and false otherwise.
%
...
%  Input:
%
%    real XA, YA, XB, YB, XC, YC, the vertex coordinates.
%
%  Output:
%
%    integer VALUE, is true if the points are judged to be collinear,
%    and false otherwise.
%
...
%  Input:
%
%    real XA, YA, XB, YB, XC, YC, XD, YD, the X and Y coordinates
