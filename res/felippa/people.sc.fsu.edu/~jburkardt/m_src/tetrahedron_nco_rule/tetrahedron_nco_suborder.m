function suborder = tetrahedron_nco_suborder ( rule, suborder_num )
...
%  Output:
%
%    integer SUBORDER(SUBORDER_NUM), the suborders of the rule.
%
  if ( rule == 1 )
  ...
  elseif ( rule == 7 )
    ...
    fprintf ( 1, '\n' );
    fprintf ( 1, 'TETRAHEDRON_NCO_SUBORDER - Fatal error!\n' );
    fprintf ( 1, '  Illegal RULE = %d\n', rule );
    error ( 'TETRAHEDRON_NCO_SUBORDER - Fatal error!' )
