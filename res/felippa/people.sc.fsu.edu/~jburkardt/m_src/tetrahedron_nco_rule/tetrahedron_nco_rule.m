function [ xyz, w ] = tetrahedron_nco_rule ( rule, order_num )
...
%
  ...
  [ suborder_xyz, suborder_w ] = tetrahedron_nco_subrule ( rule, suborder_num );
%
...
%
    elseif ( suborder(s) == 24 )
      ...
      fprintf ( 1, '\n' );
      fprintf ( 1, 'TETRAHEDRON_NCO_RULE - Fatal error!\n' );
      fprintf ( 1, '  Illegal SUBORDER(%d) = %d\n', s, suborder(s) );
      error ( 'TETRAHEDRON_NCO_RULE - Fatal error!' );
