...
%  Input:
%
%    integer MX, MY, the polynomial degree in X and Y.
%
%    real XD_1D(MX+1,1), YD_1D(MY+1,1), the 1D data locations.
%
%    real ZD((MX+1)*(MY+1)), the 2D array of data values,
%    stored as a vector.
%
%    integer NI, the number of 2D interpolation points.
%
%    real XI(NI,1), YI(NI,1), the 2D interpolation points.
%
%  Output:
%
