...
%  Output:
%
%    real ATAN4, an angle between 0 and 2 * PI, whose tangent is
...
%
    ...
    if ( 0.0E+00 < x && 0.0E+00 < y )
      value = theta_0;
    elseif ( x < 0.0E+00 && 0.0E+00 < y )
      value = pi - theta_0;
    elseif ( x < 0.0E+00 && y < 0.0E+00 )
      value = pi + theta_0;
    elseif ( 0.0E+00 < x && y < 0.0E+00 )
      value = 2.0E+00 * pi - theta_0;
    end
