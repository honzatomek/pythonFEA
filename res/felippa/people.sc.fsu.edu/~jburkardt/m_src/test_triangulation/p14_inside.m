function inside = p14_inside ( m, n, point )
...
%
  ...
  for j = 1 : n
    ...
    inside1 = polygon_contains_point_2d ( n1, v1, point(1:m,j) );

    inside2 = polygon_contains_point_2d ( n2, v2, point(1:m,j) );

    inside(j) = ( inside1 && ( ~inside2 ) );
