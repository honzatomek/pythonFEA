function segment_length = p01_boundary_segment_length ( segment_index, h )
...
%
  ...
  if ( h <= 0.0 )
    fprintf ( 1, '\n' );
    fprintf ( 1, 'P01_boundary_segment_length - Fatal error!\n' );
    fprintf ( 1, '  Nonpositive H = %f\n', h );
    error ( 'P01_boundary_segment_length - Fatal error!' );
  end
