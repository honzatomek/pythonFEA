function tetrahedron_shape_test ( )
...
%
  ...
  fprintf ( 1, '\n' );
  fprintf ( 1, 'tetrahedron_shape_test():\n' );
  fprintf ( 1, '  tetrahedron_size() returns dimension information;\n' );
  fprintf ( 1, '  tetrahedron_shape() returns face and order info.\n' );
  fprintf ( 1, '\n' );
