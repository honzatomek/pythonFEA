function tetrahedron_quality2_test ( )
...
%
  ...
  fprintf ( 1, '\n' );
  fprintf ( 1, 'tetrahedron_quality2_test():\n' );
  fprintf ( 1, '  tetrahedron_quality2() computes quality measure #2\n' );
  ...
  for test = 1 : test_num
    ...
    disp ( tetra );
    quality2 = tetrahedron_quality2 ( tetra );
