...
%*****************************************************************************80
%
%% ellipse_test() is the main program for the ELLIPSE code.
%
%  Discussion:
%
...
%
%    integer NTG1, the parameter determining the number of target points.
%
...
%
%    real C0(0+1:DEGMAX+2,1:DEGMAX+2), the coefficient matrix.
%
...
%
%    real C1, C2, ALPHA, BETA, the center and scale
...
%  Input:
%
%    real X, a point in [-1,+1];
%
%  Output:
%
%    real VALUE, a corresponding point in [-pi/2,+pi/2].
%
  value = pi * x / 2.0;
...
%  Input:
%
%    real X, a point in [-pi/2,+pi/2].
%
%  Output:
%
%    real VALUE, a corresponding point in [-1,+1].
%
  value = 2.0 * x / pi;
