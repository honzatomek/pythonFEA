function rectangle_test ( )

%*****************************************************************************80
%
%% rectangle_test() is the main program for RECTANGLE.
%
%  Discussion:
%
...
%  Local:
%
%    integer DEGMAX, the maximum degree of interpolation.
%
%    integer NPDMAX, the maximum number of Padua points
%    = (DEGMAX + 1) * (DEGMAX + 2) / 2.
%
%    integer NTG1MX, the maximum value of the parameter determining 
%    the number of target points.
%
%    integer NTGMAX, the maximum number of target points,
%    dependent on NTG1MX.
%
%    integer DEG, the degree of interpolation,
%
%    integer NTG1, the parameter determining the number 
%    of target points.
%
%    integer FAMILY, specifies the desired family of Padua points.
%
%    integer NPD, the number of Padua points = (DEG + 1) * (DEG + 2) / 2.
%
%    integer NTG, the number of target points, dependent on NTG1.
%
%    real PD1(NPDMAX), the first coordinates of 
%    the Padua points.
%
%    real PD2(NPDMAX), the second coordinates of the 
%    Padua points.
%
%    real WPD(NPDMAX), the weights.
%
%    real FPD(NPDMAX), the function at the Padua points.
%
%    Workspace, real RAUX1(DEGMAX+1)*(DEGMAX+2)).
%
%    Workspace, real RAUX2(DEGMAX+1)*(DEGMAX+2)).
%
%    real C0(0:DEGMAX+1,0:DEGMAX+1), the coefficient matrix.
%
%    real TG1(NTGMAX), the first coordinates of the 
%    target points.
%
%    real TG2(NTGMAX), the second coordinates of the 
%    target points.
%
%    real INTFTG(NTGMAX), the values of the 
%    interpolated function.
%
%    real MAXERR, the maximum norm of the error at target 
%    points.
%
%    real ESTERR, the estimated error.
%
  degmax = 60;
  ntg1mx = 100;
...
%  Input:
%
%    real T1, T2, the coordinates of a point in the square.
%
%    real A1, B1, A2, B2, the coordinates of the extreme
%    corners of the rectangle.
%
%    integer FAMILY, DEG, select the family of Padua points at 
%    degree DEG.
%
%  Output:
%
%    real VALUE, the X coordinate of the corresponding
...
%  Input:
%
%    real SIGMA1, SIGMA2, the coordinates of a point 
%    in the rectangle.
%
%    real A1, B1, A2, B2, the coordinates of the extreme
%    corners of the rectangle.
...
%  Output:
%
%    real VALUE, the Y coordinate of the corresponding
%    point in the rectangle.
%
  theta = ( 2 * mod ( deg, 2 ) - 1 ) * ( family - 1 ) * pi / 2.0;
...
%    corners of the rectangle.
%
%    integer NTG1, a parameter determining the number 
%    of target points
%
%    integer NTGMAX, the maximum number of target points.
%
%  Output:
%
%    real TG1(NTG), TG2(NTG), the X and Y coordinates
%    of the target points.
%
%    integer NTG, the number of target points computed.
%
  if ( ntg1 < 2 )
    fprintf ( 1, '\n' );
