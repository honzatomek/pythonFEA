...
%*****************************************************************************80
%
%% power_rule() creates a multidimensional quadrature rule as a power.
%
%  Licensing:
%
...
%  Input:
%
%    character quad_1d_filename, the name of the file containing the 1d rule.
%
%    integer dim_num, the number of dimensions for the new rule.
%
  timestamp ( );
  fprintf ( 1, '\n' );
...
%  Input:
%
%    integer POINT_NUM_1D, the order of the 1D rule.
%
%    real X_1D(POINT_NUM_1D), the points of the 1D rule.
%
%    real W_1D(POINT_NUM_1D), the weights of the 1D rule.
%
%    real R_1D(2), the extreme points that define
...
%  Output:
%
%    real X(DIM_NUM,POINT_NUM), the points of the rule.
%
%    real W(POINT_NUM), the weights of the rule.
%
%    real R(DIM_NUM,2), the extreme points 
...
%  Input:
%
%    integer POINT_NUM_1D, the number of points in the 1D rule.
%
%    integer DIM_NUM, the spatial dimension.
%
%  Output:
