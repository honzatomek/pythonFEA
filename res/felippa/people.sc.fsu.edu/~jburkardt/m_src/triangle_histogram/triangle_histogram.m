...
%*****************************************************************************80
%
%% triangle_histogram() produces a histogram of points within a triangle.
%
%  Discussion:
%
...
%  Input:
%
%    character data_filename, the name of the file containing the sample points,
%
%    integer n, the number of subintervals each triangle side is divided into.
%
  timestamp ( );
  fprintf ( 1, '\n' );
...
%
  ...
  fprintf ( 1, '\n' );
  fprintf ( 1, '  Number of out-of-range points = %8d\n', histo(n*n+1) );
%
%  Terminate.
%
  fprintf ( 1, '\n' );
