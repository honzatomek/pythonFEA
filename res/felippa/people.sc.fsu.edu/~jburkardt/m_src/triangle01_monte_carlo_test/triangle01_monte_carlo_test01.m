function triangle01_monte_carlo_test01 ( )

%*****************************************************************************80
%
%% triangle01_monte_carlo_test01() estimates integrals over the unit triangle in 2D.
%
%  Licensing:
%
...
%
  ...
  fprintf ( 1, '\n' );
  fprintf ( 1, 'TRIANGLE01_MONTE_CARLO_TEST01\n' );
