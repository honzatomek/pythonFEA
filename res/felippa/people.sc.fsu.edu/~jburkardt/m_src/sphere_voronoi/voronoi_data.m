function [ area, centroid ] = voronoi_data ( d_num, d_xyz, face_num, ...
  face_d, v_xyz )
...
%  Input:
%
%    integer D_NUM, the number of data points and Voronoi polygons.
%
%    real D_XYZ(3,D_NUM), the coodinates of the data points.
%
%    integer FACE_NUM, the number of faces, and Voronoi vertices.
%
%    integer FACE_D(3,FACE_NUM), the data points that form
%    each triangle.
%
%    real V_XYZ(3,FACE_NUM), the coordinates of the Voronoi vertices.
%
%  Output:
%
%    real AREA(D_NUM), the area of each Voronoi polygon.
%
%    real CENTROID(3,D_NUM), the centroids of each Voronoi polygon.
%
  area = zeros ( d_num, 1 );
