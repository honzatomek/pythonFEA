function chebyshev2_rule ( order, a, b, filename )

%*****************************************************************************80
%
%% chebyshev2_rule() generates a Gauss-Chebyshev type 2 quadrature rule.
%
%  Discussion:
%
...
%  Input:
%
%    integer ORDER (number of points) in the rule;
%
...
%
  timestamp ( );
  fprintf ( 1, '\n' );
  fprintf ( 1, 'CHEBYSHEV2_RULE\n' );
  fprintf ( 1, '  MATLAB version\n' );
  fprintf ( 1, '\n' );
  fprintf ( 1, '  Compute a Gauss-Chebyshev type 2 rule for approximating\n' );
...
%
  if ( nargin < 4 )
    ...
    filename = input ( '  Enter FILENAE as a quoted string:  ' );
  end
%
%  Input summary.
%
