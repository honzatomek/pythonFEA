...
%  Input:
%
%    integer D1, the degree of factor 1.
%
%    real P1(M1), the factor 1 coefficients.
%    M1 = ((D1+1)*(D1+2))/2.
%
%    integer D2, the degree of factor 2.
%
%    real P2(M2), the factor2 coefficients.
%    M2 = ((D2+1)*(D2+2))/2.
%
%  Output:
%
%    integer D3, the degree of the result.
%
%    real P3(M3), the result coefficients.
%    M3 = ((D3+1)*(D3+2))/2.
%
  d3 = d1 + d2;
  m3 = ( ( d3 + 1 ) * ( d3 + 2 ) ) / 2;
