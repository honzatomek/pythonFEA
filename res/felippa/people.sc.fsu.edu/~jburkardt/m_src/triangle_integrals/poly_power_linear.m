...
%  Input:
%
%    integer D1, the degree of the linear polynomial,
%    which should be 1.
%
%    real P1(M1), the coefficients of the linear polynomial.
%    M1 = ( (D1+1)*(D1+2) ) / 2, which should be 3.
%
%    integer N, the power to which the polynomial is to be raised.
%    0 <= N.
%
%  Output:
%
%    integer D2, the degree of the power polyynomial, which
%    should be D2 = N * D1 = N.
%
%    real P2(M2), the coefficients of the power polynomial.
