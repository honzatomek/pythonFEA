...
%  Input:
%
%    integer DEG, the degree of approximation.
%
%    integer DEGMAX, the maximum degree allowed.
%
%    integer NPD, the number of Padua points.
%
%    real WPD(NPD), the weights.
%
%    real FPD(NPD), the value at the Padua points
%    of the function to be interpolated.
%
%  Output:
%
%    real C0(0+1:DEG+1,0+1:DEG+1), the coefficient matrix.
%
