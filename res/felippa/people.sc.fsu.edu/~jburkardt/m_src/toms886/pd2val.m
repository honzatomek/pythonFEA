...
%
%    real C0(0+1:DEGMAX+1+1,0+1:DEG+1), the coefficient matrix.
%
%    real TG1, TG2, the first and second coordinates of
%    the target point.
%
%  Output:
%
%    real VALUE, the value of the interpolant at the target point.
%
  BASE = 1;
%
