function suborder_num = tetrahedron_ncc_suborder_num ( rule )
...
%
  ...
  elseif ( rule == 7 )
    ...
    suborder_num = -1;
    fprintf ( 1, '\n' );
    fprintf ( 1, 'TETRAHEDRON_NCC_SUBORDER_NUM - Fatal error!\n' );
    fprintf ( 1, '  Illegal RULE = %d\n', rule );
    error ( 'TETRAHEDRON_NCC_SUBORDER_NUM - Fatal error!\n' )
