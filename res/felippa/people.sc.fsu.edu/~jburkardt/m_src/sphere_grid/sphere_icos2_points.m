function node_xyz = sphere_icos2_points ( factor, node_num )
...
%  Input:
%
%    integer FACTOR, the subdivision factor, which must
%    be at least 1.
%
%    integer NODE_NUM, the number of nodes, as reported
%    by SPHERE_GRID_ICOS_SIZE.
%
%  Output:
%
%    real NODE_XYZ(3,NODE_NUM), the node coordinates.
%
%  Local:
%
