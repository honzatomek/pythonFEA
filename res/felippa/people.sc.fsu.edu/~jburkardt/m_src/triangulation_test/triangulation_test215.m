...
%*****************************************************************************80
%
%% triangulation_test215 tests triangulation_order3_refine_compute, triangulation_order3_refine_size.
%
%  Licensing:
%
...
%
  ...
  fprintf ( 1, '\n' );
  fprintf ( 1, 'triangulation_test215\n' );
  ...
  fprintf ( 1, '  TRIANGULATION_ORDER3_REFINE_COMPUTE computes the\n' );
