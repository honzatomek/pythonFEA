...
%*****************************************************************************80
%
%% triangulation_test219() tests triangulation_search_delaunay() and triangulation_search_naive().
%
%  Licensing:
%
...
%
  ...
  fprintf ( 1, '\n' );
  fprintf ( 1, 'triangulation_test219\n' );
...
%  Get the test points.
%
  [ p_test, t_test ] = triangulation_order3_sample ( node_num, ...
    node_xy, triangle_num, triangle_node, test_num );
