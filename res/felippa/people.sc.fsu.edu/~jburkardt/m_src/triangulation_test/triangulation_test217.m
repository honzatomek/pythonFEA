...
%*****************************************************************************80
%
%% triangulation_test217() tests triangulation_search_delaunay().
%
%  Licensing:
%
...
%
  ...
  fprintf ( 1, '\n' );
  fprintf ( 1, 'triangulation_test217\n' );
...
%  Get the test points.
%
  [ xd, td ] = triangulation_order3_sample ( node_num, node_xy, ...
    triangle_num, triangle_node, test_num );
