function wedge_grid_plot ( n, ng, g, header )
...
%
%    integer NG, the number of nodes.
%
%    real G(3,NG), the grid point coordinates.
%
%    string HEADER, the header for the files.
%

%
%  Create the vertex file.
%
  [ v1, v2, v3, v4, v5, v6 ] = wedge_vertices ( );
