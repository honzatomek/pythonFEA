function triangle_fekete_rule_test04 ( )

%*****************************************************************************80
%
%% triangle_fekete_rule_test04() tests fekete_rule().
%
%  Licensing:
%
...
%
  fprintf ( 1, '\n' );
  fprintf ( 1, 'TRIANGLE_FEKETE_RULE_TEST04\n' );
  fprintf ( 1, '  FEKETE_RULE returns the points and weights of\n' );
  fprintf ( 1, '  a Fekete rule for the unit triangle.\n' );
  fprintf ( 1, '\n' );
