...
%
%    real XYZ(3,N), the coordinates of the points.
%
%    integer FACE_NUM, the number of Delaunay triangles.
%
%    integer FACE(3,FACE_NUM), the indices of points that
%    form each Delaunay triangle.
%
%  Output:
%
%    real V(3,N), the coordinates of the Voronoi vertices.
%    
  for f = 1 : face_num
