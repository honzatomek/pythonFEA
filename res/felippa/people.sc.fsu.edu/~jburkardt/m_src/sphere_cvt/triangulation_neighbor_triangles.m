...
%    neighbors of a given triangle.  TRIANGLE_NEIGHBOR(1,I) is the index of the
%    triangle which touches side 1, defined by nodes 2 and 3, and so on. 
%    TRIANGLE_NEIGHBOR(1,I) is negative if there is no neighbor on that side.  
%    In this case, that side of the triangle lies on the boundary of the
%    triangulation.
%
