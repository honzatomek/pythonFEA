...
%  Input:
%
%    integer NODE_NUM1, the number of nodes in the input mesh.
%
...
%    in the input mesh.
%
%    integer NODE_NUM2, the number of nodes for the refined mesh.
%
...
%
%    integer TETRA_NODE2(4,TETRA_NUM2), the indices of the nodes
%    in the output mesh.
%
