function [ value_min, value_mean, value_max, value_var ] = ...
  tet_mesh_quality3 ( node_num, node_xyz, tetra_order, tetra_num, ...
  tetra_node )
...
%
%    double NODE_XYZ(3,NODE_NUM), the nodes.
%
%    integer TETRA_ORDER, the order of the tetrahedrons.
%
%    integer TETRA_NUM, the number of tetrahedrons.
%
%    integer TETRA_NODE(TETRA_ORDER,TETRA_NUM), the indices of the nodes
%    that make up the tetrahedrons.
%
%  Output:
%
%    double VALUE_MIN, VALUE_MEAN, VALUE_MAX, VALUE_VAR,
