...
%  Input:
%
%    integer TETRA_NUM, the number of tetrahedrons in the
%    linear mesh.
%
%    integer TETRA_NODE1(4,TETRA_NUM), the nodes that make up
%    each tetrahedron in the linear mesh.
%
%    integer NODE_NUM1, the number of nodes for the linear mesh.
%
%    real NODE_XYZ1(3,NODE_NUM1), the coordinates of
%    the nodes that make up the linear mesh.
%
%    integer EDGE_DATA(5,6*TETRA_NUM), edge data.
%
%    integer NODE_NUM2, the number of nodes for the quadratic mesh.
%
%  Output:
%
%    integer TETRA_NODE2(10,TETRA_NUM), the nodes that make up
%    each tetrahedron in the quadratic mesh.
%
%    real NODE_XYZ2(3,NODE_NUM2), the coordinates of
