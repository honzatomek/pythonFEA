...
%  Input:
%
%    integer NODE_NUM, the number of nodes in the tet mesh.
%
%    real NODE_XYZ(3,NODE_NUM), the coordinates 
%    of the nodes.
%
%    integer TET_ORDER, the order of tetrahedrons in the tet mesh.
%
%    integer TET_NUM, the number of tetrahedrons in the tet mesh.
%
%    integer TET_NODE(TET_ORDER,TET_NUM), 
%    the nodes making up each tetrahedron.
%
%    function QUAD_FUN ( N, XYZ_VEC), the name of the function that 
%    evaluates the integrand.
%
%    integer QUAD_NUM, the order of the quadrature rule.
%
%    real QUAD_XYZ(3,QUAD_NUM), the abscissas of the 
...
%
%    real REGION_VOLUME, the volume of the region.
%
  quad_value = 0.0;
  region_volume = 0.0;
