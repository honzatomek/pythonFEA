...
%  Input:
%
%    integer TETRA_NUM1, the number of tetrahedrons in the quadratic
%    tet mesh.
%
%    integer TETRA_NODE1(10,TETRA_NUM1), the quadratic tet mesh.
%
%    integer TETRA_NUM2, the number of tetrahedrons in the linear
%    tet mesh.  TETRA_NUM2 = 8 * TETRA_NUM1.
%
%  Output:
%
%    integer TETRA_NODE2(4,TETRA_NUM2), the linear tet mesh.
%
  tetra2 = 0;
