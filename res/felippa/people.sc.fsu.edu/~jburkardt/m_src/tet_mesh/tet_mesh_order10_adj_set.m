...
%
%    integer TETRA_NODE(10,TETRA_NUM), the nodes that make up the
%    tetrahedrons.
%
%    integer ADJ_NUM, the total number of adjacency relationships,
%
%    integer ADJ_ROW(NODE_NUM+1), the ADJ pointer array.
%
%  Output:
%
%    integer ADJ(ADJ_NUM), the adjacency information.
%
