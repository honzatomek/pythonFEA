function line01_sample_random_test ( )
...
%
  fprintf ( 1, '\n' );
  fprintf ( 1, 'LINE01_SAMPLE_RANDOM_TEST\n' );
  fprintf ( 1, '  LINE01_SAMPLE_RANDOM randomly samples the unit line segment.\n' );
