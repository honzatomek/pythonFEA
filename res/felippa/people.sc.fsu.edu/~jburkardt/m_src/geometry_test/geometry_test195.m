function geometry_test195 ( )

%*****************************************************************************80
%
%% geometry_test195() tests sphere01_sample3_nd().
%
%  Licensing:
%
...
%
  ...
  fprintf ( 1, '\n' );
  fprintf ( 1, 'geometry_test195():\n' );
  fprintf ( 1, '  For the unit sphere in N dimensions:\n' );
  fprintf ( 1, '  SPHERE01_SAMPLE3_ND samples;\n' );
