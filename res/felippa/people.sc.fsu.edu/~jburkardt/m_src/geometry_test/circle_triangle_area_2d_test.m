function circle_triangle_area_2d_test ( )
...
%
  ...
  fprintf ( 1, '\n' );
  fprintf ( 1, 'circle_triangle_area_2d_test():\n' );
  fprintf ( 1, '  circle_triangle_area_2d() computes the area of a\n' );
  fprintf ( 1, '  circular triangle.\n' );
  fprintf ( 1, '\n' );
