function cylinder_point_dist_signed_test ( )

%*****************************************************************************80
%
%% cylinder_point_dist_signed_test() tests cylinder_point_dist_signed().
%
%  Licensing:
%
...
%
  ...
  fprintf ( 1, '\n' );
  fprintf ( 1, 'cylinder_point_dist_signed_test():\n' );
  fprintf ( 1, '  cylinder_point_dist_signed() computes the signed\n' );
  ...
  for test = 1 : test_num
    ...
    dist = cylinder_point_dist_signed ( p1, p2, r, p );
