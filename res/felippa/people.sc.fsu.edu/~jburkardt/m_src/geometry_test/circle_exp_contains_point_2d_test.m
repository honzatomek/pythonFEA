function circle_exp_contains_point_2d_test ( )
...
%
  ...
  fprintf ( 1, '\n' );
  fprintf ( 1, 'circle_exp_contains_point_2d_test():\n' );
  fprintf ( 1, '  circle_exp_contains_point_2d() determines if a\n' );
  fprintf ( 1, '  point lies inside a circle.\n' );
%
%  This point is inside.
%
  p1(1:dim_num,1) = [  4.0, 2.0 ];
  p2(1:dim_num,1) = [  1.0, 5.0 ];
  p3(1:dim_num,1) = [ -2.0, 2.0 ];
  p(1:dim_num,1)  = [  2.0, 3.0 ];
