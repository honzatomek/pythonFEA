function cylinder_point_near_test ( )

%*****************************************************************************80
%
%% cylinder_point_near_test() tests cylinder_point_near().
%
%  Licensing:
%
...
%
  ...
  fprintf ( 1, '\n' );
  fprintf ( 1, 'cylinder_point_near_test():\n' );
  fprintf ( 1, '  cylinder_point_near() computes the nearest point\n' );
  ...
  for test = 1 : test_num
    ...
    pn = cylinder_point_near ( p1, p2, r, p );
