function plane_exp_project_test ( )

%*****************************************************************************80
%
%% plane_exp_project_test() tests plane_exp_project().
%
%  Licensing:
%
...
%
  ...
  fprintf ( 1, '\n' );
  fprintf ( 1, 'plane_exp_project_test():\n' );
  fprintf ( 1, '  plane_exp_project() projects a point through\n' );
...
%
  ...
  [ pp, ivis ] = plane_exp_project ( p1, p2, p3, pf, n, po );
