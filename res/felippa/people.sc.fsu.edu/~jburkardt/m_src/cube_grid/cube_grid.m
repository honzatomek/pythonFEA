function x = cube_grid ( n, ns, a, b, c )
...
%
%    integer NS(3), the number of points along 
%    each dimension.
%
%    real A(3), B(3), the endpoints for each dimension.
%
%    integer C(3), the grid centering for each dimension.
%    1 <= C(*) <= 5.
%
%  Output:
%
%    real X(3,N) = X(3*S(1)*S(2)*S(3)), the points.
%
  m = 3;
%
