...
%
%    integer N_DATA_NEW, the index of the test data.
%
%    integer NROW, NCOL, the number of rows and columns of A.
%
%    integer NSYS, the number of systems.
%
%    real A(NROW,NCOL), the matrix.
%
%    real X(NCOL,NSYS), the solutions of the linear system.
%
%    real B(NROW,NSYS), the right hand sides.
%
  n_max = 4;
