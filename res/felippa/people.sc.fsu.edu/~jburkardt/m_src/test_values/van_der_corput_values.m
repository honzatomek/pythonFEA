function [ n_data, base, key, value ] = van_der_corput_values ( n_data )
...
%
%    integer key, the index of the element of the sequence.
%
%    real VALUE, the value of the key-th element of the
