...
%  Input:
%
%    real T(2,3), the X and Y coordinates
...
%
%    real PHY(2,N), the coordinates of points in the physical space.
%
%  Output:
%
%    real REF(2,N), the coordinates of the corresponding
...
function value = triangle01_monomial_integral ( expon )

%*****************************************************************************80
%
%% triangle01_monomial_integral(): integral of a monomial over unit triangle.
%
%  Discussion:
%
%    This routine evaluates a monomial of the form
