...
%  Input:
% 
%    string TYPE, selects the 1D integration rule:
...
%
%    integer DIM, the dimension of the integration problem.
%
%    integer K, the level.  
%
%    integer SYM.  This is only useful when the user has 
...
%  Output:
%
%    real NODES(*,DIM), the quadrature nodes.
%
%    real WEIGHTS(*,1), the weights.
%
%  Local:
%
%    integer R1D(1,K), the length of the rules of levels 1 through K.
%
  if ( nargin < 3 )
...
%
%  If the user indicates that it's a symmetric rule, then 
