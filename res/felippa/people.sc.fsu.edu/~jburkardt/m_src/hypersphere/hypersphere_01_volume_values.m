function [ n_data, n, volume ] = hypersphere_01_volume_values ( n_data )
...
%  Input:
%
%    integer N_DATA: if N_DATA is 0, the first test data is returned, and
%    N_DATA is set to the index of the test data.  
%
%  Output:
%
%    integer N_DATA, increments the input value by 1.  But if there is
%    no more data to return, N_DATA is reset to 0.
%
