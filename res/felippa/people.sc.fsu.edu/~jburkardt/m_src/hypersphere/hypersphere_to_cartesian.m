...
%
%    real C(M,1), the center of the hypersphere.
%
%    real R(N,1), the radius of the points on the hypersphere.
%    Except for the trivial case M = 1, R is assumed nonnegative.
%
%    real THETA(M-1,N), the coordinate angles of the points,
%    measured in radians.
%
%  Output:
%
%    real X(M,N), the Cartesian coordinates of the points.
%
  x = zeros ( m, n );
%
%  Make R a row vector.
