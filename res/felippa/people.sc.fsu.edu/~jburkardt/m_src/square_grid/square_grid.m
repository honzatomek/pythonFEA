...
%
%    integer NS(2), the number of points along 
%    each dimension.
%
%    real A(2), B(2), the endpoints for each dimension.
%
%    integer C(2), the grid centering for each dimension.
%    1 <= C(*) <= 5.
%
%  Output:
%
%    real X(2,N) = X(2*S(1)*S(2)), the points.
%
  m = 2;
%
