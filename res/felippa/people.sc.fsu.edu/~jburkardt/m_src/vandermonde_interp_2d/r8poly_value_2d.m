...
%
%    real C(T(M+1),1), the polynomial coefficients.  C(1) is
...
%
%    real X(N,1), Y(N,1), the evaluation points.
%
%  Output:
%
%    real P(N,1), the value of the polynomial at the evaluation points.
%
  p = zeros ( n, 1 );
