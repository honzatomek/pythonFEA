...
%  Usage:
%
%    triangulation_plot prefix node_show triangle_show
%
%    where:
%
...
%
%    'triangle_show' indicates the triangle visibility:
%
...
%  Input:
%
%    character prefix, the common prefix for the node and triangle files:
%
%    integer node_show, indicates the node visibility:
%
%    integer triangle_show, indicates the triangle visibility:
%
  timestamp ( );
...
%  Input:
%
%    string FILE_NAME, the name of the output file.
%
...
%
%    integer TRIANGLE_NODE(3,TRIANGLE_NUM), lists, for each triangle,
...
%    integer TRIANGLE_NUM, the number of triangles.
%
%    integer TRIANGLE_NODE(4,TRIANGLE_NUM), lists, for each triangle,
%    the indices of the points that form the vertices of the triangle.
%
%    logical NODE_SHOW:
%    0, do not show the nodes.
...
%  Input:
%
%    character FILE_NAME(*), the name of the output file.
%
%    integer NODE_NUM, the number of points.
%
%    real NODE_XY(2,NODE_NUM), the nodes.
...
%    integer TRIANGLE_NUM, the number of triangles.
%
%    integer TRIANGLE_NODE(6,TRIANGLE_NUM), lists, for each triangle,
