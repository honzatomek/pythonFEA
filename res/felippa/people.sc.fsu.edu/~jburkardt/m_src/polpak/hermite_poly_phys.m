function cx = hermite_poly_phys ( n, x )

%*****************************************************************************80
%
%% hermite_poly_phys() evaluates the Hermite physicist polynomials at X.
%
...
%  Output:
%
%    real CX(1:N+1,1), the values of the first N+1 Hermite
