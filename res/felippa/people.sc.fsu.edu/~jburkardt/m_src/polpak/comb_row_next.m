...
%  Input:
%
%    integer N, the index of the desired row.
%
%    integer ROW(1:N+1):, row N-1 is contained in entries 0 through N-1.  
%
%  Output:
%
%    integer ROW(1:N+1), row N is conains in entries 0 through N.
%
  if ( n < 0 )
    return
  end
