function triangle_monte_carlo_test08 ( )

%*****************************************************************************80
%
%% triangle_monte_carlo_test08() uses triangle_sample_04() on a general triangle.
%
%  Licensing:
%
...
%
  ...
  fprintf ( 1, '\n' );
  fprintf ( 1, 'TRIANGLE_MONTE_CARLO_TEST08\n' );
  ...
  while ( p_num <= 65536 )
    ...
    result = triangle_monte_carlo ( t, p_num, f_num, ...
      @triangle_unit_sample_04, @triangle_integrand_user );
