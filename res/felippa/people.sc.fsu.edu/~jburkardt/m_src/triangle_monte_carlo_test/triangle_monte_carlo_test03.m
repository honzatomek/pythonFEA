function triangle_monte_carlo_test03 ( )

%*****************************************************************************80
%
%% triangle_monte_carlo_test03() uses triangle_sample_03() with an increasing number of points.
%
%  Licensing:
%
...
%
  ...
  fprintf ( 1, '\n' );
  fprintf ( 1, 'TRIANGLE_MONTE_CARLO_TEST03\n' );
  ...
  while ( p_num <= 65536 )
    ...
    result = triangle_monte_carlo ( t, p_num, f_num, ...
      @triangle_unit_sample_03, @triangle_integrand_03 );
