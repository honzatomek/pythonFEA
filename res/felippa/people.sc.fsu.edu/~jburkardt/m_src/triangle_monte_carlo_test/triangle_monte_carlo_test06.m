function triangle_monte_carlo_test06 ( )

%*****************************************************************************80
%
%% triangle_monte_carlo_test06() uses triangle_sample_02() on a general triangle.
%
%  Licensing:
%
...
%
  ...
  fprintf ( 1, '\n' );
  fprintf ( 1, 'TRIANGLE_MONTE_CARLO_TEST06\n' );
  fprintf ( 1, '  Sample using TRIANGLE_UNIT_SAMPLE_02\n' );
  fprintf ( 1, '  Integrate TRIANGLE_INTEGRAND_USER\n' );
  ...
  while ( p_num <= 65536 )
    ...
    result = triangle_monte_carlo ( t, p_num, f_num, ...
      @triangle_unit_sample_02, @triangle_integrand_user );
