...
%    integer M, N, the number of rows and columns.
%
%    integer A(M,N), a sorted array, containing
%    N columns of data.
%
%  Output:
%
%    integer UNIQUE_NUM, the number of unique columns.
%
  if ( n <= 0 )
    unique_num = 0;
    return
...
%
%    integer TRIANGLE_NODE(TRIANGLE_ORDER,TRIANGLE_NUM), the nodes that 
%    make up each triangle.
%
%  Output:
%
%    integer TRIANGLE_NEIGHBOR(3,TRIANGLE_NUM), the three triangles that
