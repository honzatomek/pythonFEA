function triangulation_order3_print ( node_num, triangle_num, node_xy, ...
...
%
%    real NODE_XY(2,NODE_NUM), the point coordinates.
%
%    integer TRIANGLE_NODE(3,TRIANGLE_NUM), the nodes that make up the triangles.
%
%    integer TRIANGLE_NEIGHBOR(3,TRIANGLE_NUM), the triangle neighbors on each side.
...
%
  ...
  fprintf ( 1, '\n' );
  fprintf ( 1, 'TRIANGULATION_ORDER3_PRINT\n' );
