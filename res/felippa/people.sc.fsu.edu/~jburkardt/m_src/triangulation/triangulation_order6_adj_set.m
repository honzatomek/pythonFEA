...
%
%    integer TRIANGLE_NODE(6,TRI_NUM), lists the nodes that
...
%
%    integer TRIANGLE_NEIGHBOR(3,TRI_NUM), for each side of
%    a triangle, lists the neighboring triangle, or -1 if there is
%    no neighbor.
%
%    integer ADJ_NUM, the number of adjacencies.
%
%    integer ADJ_COL(NODE_NUM+1).  Information about column J is stored
