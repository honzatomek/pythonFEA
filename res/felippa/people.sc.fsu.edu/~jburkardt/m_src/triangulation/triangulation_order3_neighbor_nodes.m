...
%  Example:
%
%    On the triangle data structure is:
%
%    Triangle  Nodes
%    --------  ----------
%     1        3,   4,   1
...
%     5        6,   2,   5
%
%  On the auxilliary neighbor arrays are:
%
%    Node  Num  First
%    ----  ---  -----
%     1     4     1
...
%
%    integer NABES_MAX, the maximum dimension of NABES.
%
%    integer TRIANGLE_NODE(3,TRIANGLE_NUM), the nodes that make up each triangle.
%
%  Output:
%
%    integer NABES_FIRST(NODE_NUM), the index in NABES of the first
%    neighbor in the list for each node.
%
%    integer NABES_NUM(NODE_NUM), the number of neighbors of each node.
%
%    integer NABES_DIM, the dimension of NABES.
%
%    integer NABES(NABES_DIM), a list of the neighbors of all the nodes.
