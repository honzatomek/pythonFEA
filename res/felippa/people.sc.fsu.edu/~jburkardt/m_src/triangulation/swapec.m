...
%  Input:
%
%    integer I, the index of the new vertex.
%
%    integer TOP, the index of the top of the stack.
%
%    integer BTRI, BEDG; if positive, are the
%    triangle and edge indices of a boundary edge whose updated indices
%    must be recorded. 
%
%    integer NODE_NUM, the number of node.
%
%    real NODE_XY(2,NODE_NUM), the coordinates of
%    the points.
%
%    integer TRIANGLE_NUM, the number of triangles.
%
%    integer TRIANGLE_NODE(3,TRIANGLE_NUM), the triangle incidence list.  
%
%    integer TRIANGLE_NEIGHBOR(3,TRIANGLE_NUM), the triangle neighbor list; 
%    negative values are used for links of the counter-clockwise linked 
%    list of boundary edges;
%      LINK = -(3*I + J-1) where I, J = triangle, edge index.
%
%    integer WORK(MAXST); entries 1 through TOP
...
%    integer TOP, is zero.
%
%    integer BTRI, BEDG; updated because of swaps.
%
%    integer TRIANGLE_NODE(3,TRIANGLE_NUM), updated because of swaps.
%
%    integer TRIANGLE_NEIGHBOR(3,TRIANGLE_NUM), updated on output because of swaps.
%
