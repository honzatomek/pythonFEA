...
%
%    integer ELEMENT_NUM, the number of element.
%
%    integer ELEMENT_NODE(ELEMENT_ORDER,ELEMENT_NUM), the nodes that 
%    make up each element.
%
%  Output:
%
%    integer ELEMENT_NEIGHBOR(3,ELEMENT_NUM), the three elements that are direct
