...
%  Input:
%
%    integer NODE_NUM, the number of nodes in the
%    triangulation.
%
%    real NODE_XY(2,NODE_NUM), the coordinates of the nodes.
%
%    integer TRIANGLE_ORDER, the order of triangles in
%    the triangulation.
%
...
%  Output:
%
%    real TRIANGLE_AREA(TRIANGLE_NUM), the area of
%    the triangles.
%
%    real TRIANGULATION_AREA, the area of
%    the triangulation.
%
