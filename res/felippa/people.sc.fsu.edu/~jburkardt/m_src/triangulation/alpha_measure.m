...
%
%    We measure the minimum angle among all the triangles in the triangulated
%    dataset.  In degrees, the maximum possible value is 60.  We divide the
%    achieved value by the maximum possible value to get a quality measure.
%
%  Licensing:
%
