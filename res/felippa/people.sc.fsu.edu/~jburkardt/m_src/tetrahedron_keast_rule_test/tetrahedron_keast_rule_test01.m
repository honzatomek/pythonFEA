function tetrahedron_keast_rule_test01 ( )

%*****************************************************************************80
%
%% tetrahedron_keast_rule_test01() tests keast_rule_num(), keast_degree(), keast_order_num().
%
%  Licensing:
%
...
%
  fprintf ( 1, '\n' );
  fprintf ( 1, 'TETRAHEDRON_KEAST_RULE_TEST01\n' );
