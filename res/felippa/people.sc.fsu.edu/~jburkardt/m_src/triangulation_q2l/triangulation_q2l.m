...
%  Input:
%
%    integer TRIANGLE_NUM1, the number of triangles in the quadratic
%    triangulation.
%
%    integer TRIANGLE_NODE1(6,TRIANGLE_NUM1), the quadratic triangulation.
%
%  Output:
%
%    integer TRIANGLE_NODE2(3,4*TRIANGLE_NUM1), the linear triangulation.
%
  tri2 = 0;
