...
//
  ...
  for ( j = 0; j < p_num; j++ )
  {
    x_max = fmax ( x_max, p[0+j*2] );
    x_min = fmin ( x_min, p[0+j*2] );
  }
  for ( j = 0; j < 3; j++ )
  {
    x_max = fmax ( x_max, t[0+j*2] );
    x_min = fmin ( x_min, t[0+j*2] );
  }
  x_scale = x_max - x_min;
  ...
  for ( j = 0; j < p_num; j++ )
  {
    y_max = fmax ( y_max, p[1+j*2] );
    y_min = fmin ( y_min, p[1+j*2] );
  }
  for ( j = 0; j < 3; j++ )
  {
    y_max = fmax ( y_max, t[1+j*2] );
    y_min = fmin ( y_min, t[1+j*2] );
  }
  y_scale = y_max - y_min;
