...
//  Purpose:
//
//    triangle_ncc_rule_test() tests triangle_ncc_rule().
//
//  Licensing:
//
...
//
{
  timestamp ( );
  cout << "\n";
  cout << "TRIANGLE_NCC_RULE_TEST:\n";
  cout << "  C++ version\n";
  cout << "  Test the TRIANGLE_NCC_RULE library.\n";
...
//
{
  ...
  cout << "\n";
  cout << "TEST01\n";
  cout << "  TRIANGLE_NCC_RULE_NUM returns the number of rules;\n";
  cout << "  TRIANGLE_NCC_DEGREE returns the degree of a rule;\n";
  cout << "  TRIANGLE_NCC_ORDER_NUM returns the order of a rule.\n";
...
//
{
  ...
  cout << "\n";
  cout << "TEST02\n";
  cout << "  TRIANGLE_NCC_RULE returns the points and weights\n";
  cout << "  of an NCC rule for the triangle.\n";
  cout << "\n";
...
//
{
  ...
  cout << "\n";
  cout << "TEST04\n";
  cout << "  TRIANGLE_NCC_RULE returns the points and weights of\n";
  cout << "  an NCC rule for the unit triangle.\n";
  cout << "\n";
