...
//
{
  ...
  else
  {
    degree = -1;
    cout << "\n";
    cout << "TRIANGLE_NCO_DEGREE - Fatal error!\n";
...
//
  ...
  for ( s = 0; s < suborder_num; s++ )
  {
    ...
    {
      cout << "\n";
      cout << "TRIANGLE_NCO_RULE - Fatal error!\n;";
...
int triangle_nco_rule_num ( void )
...
//
{
  ...
  {
    cout << "\n";
    cout << "TRIANGLE_NCO_SUBORDER - Fatal error!\n";
    cout << "  Illegal RULE = " << rule << "\n";
    exit ( 1 );
  }
...
//
{
  ...
  else
  {
    suborder_num = -1;
    cout << "\n";
    cout << "TRIANGLE_NCO_SUBORDER_NUM - Fatal error!\n";
    cout << "  Illegal RULE = " << rule << "\n";
    exit ( 1 );
  }
...
//
{
  ...
  {
    cout << "\n";
    cout << "TRIANGLE_NCO_SUBRULE - Fatal error!\n";
    cout << "  Illegal RULE = " << rule << "\n";
    exit ( 1 );
  }
