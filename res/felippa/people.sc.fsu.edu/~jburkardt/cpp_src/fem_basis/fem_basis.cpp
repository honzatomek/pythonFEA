...
//  Input:
//
//    int I, J, the integer barycentric coordinates of
...
//  Output:
//
//    double FEM_BASIS_1D, the value of the basis function at X.
//
{
  double c;
  int d;
...
//  Input:
//
//    int I, J, K, the integer barycentric coordinates of
//    the basis function, 0 <= I, J, K.  The polynomial degree D = I + J + K.
//
//    double X, Y, the evaluation point.
//
//  Output:
//
//    double FEM_BASIS_2D, the value of the basis function at (X,Y).
//
{
  double c;
  int d;
...
//  Input:
//
//    int I, J, K, L, the integer barycentric 
//    coordinates of the basis function, 0 <= I, J, K, L. 
//    The polynomial degree D = I + J + K + L.
//
//    double X, Y, Z, the evaluation point.
//
//  Output:
//
//    double FEM_BASIS_3D, the value of the basis function at (X,Y,Z).
//
{
  double c;
  int d;
...
//
//    int I[M+1], the integer barycentric coordinates of the 
//    basis function.  The polynomial degree D = sum ( I );
//
//    double X[M], the evaluation point.
//
//  Output:
//
//    double FEM_BASIS_MD, the value of the basis function at (X,Y,Z).
//
{
  double c;
  int d;
...
//  Input:
//
//    int I[3], the integer barycentric coordinates of
//    the triangular basis function, 0 <= I[*].  
//    The polynomial degree DI = I[0] + I[1] + I[2].
//
//    int J[2], the integer barycentric coordinates of
//    the linear basis function, 0 <= J[*].  
//    The polynomial degree DJ = J[0] + J[1].
//
//    double XYZ[3], the evaluation point.
//
//  Output:
//
//    double B, the value of the basis function at XYZ.
//
{
  double b;
  double bi;
...
//  Output:
//
//    int I4VEC_SUM, the sum of the vector.
//
{
  int i;
  int value;
