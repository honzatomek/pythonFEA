...
void rule_write ( int order, string filename, double x[], double w[], 
  double r[] );
void scqf ( int nt, double t[], int mlt[], double wts[], int nwts, 
...
//
{
  ...
  timestamp ( );
  cout << "\n";
  cout << "CHEBYSHEV1_RULE\n";
  cout << "  C++ version\n";
  cout << "\n";
  cout << "  Compiled on " << __DATE__ << " at " << __TIME__ << ".\n";
  cout << "\n";
  cout << "  Compute a Gauss-Chebyshev type 1 rule for approximating\n";
  cout << "\n";
  cout << "    Integral ( A <= x <= B ) f(x) / sqrt ( ( x - A ) * ( B - x ) ) dx\n";
  cout << "\n";
  cout << "  of order ORDER.\n";
  cout << "\n";
