...
def hypersphere_area_sample ( d, r, n ):
...
#
  x = r * hypersphere01_area_sample ( d, n )

  return x

def hypersphere_area_sample_test ( ) :
...
#
  ...
  r = 1.5
  n = 5
  x = hypersphere_area_sample ( d, r, n )
...
def hypersphere_to_cartesian_test ( ):
...
def hypersphere_volume_sample ( d, r, n ):
...
#    real X(D,N), the points.
#
  x = r * hypersphere01_volume_sample ( d, n )

  return x

def hypersphere_volume_sample_test ( ) :
...
#
  ...
  r = 1.5
  n = 5
  x = hypersphere_volume_sample ( d, r, n )
...
def hypersphere01_area_sample ( d, n ):
...
def hypersphere01_area_sample_test ( ) :
...
#
  ...
  d = 4
  n = 5
  x = hypersphere01_area_sample ( d, n )
...
def hypersphere01_stereograph_test ( ):
...
#
  ...
  for d in range ( 2, 6 ):
    print ( '' )
    for j in range ( 0, 5 ):
      x1 = hypersphere01_area_sample ( d, n )
...
def hypersphere01_volume_sample ( d, n ):
...
def hypersphere01_volume_sample_test ( ) :
...
#
  ...
  d = 4
  n = 5
  x = hypersphere01_volume_sample ( d, n )
