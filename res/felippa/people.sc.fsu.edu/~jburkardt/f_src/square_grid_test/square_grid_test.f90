...
!
  ...
  real ( kind = rk ), dimension ( 2 ) :: a = (/ -1.0D+00, -1.0D+00 /)
  real ( kind = rk ), dimension ( 2 ) :: b = (/ +1.0D+00, +1.0D+00 /)
  integer, dimension ( 2 ) :: c = (/ 1, 1 /)
  integer i
  integer n
  integer, dimension ( 2 ) :: ns = (/ 3, 3 /)
...
!
  ...
  real ( kind = rk ), dimension ( 2 ) :: a = (/ 0.0D+00, 0.0D+00 /)
  real ( kind = rk ), dimension ( 2 ) :: b = (/ 1.0D+00, 1.0D+00 /)
  integer, dimension ( 2 ) :: c = (/ 2, 2 /)
  integer i
  integer n
  integer, dimension ( 2 ) :: ns = (/ 4, 2 /)
  real ( kind = rk ), allocatable :: x(:,:)
...
!
  ...
  real ( kind = rk ), dimension ( 2 ) :: a = (/  0.0D+00, -2.0D+00 /)
  real ( kind = rk ), dimension ( 2 ) :: b = (/ 10.0D+00, +2.0D+00 /)
  integer, dimension ( 2 ) :: c = (/ 3, 4 /)
  integer i
  integer n
  integer, dimension ( 2 ) :: ns = (/ 3, 3 /)
  real ( kind = rk ), allocatable :: x(:,:)
