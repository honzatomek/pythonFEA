...
!*****************************************************************************80
!
!! chebyshev2_rule() computes a standard Gauss-Chebyshev type 2 quadrature rule.
!
!  Discussion:
!
...
!
  ...
  call timestamp ( )
  write ( *, '(a)' ) ' '
  write ( *, '(a)' ) 'CHEBYSHEV2_RULE'
  write ( *, '(a)' ) '  FORTRAN90 version'
  write ( *, '(a)' ) ' '
  write ( *, '(a)' ) '  Compute a Gauss-Chebyshev type 2 rule for'
  write ( *, '(a)' ) ' '
...
!    be calculated.  This value is only needed when rule_kind = rk.
!
