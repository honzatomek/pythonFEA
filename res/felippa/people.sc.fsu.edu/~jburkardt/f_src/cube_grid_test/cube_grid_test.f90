...
!
  ...
  real ( kind = rk ), dimension ( 3 ) :: a = (/ -1.0D+00, -1.0D+00, -1.0D+00 /)
  real ( kind = rk ), dimension ( 3 ) :: b = (/ +1.0D+00, +1.0D+00, +1.0D+00 /)
  integer, dimension ( 3 ) :: c = (/ 1, 1, 1 /)
  integer i
  integer n
  integer, dimension ( 3 ) :: ns = (/ 3, 3, 3 /)
...
!
  ...
  real ( kind = rk ), dimension ( 3 ) :: a = (/ 0.0D+00, 0.0D+00, 0.0D+00 /)
  real ( kind = rk ), dimension ( 3 ) :: b = (/ 1.0D+00, 1.0D+00, 1.0D+00 /)
  integer, dimension ( 3 ) :: c = (/ 2, 2, 2 /)
  integer i
  integer n
  integer, dimension ( 3 ) :: ns = (/ 4, 2, 3 /)
  real ( kind = rk ), allocatable :: x(:,:)
...
!
  ...
  real ( kind = rk ), dimension ( 3 ) :: a = (/  0.0D+00, -2.0D+00, 50.0D+00 /)
  real ( kind = rk ), dimension ( 3 ) :: b = (/ 10.0D+00, +2.0D+00, 51.0D+00 /)
  integer, dimension ( 3 ) :: c = (/ 3, 4, 5 /)
  integer i
  integer n
  integer, dimension ( 3 ) :: ns = (/ 3, 3, 3 /)
  real ( kind = rk ), allocatable :: x(:,:)
