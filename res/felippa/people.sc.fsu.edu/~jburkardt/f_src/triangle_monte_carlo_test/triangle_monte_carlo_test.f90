...
!*****************************************************************************80
!
!! MAIN is the main program for TRIANGLE_MONTE_CARLO_NONUNIT_PRB.
!
!  Discussion:
!
!    TRIANGLE_MONTE_CARLO_NONUNIT_PRB tests the TRIANGLE_MONTE_CARLO_NONUNIT library.
!
!  Licensing:
!
...
!
  ...
  call timestamp ( )
  write ( *, '(a)' ) ' '
  write ( *, '(a)' ) 'TRIANGLE_MONTE_CARLO_NONUNIT_PRB'
  write ( *, '(a)' ) '  FORTRAN90 version'
  write ( *, '(a)' ) '  Test the TRIANGLE_MONTE_CARLO_NONUNIT library.'
!
...
!
  ...
  integer, parameter :: f_num = 3

  integer p_num
  real ( kind = rk ) result(f_num)
  integer seed
  real ( kind = rk ) :: t(2,3) = reshape ( (/ &
    1.0D+00, 0.0D+00, &
    0.0D+00, 1.0D+00, &
    0.0D+00, 0.0D+00 /), (/ 2, 3 /) )
...
!
!    Input, real ( kind = rk ) P(2,P_NUM), the evaluation points.
!
