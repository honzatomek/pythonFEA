...
!
  ...
  call timestamp ( )
  write ( *, '(a)' ) ''
  write ( *, '(a)' ) 'geometry_test():'
  write ( *, '(a)' ) '  FORTRAN90 version'
  write ( *, '(a)' ) '  Test geometry().'

  call angle_box_2d_test ( )
  call angle_contains_point_2d_test ( )
  call angle_degrees_2d_test ( )
  call angle_half_2d_test ( )
  call angle_rad_2d_test ( )
  call angle_rad_3d_test ( )
  call angle_rad_nd_test ( )
  call angle_turn_2d_test ( )

  call annulus_sector_centroid_2d_test ( )

  call ball01_sample_2d_test ( )
  call ball01_sample_3d_test ( )
  call ball01_sample_nd_test ( )
  call ball01_volume_test ( )

  call basis_map_3d_test ( )

  call box_contains_point_2d_test ( )
  call box_segment_clip_2d_test ( )
  call box_ray_int_2d_test ( )

  call box01_contains_point_2d_test ( )

  call circle_area_2d_test ( )
  call circle_dia2imp_2d_test ( )
  call circle_exp_contains_point_2d_test ( )
  call circle_exp2imp_2d_test ( )
  call circle_imp_line_exp_dist_2d_test ( )
  call circle_imp_line_exp_intersect_test ( )
  call circle_imp_line_par_int_2d_test ( )
  call circle_imp_point_dist_2d_test ( )
  call circle_imp_points_2d_test ( )
  call circle_imp_points_3d_test ( )
  call circle_imp_points_arc_2d_test ( )
  call circle_imp_segment_intersect_test ( )
  call circle_imp2exp_2d_test ( )
  call circle_llr2imp_2d_test ( )
  call circle_lune_angle_by_height_2d_test ( )
  call circle_lune_area_by_angle_2d_test ( )
  call circle_lune_area_by_height_2d_test ( )
  call circle_lune_centroid_2d_test ( )
  call circle_lune_height_by_angle_2d_test ( )
  call circle_pppr2imp_3d_test ( )
  call circle_ppr2imp_2d_test ( )
  call circle_sector_area_2d_test ( )
  call circle_sector_centroid_2d_test ( )
  call circle_triangle_area_2d_test ( )
  call circle_triple_angles_2d_test ( )

  call circles_intersect_points_2d_test ( )

  call test020 ( )

  call cube01_volume_test ( )

  call cylinder_point_dist_3d_test ( )
  call cylinder_point_dist_signed_3d_test ( )
  call cylinder_point_inside_3d_test ( )
  call cylinder_point_near_3d_test ( )
  call cylinder_sample_3d_test ( )
  call cylinder_volume_3d_test ( )

  call degrees_to_radians_test ( )

  call test021 ( )

  call disk_point_dist_3d_test ( )

  call dms_to_radians_test ( )

  call test0236 ( )

  call dual_size_3d_test ( )
  call dual_shape_3d_test ( )
  ...
  call plane_exp2imp_3d_test ( )
  call plane_exp2normal_3d_test ( )
  ...
  call points_centroid_2d_test ( )

  call test066 ( )

  call points_hull_2d_test ( )

  call test0126 ( )
  call test0127 ( )
  call test068 ( )

  call polar_to_xy_test ( )

  call polygon_area_2d_test ( )
  call polygon_area_3d_test ( )
  call polygon_centroid_3d_test ( )
  call polygon_solid_angle_3d_test ( )

  call polyhedron_area_3d_test ( )
  call polyhedron_centroid_3d_test ( )
  call polyhedron_contains_point_3d_test ( )

  call test083 ( )
  call test084 ( )

  call polyline_points_nd_test ( )

  call polyloop_arclength_nd_test ( )
  call polyloop_points_nd_test ( )
  ...
  call r8vec_any_normal_test ( )
  call r8vec_uniform_unit_test ( )

  call radec_distance_3d_test ( )
  call radec_to_xyz_test ( )

  call radians_to_degrees_test ( )
  call radians_to_dms_test ( )

  call test1787 ( )

  call rtp_to_xyz_test ( )

  call segment_contains_point_1d_test ( )
  call segment_point_coords_2d_test ( )
  call segment_point_dist_2d_test ( )
  call segment_point_dist_3d_test ( )
  call segment_point_near_2d_test ( )
  call segment_point_near_3d_test ( )

  call segments_curvature_2d_test ( )
  call segments_dist_2d_test ( )
  call segments_dist_3d_test ( )
  call segments_int_1d_test ( )
  call segments_int_2d_test ( )

  call test1788 ( )

  call simplex_lattice_point_next_test ( )
  ...
  call sphere_cap_volume_2d_test ( )
  call sphere_dia2imp_3d_test ( )

  call test182 ( )
  call test183 ( )
  call test1835 ( )

  call sphere_exp2imp_nd_test ( )
  call sphere_imp_point_project_3d_test ( )
  call sphere_triangle_sides_to_angles_test ( )

  call test189 ( )
  call test1895 ( )

  call sphere01_sample_2d_test ( )
  call sphere01_sample_3d_test ( )
  ...
  call tetrahedron_centroid_3d_test ( )
  call tetrahedron_circumsphere_3d_test ( )
  call tetrahedron_volume_3d_test ( )
  ...
  call vector_directions_nd_test ( )
  call vector_rotate_2d_test ( )
  call vector_rotate_3d_test ( )
  call vector_rotate_base_2d_test ( )
  call vector_separation_nd_test ( )

  call voxels_dist_l1_nd_test ( )
  call voxels_line_3d_test ( )
  call voxels_region_3d_test ( )
  call voxels_step_3d_test ( )

  call wedge01_volume_test ( )

  call xy_to_polar_test ( )

  call xyz_to_radec_test ( )
  call xyz_to_rtp_test ( )
!
!  Terminate.
!
  write ( *, '(a)' ) ''
...
!
  ...
  real ( kind = rk ) dist
  real ( kind = rk ), dimension ( test_num ) :: dist_test = (/ &
    1.0D+00, 1.0D+00, 1.0D+00 /)
  real ( kind = rk ) p1(2)
  real ( kind = rk ), dimension(2,test_num) :: p1_test = reshape ( (/ &
    0.0D+00, 0.0D+00, &
    0.0D+00, 0.0D+00, &
    3.0D+00, 0.0D+00 /), (/ 2, test_num /) )
  real ( kind = rk ) p2(2)
  real ( kind = rk ), dimension(2,test_num) :: p2_test = reshape ( (/ &
    3.0D+00, 0.0D+00, &
    3.0D+00, 0.0D+00, &
    3.0D+00, 0.0D+00 /), (/ 2, test_num /) )
  real ( kind = rk ) p3(2)
  real ( kind = rk ), dimension(2,test_num) :: p3_test = reshape ( (/ &
    4.0D+00,  2.0D+00, &
    2.0D+00, -2.0D+00, &
    2.0D+00, -2.0D+00 /), (/ 2, test_num /) )
  real ( kind = rk ) p4(2)
  real ( kind = rk ) p5(2)
  integer test

  write ( *, '(a)' ) ''
  write ( *, '(a)' ) 'ANGLE_BOX_2D_TEST'
  ...
  do test = 1, test_num
    ...
    p1(1:2) = p1_test(1:2,test)
    p2(1:2) = p2_test(1:2,test)
    p3(1:2) = p3_test(1:2,test)
    dist = dist_test(test)

    write ( *, '(a)' ) ''
    write ( *, '(a,g14.6)' ) '  DIST = ', dist
    write ( *, '(a,2g14.6)' ) '  P1:', p1(1:2)
    write ( *, '(a,2g14.6)' ) '  P2:', p2(1:2)
    write ( *, '(a,2g14.6)' ) '  P3:', p3(1:2)
 
    call angle_box_2d ( dist, p1, p2, p3, p4, p5 )
 
    write ( *, '(a,2g14.6)' ) '  P4:', p4(1:2)
    write ( *, '(a,2g14.6)' ) '  P5:', p5(1:2)

  end do

  return
end
subroutine angle_contains_point_2d_test ( )

!*****************************************************************************80
!
!! angle_contains_point_2d_test tests angle_contains_point_2d.
!
!  Licensing:
!
!    This code is distributed under the GNU LGPL license. 
...
!
  ...
  integer angle
  integer, parameter :: angle_num = 12
  real ( kind = rk ) angle_rad
  logical inside
  real ( kind = rk ) p(dim_num)
  real ( kind = rk ) p1(dim_num)
  real ( kind = rk ), dimension ( dim_num, test_num ) :: p1_test = reshape ( (/ &
    1.0D+00,  0.0D+00, &
    1.0D+00,  0.0D+00, &
    1.0D+00, -1.0D+00, &
    1.0D+00,  0.0D+00, &
  ...
  real ( kind = rk ), dimension ( dim_num, test_num ) :: p2_test = reshape ( (/ &
    0.0D+00, 0.0D+00, &
    0.0D+00, 0.0D+00, &
    0.0D+00, 0.0D+00, &
    0.0D+00, 0.0D+00, &
  ...
  real ( kind = rk ), dimension ( dim_num, test_num ) :: p3_test = reshape ( (/ &
     1.0D+00,  1.0D+00, &
     0.0D+00,  1.0D+00, &
     0.0D+00,  1.0D+00, &
    -1.0D+00,  0.0D+00, &
  ...
  write ( *, '(a)' ) ''
  write ( *, '(a)' ) 'ANGLE_CONTAINS_POINT_2D_TEST'
  ...
  do test = 1, test_num
    ...
    do angle = 0, angle_num
      ...
      angle_rad = real ( angle, kind = rk ) * 2.0D+00 * pi &
        / real ( angle_num, kind = rk )
...
subroutine angle_degrees_2d_test ( )

!*****************************************************************************80
!
!! angle_degrees_2d_test() tests angle_degrees_2d().
!
!  Licensing:
!
!    This code is distributed under the GNU LGPL license. 
...
!
  ...
  real ( kind = rk ) thetad
  real ( kind = rk ) thetar
  real ( kind = rk ), dimension(dim_num) :: v1 = (/ 1.0D+00, 0.0D+00 /)
  real ( kind = rk ) v2(dim_num)
  real ( kind = rk ), dimension(dim_num) :: v3 = (/ 0.0D+00, 0.0D+00 /)

  write ( *, '(a)' ) ''
  write ( *, '(a)' ) 'angle_degrees_2d_test'
  write ( *, '(a)' ) '  angle_degrees_2d computes an angle.'
  write ( *, '(a)' ) ''
  ...
  do i = 0, angle_num
    ...
    thetad = real ( i, kind = rk ) * 360.0D+00 / real ( angle_num, kind = rk )
    ...
    temp2 = angle_degrees_2d ( v1, v3, v2 )

    write ( *, '(2x,7f10.3)') v2(1:2), thetad, temp1, temp2
 
  end do
 
  return
end
subroutine angle_half_2d_test ( )
...
!
  ...
  angle_degrees = 75.0D+00
  r = 3.0D+00
  p1(1:dim_num) = p2(1:dim_num) &
    + r * (/ r8_cosd ( angle_degrees ), r8_sind ( angle_degrees ) /)

  angle_degrees = 15.0D+00
  r = 2.0D+00
...
!
  ...
  real ( kind = rk ), dimension ( dim_num ) :: p3 = (/ &
...
!
  ...
  write ( *, '(a)' ) ''
  write ( *, '(a)' ) 'ANGLE_RAD_ND_TEST'
  write ( *, '(a)' ) '  ANGLE_RAD_ND computes an angle in N dimensions.'
  write ( *, '(a)' ) ''
  write ( *, '(a)' ) '  X  Y  Theta  ATAN2(y, x), ' // &
    'ANGLE_RAD_ND'
  write ( *, '(a)' ) ''
  ...
  do i = 0, angle_num
    ...
    write ( *, '(2x,5f10.3)') v2(1:2), thetad, temp1, temp2
 
  end do
 
  return
end
subroutine angle_turn_2d_test ( )
...
!
  ...
  real ( kind = rk ) p1(dim_num)
  real ( kind = rk ), dimension(dim_num) :: p2 = (/ 0.0D+00, 0.0D+00 /)
  real ( kind = rk ), dimension(dim_num) :: p3 = (/ 1.0D+00, 0.0D+00 /)
  real ( kind = rk ), parameter :: r8_pi = 3.141592653589793D+00
  integer test
  real ( kind = rk ) theta
  real ( kind = rk ) theta_degrees
  real ( kind = rk ) turn

  write ( *, '(a)' ) ''
  write ( *, '(a)' ) 'ANGLE_TURN_2D_TEST'
  ...
  do test = 1, test_num
    ...
    theta = 2.0D+00 * r8_pi * real ( test     - 1, kind = rk ) &
                         / real ( test_num - 1, kind = rk )

    theta_degrees = 360.0D+00 * real ( test     - 1, kind = rk ) &
                         /      real ( test_num - 1, kind = rk )
...
subroutine annulus_sector_centroid_2d_test ( )
...
!
  ...
  real ( kind = rk ) degrees_to_radians
  real ( kind = rk ), dimension(dim_num) :: pc = (/ 5.0D+00, 3.0D+00 /)
  real ( kind = rk ) :: r1 = 2.0D+00
  real ( kind = rk ) :: r2 = 3.0D+00
  real ( kind = rk ) theta1
  real ( kind = rk ) theta2
...
subroutine ball01_sample_2d_test ( )
...
!
  ...
  real ( kind = rk ) average(dim_num)
  real ( kind = rk ) average_r
  real ( kind = rk ) average_theta
  integer i
  ...
  write ( *, '(a)' ) ''
  write ( *, '(a)' ) 'BALL01_SAMPLE_2D_TEST'
  write ( *, '(a)' ) '  BALL01_SAMPLE_2D samples the unit ball in 2 dimensions;'
  ...
  average(1:dim_num) = average(1:dim_num) / real ( sample_num, kind = rk )
  ...
  average_r = average_r / real ( sample_num, kind = rk )
  ...
  average_theta = average_theta / real ( sample_num, kind = rk )
...
subroutine ball01_sample_3d_test ( )
...
!
  ...
  write ( *, '(a)' ) ''
  write ( *, '(a)' ) 'BALL01_SAMPLE_3D_TEST'
  write ( *, '(a)' ) '  BALL01_SAMPLE_3D samples the unit ball in 3 dimensions;'
  ...
  write ( *, '(a,f8.4)' ) '  1/2**(1/dim_num) = ', &
    0.5D+00**( 1.0D+00 / real ( dim_num, kind = rk ) )
  write ( *, '(a)' ) ''
  ...
  average_phi = average_phi / real ( sample_num, kind = rk )
...
subroutine ball01_sample_nd_test ( )
...
!
  ...
  write ( *, '(a)' ) ''
  write ( *, '(a)' ) 'BALL01_SAMPLE_ND_TEST'
  write ( *, '(a)' ) '  BALL01_SAMPLE_ND samples the unit ball in N dimensions;'
  ...
  do i = 1, 5
    call ball01_sample_nd ( dim_num, x )
    write ( *, '(2x,3f8.4)' ) x(1:dim_num)
  end do
...
!
  ...
  write ( *, '(a)' ) ''
  write ( *, '(a)' ) 'BALL01_VOLUME_TEST'
  write ( *, '(a)' ) '  BALL01_VOLUME returns the volume of the unit ball.'
...
subroutine box_contains_point_2d_test ( )
...
!
  ...
  integer j
  real ( kind = rk ) p(dim_num)
  real ( kind = rk ), dimension(dim_num) :: p1 = (/ -0.1D+00, 0.3D+00 /)
  real ( kind = rk ), dimension(dim_num) :: p2 = (/  1.1D+00, 0.9D+00 /)
  real ( kind = rk ), parameter :: xhi =  1.2D+00
  real ( kind = rk ), parameter :: xlo = -0.3D+00
  real ( kind = rk ), parameter :: yhi =  1.4D+00
  real ( kind = rk ), parameter :: ylo = -0.1D+00

  write ( *, '(a)' ) ''
  write ( *, '(a)' ) 'BOX_CONTAINS_POINT_2D_TEST'
  ...
  do i = 1, n
    ...
    p(2) = ( real ( n - i,     kind = rk ) * yhi   &
           + real (     i - 1, kind = rk ) * ylo ) &
           / real ( n     - 1, kind = rk )

    do j = 1, n

      p(1) = ( real ( n - j,     kind = rk ) * xlo   &
...
subroutine box_segment_clip_2d_test ( )
...
!
  ...
  integer ival
  real ( kind = rk ), dimension(dim_num) :: p1 = (/ -10.0D+00, 10.0D+00 /)
  real ( kind = rk ), dimension(dim_num) :: p2 = (/  10.0D+00, 20.0D+00 /)
  real ( kind = rk ) pa(dim_num)
  real ( kind = rk ) pb(dim_num)
  real ( kind = rk ) qa(dim_num)
  real ( kind = rk ) qb(dim_num)
  real ( kind = rk ), dimension ( dim_num, test_num ) :: p1_test = reshape ( (/ &
     1.0D+00,  2.0D+00, &
    -3.0D+00, 12.0D+00, &
   -20.0D+00, 20.0D+00, &
  ...
  write ( *, '(a)' ) ''
  write ( *, '(a)' ) 'BOX_SEGMENT_CLIP_2D_TEST'
...
subroutine box_ray_int_2d_test ( )
...
!
  ...
  real ( kind = rk ), dimension(dim_num) :: p1 = (/  0.0D+00, 0.0D+00 /)
  real ( kind = rk ), dimension(dim_num) :: p2 = (/  5.0D+00, 3.0D+00 /)
  real ( kind = rk ) pa(1:dim_num)
  real ( kind = rk ), dimension(1:dim_num,test_num) :: pa_test = reshape ( (/ &
    3.0D+00, 1.0D+00, &
    4.0D+00, 1.0D+00, &
    3.0D+00, 1.0D+00 /), (/ dim_num, test_num /) )
  real ( kind = rk ) pb(1:dim_num)
  real ( kind = rk ), dimension(1:dim_num,test_num) :: pb_test = reshape ( (/ &
    5.0D+00, 5.0D+00, &
    3.0D+00, 1.0D+00, &
    4.0D+00, 2.0D+00 /), (/ dim_num, test_num /) )
  real ( kind = rk ), dimension(1:dim_num,test_num) :: pc_test = reshape ( (/ &
    4.0D+00, 3.0D+00, &
    0.0D+00, 1.0D+00, &
    5.0D+00, 3.0D+00 /), (/ dim_num, test_num /) )
  real ( kind = rk ) pint(1:dim_num)
  integer test

  write ( *, '(a)' ) ''
  write ( *, '(a)' ) 'BOX_RAY_INT_2D_TEST'
...
subroutine box01_contains_point_2d_test ( )
...
!
  ...
  write ( *, '(a)' ) ''
  write ( *, '(a)' ) 'BOX01_CONTAINS_POINT_2D_TEST'
  write ( *, '(a)' ) '  BOX01_CONTAINS_POINT_2D reports if the unit box'
  write ( *, '(a)' ) '  contains a point.'
  write ( *, '(a)' ) ''
  write ( *, '(a)' ) '  We will call the function repeatedly, and draw'
  ...
  do i = 1, n
    ...
    do j = 1, n
      ...
      if ( box01_contains_point_2d ( p ) ) then
        dot(j) = '*'
      else
        dot(j) = '-'
      end if
...
subroutine circle_area_2d_test ( )
...
!
  ...
  write ( *, '(a)' ) ''
  write ( *, '(a)' ) 'circle_area_2d_test'
  write ( *, '(a)' ) '  circle_area_2d computes the area of a circle of radius R.'
  write ( *, '(a)' ) ''
  write ( *, '(a)' ) '      R            Area'
  write ( *, '(a)' ) ''
  ...
  r = 1.0D+00
  do i = 1, 4
    call circle_area_2d ( r, area )
    write ( *, '(2x,f10.4,2x,f10.4)' ) r, area
    r = r * 2.0D+00
  end do

  return
end
subroutine circle_dia2imp_2d_test ( )
...
!
  ...
  write ( *, '(a)' ) ''
  write ( *, '(a)' ) 'CIRCLE_DIA2IMP_2D_TEST'
...
subroutine circle_exp_contains_point_2d_test ( )
...
!
  ...
  write ( *, '(a)' ) ''
  write ( *, '(a)' ) 'circle_exp_contains_point_2d_test'
...
subroutine circle_exp2imp_2d_test ( )
...
!
  ...
  write ( *, '(a)' ) ''
  write ( *, '(a)' ) 'circle_exp2imp_2d_test'
...
subroutine circle_imp_line_exp_dist_2d_test ( )

!*****************************************************************************80
!
!! circle_imp_line_exp_dist_2d_test tests circle_imp_line_exp_dist_2d.
!
!  Licensing:
!
!    This code is distributed under the GNU LGPL license. 
...
!
  ...
  write ( *, '(a)' ) ''
  write ( *, '(a)' ) 'circle_imp_line_exp_dist_2d_test'
  write ( *, '(a)' ) '  circle_imp_line_exp_dist_2d() finds the distance'
  write ( *, '(a)' ) '  between an implicit circle and an explicit line.'
  ...
  p1 = (/ 13.0D+00,  8.0D+00 /)
  p2 = (/ 17.0D+00, 11.0D+00/)

  call line_exp_print_2d ( p1, p2, '  The explicit line:' )

  call circle_imp_line_exp_dist_2d ( r, pc, p1, p2, dist )

  write ( *, '(a)' ) ''
  write ( *, '(a,f8.4)' ) '  Distance is ', dist

  return
end
subroutine circle_imp_line_exp_intersect_test ( )

!*****************************************************************************80
!
!! circle_imp_line_exp_intersect_test tests circle_imp_line_exp_intersect.
!
!  Licensing:
!
!    This code is distributed under the GNU LGPL license. 
...
!
  ...
  write ( *, '(a)' ) ''
  write ( *, '(a)' ) 'circle_imp_line_exp_intersect_test'
  write ( *, '(a)' ) '  circle_imp_line_exp_intersect() finds the intersection'
  write ( *, '(a)' ) '  of an implicit circle and an explicit line.'
  ...
  call circle_imp_line_exp_intersect ( r, pc, p1, p2, int_num, p )

  write ( *, '(a)' ) ''
  write ( *, '(a,i2)' ) '  Number of intersections found = ', int_num
  do j = 1, int_num
    write ( *, '(2x,i1,2x,f8.4,2x,f8.4)' ) j, p(1,j), p(2,j)
  end do

  return
end
subroutine circle_imp_line_par_int_2d_test ( )

!*****************************************************************************80
!
!! circle_imp_line_par_int_2d_test tests circle_imp_line_par_int_2d.
!
!  Licensing:
!
!    This code is distributed under the GNU LGPL license. 
...
!
  ...
  write ( *, '(a)' ) ''
  write ( *, '(a)' ) 'circle_imp_line_par_int_2d_test'
  write ( *, '(a)' ) '  circle_imp_line_par_int_2d finds the intersection'
  write ( *, '(a)' ) '  of an implicit circle and a parametric line.'
  ...
  call line_par_print_2d ( f, g, x0, y0, '  The parametric line' )

  call circle_imp_line_par_int_2d ( r, pc, x0, y0, f, g, int_num, p )
...
subroutine circle_imp_point_dist_2d_test ( )
...
!
  ...
  do i = 1, 10
    ...
    call r8vec_uniform_ab ( 2, -10.0D+00, +10.0D+00, p )
    call circle_imp_point_dist_2d ( r, center, p, d )
    write ( *, '(2x,3f8.4)' ) p(1:2), d

  end do

  return
end
subroutine circle_imp_points_2d_test ( )

!*****************************************************************************80
!
!! circle_imp_points_2d_test tests circle_imp_points_2d.
!
!  Licensing:
!
!    This code is distributed under the GNU LGPL license. 
...
!
  ...
  real ( kind = rk ) pc(dim_num)
  real ( kind = rk ), parameter :: pi = 3.141592653589793D+00
  real ( kind = rk ) :: r = 2.0D+00
  real ( kind = rk ) result

  pc(1:2) =  (/ 5.0D+00, -2.0D+00 /)

  write ( *, '(a)' ) ''
  write ( *, '(a)' ) 'circle_imp_points_2d_test'
...
subroutine circle_imp_points_3d_test ( )
...
!
  ...
  real ( kind = rk ), dimension ( dim_num ) :: nc = (/ &
    1.0D+00, 1.0D+00, 1.0D+00 /)
  real ( kind = rk ), dimension(dim_num,n) :: p
  real ( kind = rk ), dimension ( dim_num ) :: pc = (/ &
    5.0D+00, -2.0D+00, 1.0D+00 /)
  real ( kind = rk ) :: r = 2.0D+00

  write ( *, '(a)' ) ''
  write ( *, '(a)' ) 'circle_imp_points_3d_test'
...
subroutine circle_imp_points_arc_2d_test ( )
...
!
  ...
  write ( *, '(a)' ) ''
  write ( *, '(a)' ) 'circle_imp_points_arc_2d_test'
...
subroutine circle_imp_segment_intersect_test ( )
...
!
  ...
  write ( *, '(a)' ) ''
  write ( *, '(a)' ) 'circle_imp_segment_intersect_test'
  write ( *, '(a)' ) '  circle_imp_segment_intersect() finds the intersection'
  write ( *, '(a)' ) '  of an implicit circle and a line segment.'
  ...
  do i = 1, 3
    ...
    call line_exp_print_2d ( p1, p2, '  The line segment:' )

    call circle_imp_segment_intersect ( r, pc, p1, p2, int_num, p )
...
subroutine circle_imp2exp_2d_test ( )

!*****************************************************************************80
!
!! circle_imp2exp_2d_test tests circle_imp2exp_2d.
!
!  Licensing:
!
!    This code is distributed under the GNU LGPL license. 
...
!
  ...
  write ( *, '(a)' ) ''
  write ( *, '(a)' ) 'circle_imp2exp_2d_test'
...
subroutine circle_llr2imp_2d_test ( )
...
!
  ...
  real ( kind = rk ) :: d3
  real ( kind = rk ) :: d4
  real ( kind = rk ) :: p_hi =  10.0D+00
  real ( kind = rk ) :: p_lo = -10.0D+00
  ...
  write ( *, '(a)' ) ''
  write ( *, '(a)' ) 'circle_llr2imp_2d_test'
  write ( *, '(a)' ) '  circle_llr2imp_2d() is given:'
  write ( *, '(a)' ) '  an explicit line through P1 and P2,'
  write ( *, '(a)' ) '  an explicit line through Q1 and Q2,'
  ...
  do test = 1, test_num
    ...
    call r8vec_uniform_ab ( dim_num, p_lo, p_hi, p1 )
    call r8vec_uniform_ab ( dim_num, p_lo, p_hi, p2 )
    call r8vec_uniform_ab ( dim_num, p_lo, p_hi, q1 )
    call r8vec_uniform_ab ( dim_num, p_lo, p_hi, q2 )

    r_lo = 1.0D+00
    r_hi = 5.0D+00
    r = r8_uniform_ab ( r_lo, r_hi )

    write ( *, '(a)' ) ''
    write ( *, '(a,g14.6)' ) '  Radius R = ', r

    call line_exp_print_2d ( p1, p2, '  The first explicit line:' )
...
subroutine circle_lune_angle_by_height_2d_test ( )
...
!
  ...
  write ( *, '(a)' ) ''
  write ( *, '(a)' ) 'circle_lune_angle_by_height_2d_test'
  write ( *, '(a)' ) '  circle_lune_angle_by_height_2d() computes the angle of a'
  write ( *, '(a)' ) '  circular lune based on the "height" of the circular triangle.'
  write ( *, '(a)' ) ''
  write ( *, '(a)' ) '      R            H        Angle'
  write ( *, '(a)' ) ''
  ...
  do i = - n_test, n_test
    ...
    h = real ( i, kind = rk ) * r / real ( n_test, kind = rk )

    call circle_lune_angle_by_height_2d ( r, h, angle )

    write ( *, '(3f12.4)' ) r, h, angle

  end do

  return
end
subroutine circle_lune_area_by_angle_2d_test ( )
...
!
  ...
  real ( kind = rk ) area
  real ( kind = rk ), dimension(2) :: pc = (/ 0.0D+00, 0.0D+00 /)
  real ( kind = rk ), parameter :: pi = 3.141592653589793D+00
  ...
  write ( *, '(a)' ) ''
  write ( *, '(a)' ) 'circle_lune_area_by_angle_2d_test'
  write ( *, '(a)' ) '  circle_lune_area_by_angle_2d() computes the area of a'
  ...
  do test = 0, test_num
    ...
    theta1 = 0.0D+00
    theta2 = real ( test, kind = rk ) * 2.0D+00 * pi &
           / real ( test_num, kind = rk )

    call circle_lune_area_by_angle_2d ( r, pc, theta1, theta2, area )

    write ( *, '(2x,4f12.6)' ) r, theta1, theta2, area

  end do

  return
end
subroutine circle_lune_area_by_height_2d_test ( )
...
!
  ...
  real ( kind = rk ) h
  integer i
  integer, parameter :: n_test = 6
  real ( kind = rk ) :: r = 2.0D+00

  write ( *, '(a)' ) ''
  write ( *, '(a)' ) 'circle_lune_area_by_height_2d_test'
  write ( *, '(a)' ) '  circle_lune_area_by_height_2d() computes the area of a'
  write ( *, '(a)' ) '  circular lune based on the "height" of the circular'
  write ( *, '(a)' ) '  triangle.'
  write ( *, '(a)' ) ''
  write ( *, '(a)' ) '      R            H        Area'
  write ( *, '(a)' ) ''
  ...
  do i = - n_test, n_test
    ...
    call circle_lune_area_by_height_2d ( r, h, area )

    write ( *, '(2x,3f12.6)' ) r, h, area

  end do

  return
end
subroutine circle_lune_centroid_2d_test ( )
...
!
  ...
  write ( *, '(a)' ) ''
  write ( *, '(a)' ) 'circle_lune_centroid_2d_test'
  ...
  write ( *, '(a)' ) ''
  write ( *, '(a)' ) '  The first angle of our lune is always 0.'
  write ( *, '(a)' ) ''
  write ( *, '(a)' ) '                         Lune'
  write ( *, '(a)' ) '  THETA2           X             Y'
  write ( *, '(a)' ) ''
  ...
  do test = 0, test_num
    ...
    call circle_lune_centroid_2d ( r, pc, theta1, theta2, centroid )

    write ( *, '(2x,3f14.8)' ) theta2, centroid(1:2)

  end do

  return
end
subroutine circle_lune_height_by_angle_2d_test ( )
...
!
  ...
  write ( *, '(a)' ) ''
  write ( *, '(a)' ) 'circle_lune_height_by_angle_2d_test'
  write ( *, '(a)' ) '  circle_lune_height_by_angle_2d() computes the height of'
  write ( *, '(a)' ) '  the triangle of a circular lune, given the subtended angle.'
  write ( *, '(a)' ) ''
  write ( *, '(a)' ) '      R            Angle        Height'
  write ( *, '(a)' ) ''

  do i = 0, n_test

    angle = real ( i, kind = rk ) * 2.0D+00 * r8_pi / real ( n_test, kind = rk )

    call circle_lune_height_by_angle_2d ( r, angle, height )

    write ( *, '(3f12.4)' ) r, angle, height

  end do

  return
end
subroutine circle_pppr2imp_3d_test ( )
...
!
  ...
  write ( *, '(a)' ) ''
  write ( *, '(a)' ) 'circle_pppr2imp_3d_test'
  ...
  do test = 1, test_num
    ...
    call r8vec_uniform_ab ( dim_num, p_lo, p_hi, p1 )
    call r8vec_uniform_ab ( dim_num, p_lo, p_hi, p2 )
    call r8vec_uniform_ab ( dim_num, p_lo, p_hi, p3 )
...
subroutine circle_ppr2imp_2d_test ( )
...
!
  ...
  write ( *, '(a)' ) ''
  write ( *, '(a)' ) 'circle_ppr2imp_2d_test'
...
subroutine circle_sector_area_2d_test ( )
...
!
  ...
  write ( *, '(a)' ) ''
  write ( *, '(a)' ) 'circle_sector_area_2d_test'
  ...
  do test = 0, test_num
    ...
    theta1 = 0.0D+00
    theta2 = real ( test, kind = rk ) * 2.0D+00 * r8_pi &
           / real ( test_num, kind = rk )

    call circle_sector_area_2d ( r, pc, theta1, theta2, area )
...
subroutine circle_sector_centroid_2d_test ( )
...
!
  ...
  write ( *, '(a)' ) ''
  write ( *, '(a)' ) 'circle_sector_centroid_2d_test'
  ...
  write ( *, '(a)' ) ''
  write ( *, '(a)' ) '  The first angle of our sector is always 0.'
  write ( *, '(a)' ) ''
  write ( *, '(a)' ) '                         Sector'
  write ( *, '(a)' ) '  THETA2           X             Y'
  write ( *, '(a)' ) ''
  ...
  do test = 0, test_num
    ...
    call circle_sector_centroid_2d ( r, pc, theta1, theta2, centroid )
...
subroutine circle_triangle_area_2d_test ( )
...
!
  ...
  write ( *, '(a)' ) ''
  write ( *, '(a)' ) 'circle_triangle_area_2d_test'
  ...
  do test = 0, test_num
    ...
    call circle_triangle_area_2d ( r, pc, theta1, theta2, area )
...
subroutine circle_triple_angles_2d_test ( )

!*****************************************************************************80
!
!! circle_triple_angles_2d_test tests circle_triple_angles_2d.
!
!  Licensing:
!
!    This code is distributed under the GNU LGPL license. 
...
!
  ...
  write ( *, '(a)' ) ''
  write ( *, '(a)' ) 'circle_triple_angles_2d_test'
  write ( *, '(a)' ) '  circle_triple_angles_2d() computes the angles'
  write ( *, '(a)' ) '  in the triangle formed by the centers of 3'
  write ( *, '(a)' ) '  cotangent circles of radius r1, r2, r3.'
  write ( *, '(a)' ) ''
  write ( *, '(a)' ) &
    '      R1      R2      R3      A1      A2      A3'
  write ( *, '(a)' ) ''
  ...
  do test = 1, 10
    ...
    r1 = real ( i4_uniform_ab ( 1, 5 ), kind = rk )
    r2 = real ( i4_uniform_ab ( 1, 5 ), kind = rk )
    r3 = real ( i4_uniform_ab ( 1, 5 ), kind = rk )

    call circle_triple_angles_2d ( r1, r2, r3, angle1, angle2, angle3 )

    write ( *, '(2x,6f8.4)' ) r1, r2, r3, angle1, angle2, angle3

  end do

  return
end
subroutine circles_intersect_points_2d_test ( )
...
!
  ...
  integer int_num
  real ( kind = rk ), dimension(2) :: pc1 = (/ 0.0D+00, 0.0D+00 /)
  real ( kind = rk ) pc2(2)
  real ( kind = rk ), parameter, dimension (2,test_num) :: &
    pc2_test = reshape ( (/ &
    5.0D+00,       5.0D+00, &
    7.0710678D+00, 7.0710678D+00, &
    4.0D+00,       0.0D+00, &
    6.0D+00,       0.0D+00, &
    0.0D+00,       0.0D+00 /), (/ 2, test_num /) )
  real ( kind = rk ) pint(2,2)
  real ( kind = rk ), parameter :: r1 = 5.0D+00
  real ( kind = rk ) r2
  real ( kind = rk ), parameter, dimension ( test_num ) :: r2_test = &
    (/ 0.5D+00, 5.0D+00, 3.0D+00, 3.0D+00, 5.0D+00 /)
  integer test

  write ( *, '(a)' ) ''
  write ( *, '(a)' ) 'CIRCLES_INTERSECT_POINTS_2D_TEST'
  write ( *, '(a)' ) '  CIRCLE_INTERSECT_POINTS_2D determines intersection'
  write ( *, '(a)' ) '  points of two circles in 2D.'
  ...
  do test = 1, test_num
    ...
    call circles_intersect_points_2d ( r1, pc1, r2, pc2, int_num, pint )
    ...
    if ( int_num == 0 ) then
      ...
      write ( *, '(a)' ) '        P'
      write ( *, '(a)' ) ''
      write ( *, '(2x,4f8.4)' ) pint(1:2,1)
      write ( *, '(2x,2f8.4)' ) pint(1:2,2)
...
!
  ...
  write ( *, '(a)' ) ''
  write ( *, '(a)' ) 'TEST020'
  write ( *, '(a)' ) '  CUBE_SIZE_3D returns dimension information for a cube;'
...
!
  ...
  write ( *, '(a)' ) ''
  write ( *, '(a)' ) 'CUBE01_VOLUME_TEST'
  write ( *, '(a)' ) '  CUBE01_VOLUME returns the volume of the unit cube.'
...
subroutine cylinder_point_dist_3d_test ( )
...
!
  ...
  real ( kind = rk ), dimension ( dim_num ) :: p
  real ( kind = rk ), dimension ( dim_num, test_num ) :: p_test = reshape ( (/ &
  ...
  write ( *, '(a)' ) ''
  write ( *, '(a)' ) 'cylinder_point_dist_3d_test'
...
subroutine cylinder_point_dist_signed_3d_test ( )
...
!
  ...
  write ( *, '(a)' ) ''
  write ( *, '(a)' ) 'cylinder_point_dist_signed_3d_test'
...
subroutine cylinder_point_inside_3d_test ( )

!*****************************************************************************80
!
!! cylinder_point_inside_3d_test tests cylinder_point_inside_3d.
!
!  Licensing:
!
!    This code is distributed under the GNU LGPL license. 
...
!
  ...
  write ( *, '(a)' ) ''
  write ( *, '(a)' ) 'cylinder_point_inside_3d_test'
...
subroutine cylinder_point_near_3d_test ( )

!*****************************************************************************80
!
!! cylinder_point_near_3d_test tests cylinder_point_near_3d.
!
!  Licensing:
!
!    This code is distributed under the GNU LGPL license. 
...
!
  ...
  real ( kind = rk ), dimension ( dim_num ) :: p2 = (/ &
    0.0D+00,  2.0D+00, 0.0D+00 /)
  real ( kind = rk ), dimension ( dim_num ) :: pn
  real ( kind = rk ), dimension ( dim_num, test_num ) :: pn_test = reshape ( (/ &
  ...
  write ( *, '(a)' ) ''
  write ( *, '(a)' ) 'cylinder_point_near_3d_test'
...
subroutine cylinder_sample_3d_test ( )

!*****************************************************************************80
!
!! cylinder_sample_3d_test tests cylinder_sample_3d.
!
!  Licensing:
!
!    This code is distributed under the GNU LGPL license. 
...
!
  ...
  write ( *, '(a)' ) ''
  write ( *, '(a)' ) 'cylinder_sample_3d_test'
  ...
  call cylinder_sample_3d ( p1, p2, r, n, p )

  call r8mat_transpose_print ( dim_num, n, p, '  Sample points:' )

  return
end
subroutine cylinder_volume_3d_test ( )

!*****************************************************************************80
!
!! cylinder_volume_3d_test tests cylinder_volume_3d.
!
!  Licensing:
!
!    This code is distributed under the GNU LGPL license. 
...
!
  ...
  real ( kind = rk ) :: r = 5.0D+00
  real ( kind = rk ) volume

  write ( *, '(a)' ) ''
  write ( *, '(a)' ) 'cylinder_volume_3d_test'
...
subroutine degrees_to_radians_test ( )
...
!
  ...
  write ( *, '(a)' ) ''
  write ( *, '(a)' ) 'degrees_to_radians_test'
  ...
  do i = -2, 14
    angle_degrees = real ( 30 * i, kind = rk )
    angle_rad = degrees_to_radians ( angle_degrees )
    angle_degrees_2 = radians_to_degrees ( angle_rad )
    write ( *, '(2x,f10.6,2x,f10.6,2x,f10.6)' ) &
      angle_degrees, angle_rad, angle_degrees_2
  end do
...
!
  ...
  do test = 1, test_num
    ...
    do i = 1, 20
      call direction_pert_3d ( sigma(test), vbase, vran )
...
subroutine disk_point_dist_3d_test ( )
...
!
  ...
  real ( kind = rk ), dimension(dim_num) :: axis = (/ &
  ...
  real ( kind = rk ), dimension(dim_num,test_num) :: p_test = &
  reshape ( (/ &
     0.0D+00,  0.0D+00,        0.0D+00, &
  ...
  write ( *, '(a)' ) ''
  write ( *, '(a)' ) 'disk_point_dist_3d_test'
...
subroutine dms_to_radians_test ( )

!*****************************************************************************80
!
!! dms_to_radians_test tests dms_to_radians.
!
!  Licensing:
!
!    This code is distributed under the GNU LGPL license. 
...
!
  ...
  integer angle_degrees
  integer angle_min
  real ( kind = rk ) angle_rad
  real ( kind = rk ) angle_rad2
  integer angle_sec
  integer i
  real ( kind = rk ), parameter :: pi = 3.141592653589793D+00

  write ( *, '(a)' ) ''
  write ( *, '(a)' ) 'dms_to_radians_test'
  ...
  do i = -2, 15
    angle_rad = pi * real ( i, kind = rk ) / 7.0D+00
    call radians_to_dms ( angle_rad, angle_degrees, angle_min, angle_sec )
    call dms_to_radians ( angle_degrees, angle_min, angle_sec, angle_rad2 )
    write ( *, '(2x,f10.6,2x,i4,2x,i3,2x,i3,2x,f10.6)' ) &
      angle_rad, angle_degrees, angle_min, angle_sec, angle_rad2
  end do
...
!
  ...
  integer edge_num1
  integer edge_num2
  integer, allocatable, dimension ( :, : ) ::  edge_point1
  integer face_num1
  integer face_num2
  integer, allocatable, dimension ( : ) ::  face_order1
  integer face_order_max1
  integer face_order_max2
  integer, allocatable, dimension ( :, : ) ::  face_point1
  integer point_num1
  integer point_num2
  real ( kind = rk ), allocatable, dimension ( :, : ) :: point_coord1

  write ( *, '(a)' ) ''
  write ( *, '(a)' ) 'dual_size_3d_test'
...
!
  ...
  integer face_num2
  integer, allocatable, dimension ( : ) ::  face_order1
  integer, allocatable, dimension ( : ) ::  face_order2
  integer face_order_max1
  integer face_order_max2
  integer, allocatable, dimension ( :, : ) ::  face_point1
  integer, allocatable, dimension ( :, : ) ::  face_point2
  integer point_num1
  integer point_num2
  real ( kind = rk ), allocatable, dimension ( :, : ) :: point_coord1
  real ( kind = rk ), allocatable, dimension ( :, : ) :: point_coord2

  write ( *, '(a)' ) ''
  write ( *, '(a)' ) 'dual_shape_3d_test'
...
!
  ...
  real ( kind = rk ), dimension ( dim_num, test_num ) :: p = reshape ( (/ &
    1.0D+00,   1.0D+00, &
    1.0D+00,  -1.0D+00, &
   -1.0D+00,   1.0D+00, &
    2.0D+00, 200.0D+00 /), (/ dim_num, test_num /) )
  real ( kind = rk ), dimension ( dim_num, test_num ) :: p1 = reshape ( (/ &
    0.0D+00,   0.0D+00, &
    0.0D+00,   0.0D+00, &
   -5.0D+00,  -5.0D+00, &
    3.0D+00, 150.0D+00 /), (/ dim_num, test_num /) )
  real ( kind = rk ), dimension ( dim_num, test_num ) :: p2 = reshape ( (/ &
    2.0D+00,   0.0D+00, &
    2.0D+00,   0.0D+00, &
   10.0D+00,  10.0D+00, &
...
!
  ...
  real ( kind = rk ), dimension(dim_num,3,test_num) :: t_test = reshape ( (/ &
        0.0D+00,  0.0D+00,  0.0D+00, &
...
!
  ...
  integer int_num
  real ( kind = rk ), dimension(dim_num) :: normal = (/ &
...
!
  ...
  do test = 0, test_num
    x = real ( test, kind = rk ) * 2.0D+00 * r8_pi / real ( test_num, kind = rk )
...
!
  ...
  character dot(n)
  real ( kind = rk ), dimension(dim_num,6) :: h = reshape ( (/ &
    0.2D+00, 0.4D+00, &
    0.4D+00, 0.2D+00, &
    0.8D+00, 0.0D+00, &
    1.0D+00, 0.6D+00, &
  ...
  do i = 1, n
    ...
    p(2) = real ( n - i, kind = rk ) &
         / real ( n - 1, kind = rk )

    do j = 1, n

      p(1) = real ( j - 1, kind = rk ) &
           / real ( n - 1, kind = rk )
...
!
  ...
  integer i
  integer item
  integer, dimension ( test_num ) :: item_test = (/ &
    34, 12, 90 /)
  integer j
  integer row
  integer test
...
!
  ...
  integer i
  integer item1
  integer, dimension ( test_num ) :: item1_test = (/ &
    22, 32, 22, 54, 54 /)
  integer item2
  integer, dimension ( test_num ) :: item2_test = (/ &
    32, 22, 23, 14, 11 /)
  integer j
  integer row
  integer test
...
subroutine line_exp_normal_2d_test ( )

!*****************************************************************************80
!
!! line_exp_normal_2d_test tests line_exp_normal_2d.
!
!  Licensing:
!
!    This code is distributed under the GNU LGPL license. 
...
!
  ...
  write ( *, '(a)' ) ''
  write ( *, '(a)' ) 'line_exp_normal_2d_test'
...
!
  ...
  logical              flag
  real ( kind = rk ), dimension(dim_num) :: p1 = (/ 1.0D+00, 3.0D+00 /)
  real ( kind = rk ), dimension(dim_num) :: p2 = (/ 4.0D+00, 0.0D+00 /)
  real ( kind = rk ) p3(dim_num)
  real ( kind = rk ), dimension(dim_num,test_num) :: p3_test = reshape ( (/ &
    0.0D+00,  0.0D+00, &
    5.0D+00, -1.0D+00, &
...
!
  ...
  real ( kind = rk ) dist
  real ( kind = rk ) p(dim_num)
  real ( kind = rk ), dimension(dim_num) :: p1 = (/ 1.0D+00, 3.0D+00, 2.0D+00 /)
  real ( kind = rk ), dimension(dim_num) :: p2 = (/ 4.0D+00, 0.0D+00, 1.0D+00 /)
  real ( kind = rk ), dimension(dim_num,test_num) :: p_test = reshape ( (/ &
    0.0D+00,  0.0D+00, 2.0D+00, &
...
!
  ...
  real ( kind = rk ) :: a1 = 1.0D+00
  real ( kind = rk ) a2
  real ( kind = rk ) :: b1 = 2.0D+00
  real ( kind = rk ) b2
  real ( kind = rk ) :: c1 = 3.0D+00
  real ( kind = rk ) c2
  real ( kind = rk ) p1(dim_num)
  real ( kind = rk ) p2(dim_num)
...
!
  ...
  real ( kind = rk ) :: f1 = 1.0D+00
  real ( kind = rk ) f2
  real ( kind = rk ) :: g1 = 2.0D+00
  real ( kind = rk ) g2
  real ( kind = rk ) p1(dim_num)
  real ( kind = rk ) p2(dim_num)
  real ( kind = rk ) :: x1 = 3.0D+00
  real ( kind = rk ) x2
  real ( kind = rk ) :: y1 = 4.0D+00
  real ( kind = rk ) y2
  ...
  call line_par_print_2d ( f1, g1, x1, y1, '  Parametric line:' )
  ...
  call line_par_print_2d ( f2, g2, x2, y2, '  Recovered parametric line:' )
...
!
  ...
  real ( kind = rk ) a
  real ( kind = rk ), parameter, dimension ( test_num ) :: a_test = (/ &
    2.0D+00, 2.0D+00, 2.0D+00 /)
  real ( kind = rk ) b
  real ( kind = rk ), parameter, dimension ( test_num ) :: b_test = (/ &
    5.0D+00, 5.0D+00, 5.0D+00 /)
  real ( kind = rk ) c
  real ( kind = rk ), parameter, dimension ( test_num ) :: c_test = (/ &
    3.0D+00, 3.0D+00, 3.0D+00 /)
  real ( kind = rk ) dist
  real ( kind = rk ) p(dim_num)
  real ( kind = rk ), parameter, dimension ( dim_num, test_num ) :: &
    p_test = reshape ( (/ &
    0.0D+00, 6.0D+00, &
    0.0D+00, 5.0D+00, &
...
!
  ...
  write ( *, '(a)' ) ''
  write ( *, '(a)' ) 'TEST0351'
  write ( *, '(a)' ) '  LINE_PAR_POINT_NEAR_2D finds the point on'
  write ( *, '(a)' ) '  a parametric line (X0,Y0,F,G) nearest a point P in 2D.'
  ...
  call line_par_print_2d ( f, g, x0, y0, '  Parametric line:' )
  ...
  do test = 1, test_num
    ...
    call line_par_point_dist_2d ( f, g, x0, y0, p, dist )

    write ( *, '(a,g14.6)' ) '  Distance = ', dist

    call line_par_point_near_2d ( f, g, x0, y0, p, pn )

    call r8vec_print ( dim_num, pn, '  Nearest point PN:' )

    dist = r8vec_norm_affine ( dim_num, p, pn )

    write ( *, '(a,g14.6)' ) '  Distance recomputed = ', dist
...
!
  ...
  write ( *, '(a)' ) ''
  write ( *, '(a)' ) 'TEST0352'
  write ( *, '(a)' ) '  LINE_PAR_POINT_DIST_3D finds the distance'
  write ( *, '(a)' ) '  from a parametric line to a point in 3D.'
  ...
  write ( *, '(a)' ) ''
  write ( *, '(a)' ) '  Parametric line:'
  write ( *, '(a,g14.6,a,g14.6,a)' ) '  X(t) = ', x0, ' + ', f, ' * t'
  write ( *, '(a,g14.6,a,g14.6,a)' ) '  Y(t) = ', y0, ' + ', g, ' * t'
  write ( *, '(a,g14.6,a,g14.6,a)' ) '  Z(t) = ', z0, ' + ', h, ' * t'
  ...
  do test = 1, test_num
    ...
    call line_par_point_dist_3d ( f, g, h, x0, y0, z0, p, dist )

    write ( *, '(a,g14.6)' ) '  Distance = ', dist

    call line_par_point_near_3d ( f, g, h, x0, y0, z0, p, pn )
...
!
  ...
  real ( kind = rk ) angle
  real ( kind = rk ) p1(dim_num)
  real ( kind = rk ), dimension ( dim_num, test_num ) :: p1_test = &
    reshape ( (/ &
    0.0D+00, 0.0D+00, 0.0D+00, &
    1.0D+00, 2.0D+00, 0.0D+00 /), (/ dim_num, test_num /) )
  real ( kind = rk ) p2(dim_num)
  real ( kind = rk ), dimension ( dim_num, test_num ) :: p2_test = &
    reshape ( (/ &
    1.0D+00, 2.0D+00, 0.0D+00, &
    1.0D+00, 2.0D+00, 0.0D+00 /), (/ dim_num, test_num /) )
  real ( kind = rk ) q1(dim_num)
  real ( kind = rk ), dimension ( dim_num, test_num ) :: q1_test = &
    reshape ( (/ &
    0.0D+00, 3.0D+00,  3.0D+00, &
    1.0D+00, 2.0D+00, -1.0D+00 /), (/ dim_num, test_num /) )
  real ( kind = rk ) q2(dim_num)
  real ( kind = rk ), dimension ( dim_num, test_num ) :: q2_test = &
    reshape ( (/ &
...
!
  ...
  real ( kind = rk ) a1
  real ( kind = rk ) a2
  real ( kind = rk ), dimension ( test_num ) :: a2_test = (/ &
    1.0D+00, 2.0D+00, -3.0D+00 /)
  real ( kind = rk ) angle
  real ( kind = rk ) b1
  real ( kind = rk ) b2
  real ( kind = rk ), dimension ( test_num ) :: b2_test = (/ &
    -1.0D+00, 4.0D+00, -6.0D+00 /)
  real ( kind = rk ) c1
  real ( kind = rk ) c2
  real ( kind = rk ), dimension ( test_num ) :: c2_test = (/ &
...
!
  ...
  real ( kind = rk ) a1
  real ( kind = rk ), parameter, dimension ( test_num ) :: a1_test = &
    (/  4.0D+00,  2.0D+00, 1.0D+00 /)
  real ( kind = rk ) a2
  real ( kind = rk ), parameter, dimension ( test_num ) :: a2_test = &
    (/  4.0D+00,  4.0D+00, 2.0D+00 /)
  real ( kind = rk ) b1
  real ( kind = rk ), parameter, dimension ( test_num ) :: b1_test = &
    (/ -1.0D+00, -1.0D+00, 2.0D+00 /)
  real ( kind = rk ) b2
  real ( kind = rk ), parameter, dimension ( test_num ) :: b2_test = &
    (/ -1.0D+00, -2.0D+00, 3.0D+00 /)
  real ( kind = rk ) c1
  real ( kind = rk ), parameter, dimension ( test_num ) :: c1_test = &
    (/  3.0D+00,  0.0D+00, 2.0D+00 /)
  real ( kind = rk ) c2 
  real ( kind = rk ), parameter, dimension ( test_num ) :: c2_test = &
...
subroutine minabs_test ( )

!*****************************************************************************80
!
!! minabs_test tests minabs.
!
!  Discussion:
!
...
!
  ...
  real ( kind = rk ), dimension(dim_num) :: p1 = (/ 0.0D+00, 0.0D+00 /)
  real ( kind = rk ), dimension(dim_num) :: p2 = (/ 1.0D+00, 0.0D+00 /)
  real ( kind = rk ), dimension(dim_num) :: p3 = (/ 1.0D+00, 1.0D+00 /)
...
!
  ...
  integer j
  real ( kind = rk ) p(dim_num)
  real ( kind = rk ), dimension(dim_num) :: p1 = (/ 0.2D+00, 0.0D+00 /)
  real ( kind = rk ), dimension(dim_num) :: p2 = (/ 0.4D+00, 0.6D+00 /)
  real ( kind = rk ), dimension(dim_num) :: p3 = (/ 0.6D+00, 0.4D+00 /)
...
!
  ...
  real ( kind = rk ), dimension ( dim_num ) :: p4 = (/ &
    0.0D+00, 0.0D+00, 1.0D+00 /)
  integer test
...
subroutine plane_exp2imp_3d_test ( )

!*****************************************************************************80
!
!! PLANE_EXP2IMP_3D_TEST tests PLANE_EXP2IMP_3D.
!
!  Licensing:
!
!    This code is distributed under the GNU LGPL license. 
...
subroutine plane_exp2normal_3d_test ( )

!*****************************************************************************80
!
!! PLANE_EXP2NORMAL_3D_TEST tests PLANE_EXP2NORMAL_3D.
!
!  Licensing:
!
!    This code is distributed under the GNU LGPL license. 
...
!
  ...
  write ( *, '(a)' ) ''
  write ( *, '(a)' ) 'PLANE_EXP2NORMAL_3D_TEST'
...
!
  ...
  real ( kind = rk ), dimension ( dim_num ) :: p3 = (/ &
    0.0D+00, 0.0D+00, 1.0D+00 /)
  real ( kind = rk ), dimension ( dim_num ) :: pf = (/ &
    0.0D+00, 0.0D+00, 0.0D+00 /)
  real ( kind = rk ), dimension(dim_num,test_num) :: po = reshape ( (/ &
  ...
  real ( kind = rk ) pp(dim_num,test_num)
  integer test
...
!
  ...
  real ( kind = rk ) d
  real ( kind = rk ) dist
  real ( kind = rk ) p(1:dim_num)
  real ( kind = rk ) p1(1:dim_num)
  real ( kind = rk ) p2(1:dim_num)
  real ( kind = rk ), dimension(dim_num,test_num) :: p2_test = reshape ( (/ &
    9.0D+00, 3.0D+00,  8.0D+00, &
    5.0D+00, 1.0D+00, -2.0D+00 /), (/ dim_num, test_num /) )
  real ( kind = rk ) pn(1:dim_num)
  integer test
...
!
  ...
  real ( kind = rk ), dimension(dim_num,3) :: t
  real ( kind = rk ), dimension(dim_num,3,test_num) :: t_test = reshape ( (/ &
...
!
  ...
  real ( kind = rk ), dimension(dim_num) :: normal
  real ( kind = rk ), dimension(dim_num) :: pp
  real ( kind = rk ), dimension(dim_num) :: pq
  real ( kind = rk ), dimension(dim_num) :: pr
  integer test
  ...
  do test = 1, test_num
    ...
    call random_number ( harvest = normal(1:dim_num) )
    call random_number ( harvest = pp(1:dim_num) )
...
!
  ...
  real ( kind = rk ) dif
  integer j
  real ( kind = rk ) normal(m)
  real ( kind = rk ) pp(m)
  real ( kind = rk ) pq(m)
  real ( kind = rk ) pr(m)
  real ( kind = rk ) qr1(m-1,n)
  real ( kind = rk ) qr2(m-1,n)
  real ( kind = rk ) xyz(m,n)
...
!
  call random_number ( harvest = pp(1:m) )

  call random_number ( harvest = normal(1:m) )
!
...
!
  call random_number ( harvest = qr1(1:m-1,1:n) )
...
!
  ...
  do k = 1, 2
    ...
    do i = 0, 6
      ...
      pp(1:3) = normal(1:3) * real ( i, kind = rk ) / 5.0D+00
...
!
  ...
  real ( kind = rk ) d
  real ( kind = rk ), dimension(dim_num) :: normal
  real ( kind = rk ), dimension(dim_num,test_num) :: normal_test = reshape ( (/ &
    -0.2672612D+00, -0.5345225D+00, -0.8017837D+00, &
    -0.2672612D+00, -0.5345225D+00, -0.8017837D+00 /), (/ dim_num, test_num /) )
  real ( kind = rk ), dimension(dim_num) :: pp
  real ( kind = rk ), dimension(dim_num,test_num) :: pp_test = reshape ( (/ &
     -1.0D+00,   0.0D+00, -1.0D+00, &
    -16.0D+00, 2.0D+00, 4.0D+00 /), (/ dim_num, test_num /) )
  integer test
...
subroutine points_centroid_2d_test ( )
...
!
  ...
  real ( kind = rk ), dimension ( dim_num, n ) :: p = reshape ( (/ &
     7.0D+00,  3.0D+00, &
     4.0D+00,  7.0D+00, &
     5.0D+00, 13.0D+00, &
     2.0D+00,  7.0D+00, &
  ...
  write ( *, '(a)' ) ''
  write ( *, '(a)' ) 'points_centroid_2d_test'
...
subroutine points_hull_2d_test ( )

!*****************************************************************************80
!
!! points_hull_2d_test tests points_hull_2d.
!
!  Licensing:
!
!    This code is distributed under the GNU LGPL license. 
...
!
  ...
  integer, parameter :: node_num = 7

  integer hull_num
  real ( kind = rk ) node_xy(2,node_num)
  integer hull(node_num)
  real ( kind = rk ) hull_xy(2,node_num)

  write ( *, '(a)' ) ''
  write ( *, '(a)' ) 'points_hull_2d_test'
...
!
  ...
  do test = 1, test_num
    ...
    xy1(1) = r8_uniform_ab ( b, c )
    xy1(2) = r8_uniform_ab ( b, c )
...
subroutine polygon_area_2d_test ( )

!*****************************************************************************80
!
!! polygon_area_2d_test() tests polygon_area_2d().
!
!  Licensing:
!
!    This code is distributed under the GNU LGPL license. 
...
subroutine polygon_area_3d_test ( )
...
!
  ...
  write ( *, '(a)' ) ''
  write ( *, '(a)' ) 'polygon_area_3d_test():'
  write ( *, '(a)' ) '  polygon_area_3d() computes the area of a polygon in 3D;'
...
subroutine polygon_centroid_3d_test ( )
...
!
  ...
  real ( kind = rk ) centroid(dim_num)
  real ( kind = rk ), dimension (dim_num,n) :: v = reshape ( (/ &
    1.0D+00, 0.0D+00, 0.0D+00, &
    2.0D+00, 1.0D+00, 1.0D+00, &
    1.0D+00, 2.0D+00, 1.0D+00, &
    0.0D+00, 1.0D+00, 0.0D+00 /), (/ dim_num, n /) )
  ...
  write ( *, '(a)' ) ''
  write ( *, '(a)' ) 'polygon_centroid_3d_test():'
...
subroutine polygon_solid_angle_3d_test ( )
...
!
  ...
  write ( *, '(a)' ) ''
  write ( *, '(a)' ) 'polygon_solid_angle_3d_test():'
...
subroutine polyhedron_area_3d_test ( )
...
!
  ...
  integer, parameter :: face_num = 4
  integer, parameter :: dim_num = 3
  integer, parameter :: node_num = 4

  real ( kind = rk ) area
  real ( kind = rk ), parameter :: area_exact = 2.366025D+00
  real ( kind = rk ), dimension ( dim_num, node_num ) :: coord = reshape ( (/ &
    0.0D+00, 0.0D+00, 0.0D+00, &
    1.0D+00, 0.0D+00, 0.0D+00, &
    0.0D+00, 1.0D+00, 0.0D+00, &
  ...
  integer i
  integer j
  integer, dimension(face_num,order_max) :: node = reshape ( (/ &
    3, 1, 1, 2, &
    2, 2, 4, 3, &
    1, 4, 3, 4 /), (/ face_num,order_max /) )
  integer, dimension ( face_num ) :: order = (/ 3, 3, 3, 3 /)

  write ( *, '(a)' ) ''
  write ( *, '(a)' ) 'polyhedron_area_3d_test'
  write ( *, '(a)' ) '  polyhedron_area_3d() computes surface area of a'
  write ( *, '(a)' ) '  polyhedron in 3D.'
  write ( *, '(a)' ) ''
...
subroutine polyhedron_centroid_3d_test ( )
...
!
  ...
  real ( kind = rk ) centroid(dim_num)
  real ( kind = rk ), dimension ( dim_num ) :: centroid_exact = (/ &
    0.25D+00, 0.25D+00, 0.25D+00 /)
  real ( kind = rk ), dimension ( dim_num, node_num ) :: coord = reshape ( (/ &
    0.0D+00, 0.0D+00, 0.0D+00, &
    1.0D+00, 0.0D+00, 0.0D+00, &
  ...
  write ( *, '(a)' ) ''
  write ( *, '(a)' ) 'POLYHEDRON_CENTROID_3D_TEST'
  write ( *, '(a)' ) '  POLYHEDRON_CENTROID_3D computes the centroid of a'
  write ( *, '(a)' ) '  polyhedron in 3D.'
  write ( *, '(a)' ) ''
  write ( *, '(a,i8)' ) '  Number of faces is ', face_num
...
subroutine polyhedron_contains_point_3d_test ( )

!*****************************************************************************80
!
!! polyhedron_contains_point_3d_test() tests polyhedron_contains_point_3d().
!
!  Licensing:
!
!    This code is distributed under the GNU LGPL license. 
...
!
  ...
  integer, parameter :: node_num = 4
  integer, parameter :: test_num = 100

  real ( kind = rk ) c(dim_num+1)
  integer, dimension(face_num) :: face_order = (/ 3, 3, 3, 3 /)
  integer, dimension (face_order_max,face_num) :: face_point = reshape ( (/ &
    1, 2, 4, &
    1, 3, 2, &
    1, 4, 3, &
  ...
  real ( kind = rk ) p(dim_num)
  integer test
  real ( kind = rk ), dimension ( dim_num, node_num ) :: v = reshape ( (/ & 
    0.0D+00, 0.0D+00, 0.0D+00, &
    1.0D+00, 0.0D+00, 0.0D+00, &
    0.0D+00, 1.0D+00, 0.0D+00, &
    0.0D+00, 0.0D+00, 1.0D+00 /), (/ dim_num, node_num /) )
  ...
  write ( *, '(a)' ) ''
  write ( *, '(a)' ) 'polyhedron_contains_point_3d_test'
  ...
  do test = 1, test_num
    ...
    call random_number ( harvest = p(1:dim_num) )
...
!
  ...
  integer, dimension(face_num,order_max) :: node = reshape ( (/ &
    ...
    1, 4, 3, 4 /), (/ face_num,order_max /) )
  integer, dimension ( face_num ) :: order = (/ 3, 3, 3, 3 /)
  real ( kind = rk ) :: volume_exact = 1.0D+00 / 6.0D+00
...
subroutine polyline_points_nd_test ( )
...
!
  ...
  real ( kind = rk ), dimension(dim_num,nk) :: pk = reshape ( (/ &
    0.0D+00, 1.0D+00, &
    0.0D+00, 0.0D+00, &
    1.0D+00, 0.0D+00, &
  ...
  write ( *, '(a)' ) ''
  write ( *, '(a)' ) 'polyline_points_nd_test'
...
subroutine polyloop_arclength_nd_test ( )

!*****************************************************************************80
!
!! polyloop_arclength_nd_test tests polyloop_arclength_nd.
!
!  Licensing:
!
!    This code is distributed under the GNU LGPL license. 
...
!
  ...
  write ( *, '(a)' ) ''
  write ( *, '(a)' ) 'polyloop_arclength_nd_test'
...
subroutine polyloop_points_nd_test ( )

!*****************************************************************************80
!
!! polyloop_points_nd_test tests polyloop_points_nd.
!
!  Licensing:
!
!    This code is distributed under the GNU LGPL license. 
...
!
  ...
  write ( *, '(a)' ) ''
  write ( *, '(a)' ) 'polyloop_points_nd_test'
...
!
  ...
  real ( kind = rk ), dimension(m,n) :: base = reshape ( (/ &
    4.0D+00, 3.0D+00, 2.0D+00, 1.0D+00, &
    1.0D+00, 2.0D+00, 3.0D+00, 4.0D+00 /), (/ m, n /) )
  real ( kind = rk ), dimension ( m ) :: vecm = (/ &
...
!
  ...
  real ( kind = rk ) area
  real ( kind = rk ), dimension(2,4) :: q = reshape ( (/ &
    0.0D+00, 0.0D+00, &
    1.0D+00, 0.0D+00, &
    1.0D+00, 1.0D+00, &
    0.0D+00, 1.0D+00 /), (/ 2, 4 /) )
...
!
  ...
  real ( kind = rk ) area1
  real ( kind = rk ) area2
  real ( kind = rk ), dimension(3,4) :: q = reshape ( (/ &
    2.0D+00, 2.0D+00, 0.0D+00, &
    0.0D+00, 0.0D+00, 0.0D+00, &
    1.0D+00, 1.0D+00, 1.0D+00, &
...
!
  ...
  real ( kind = rk ), dimension(dim_num,4) :: q = reshape ( (/ &
    0.0D+00, 0.0D+00, &
    1.0D+00, 0.0D+00, &
    1.0D+00, 1.0D+00, &
...
!
  ...
  real ( kind = rk ), dimension ( test_num ) :: x_test = (/ &
    ...
    -1.0D+00, -1.0D+00, 0.0D+00 /)
  real ( kind = rk ) y
  real ( kind = rk ), dimension ( test_num ) :: y_test = (/ &
...
!
  ...
  write ( *, '(a)' ) ''
  write ( *, '(a)' ) 'TEST1787'
  write ( *, '(a)' ) '  R8GE_FA factors a general linear system,'
...
!
  ...
  integer, parameter :: n = 3
  integer, parameter :: rhs_num = 2

  real ( kind = rk ), dimension (n,n+rhs_num) :: a = reshape ( (/ &
...
subroutine r8vec_any_normal_test ( )

!*****************************************************************************80
!
!! r8vec_any_normal_test tests r8vec_any_normal_test.
!
!  Licensing:
!
!    This code is distributed under the GNU LGPL license. 
...
!
  ...
  integer, parameter :: dim_num = 10
  integer, parameter :: test_num = 5

  real ( kind = rk ) r8vec_norm
  integer test
  real ( kind = rk ) v1(dim_num)
  real ( kind = rk ) v1_length
  real ( kind = rk ) v1v2_dot
  real ( kind = rk ) v2(dim_num)
  real ( kind = rk ) v2_length

  write ( *, '(a)' ) ''
  write ( *, '(a)' ) 'r8vec_any_normal_test'
  ...
  do test = 1, test_num
    ...
    call random_number ( harvest = v1(1:dim_num) )
...
!
  ...
  do test = 1, test_num
    call r8vec_uniform_unit ( dim_num, vran )
    write ( *, '(2x,4f8.4)' ) vran(1:dim_num)
  end do

  return
end
subroutine radec_distance_3d_test ( )

!*****************************************************************************80
!
!! radec_distance_3d_test tests radec_distance_3d.
!
!  Licensing:
!
!    This code is distributed under the GNU LGPL license. 
...
!
  ...
  integer test2
  real ( kind = rk ) theta
  real ( kind = rk ) theta_deg

  write ( *, '(a)' ) ''
  write ( *, '(a)' ) 'radec_distance_3d_test'
...
!
  ...
  write ( *, '(a)' ) ''
  write ( *, '(a)' ) 'radec_to_xyz_test'
  write ( *, '(a)' ) '  radec_to_xyz() converts RADEC to XYZ coordinates.'
  write ( *, '(a)' ) ''
...
subroutine radians_to_degrees_test ( )
...
!
  ...
  write ( *, '(a)' ) ''
  write ( *, '(a)' ) 'radians_to_degrees_test'
...
subroutine radians_to_dms_test ( )
...
!
  ...
  write ( *, '(a)' ) ''
  write ( *, '(a)' ) 'radians_to_dms_test'
  write ( *, '(a)' ) '  radians_to_dms() converts an angle from radians'
  write ( *, '(a)' ) '  to degrees/minutes/seconds;'
  write ( *, '(a)' ) ''
  write ( *, '(a)' ) '  Radians     DMS     Radians'
  write ( *, '(a)' ) ''
...
!
  ...
  do test = 1, test_num
    ...
    call r8vec_uniform_ab ( 3, a, b, xyz1 )
...
subroutine segment_contains_point_1d_test ( )

!*****************************************************************************80
!
!! segment_contains_point_1d_test tests segment_contains_point_1d.
!
!  Licensing:
!
!    This code is distributed under the GNU LGPL license. 
...
!
  ...
  real ( kind = rk ) p1
  real ( kind = rk ), dimension ( test_num ) :: p1_test = (/ &
    2.0D+00,  10.0D+00,  8.0D+00, 88.0D+00 /)
  real ( kind = rk ) p2
  real ( kind = rk ), dimension ( test_num ) :: p2_test = (/ &
    6.0D+00, -10.0D+00, 10.0D+00, 88.0D+00 /)
  real ( kind = rk ) t
  integer test

  write ( *, '(a)' ) ''
  write ( *, '(a)' ) 'segment_contains_point_1d_test'
...
subroutine segment_point_coords_2d_test ( )

!*****************************************************************************80
!
!! segment_point_coords_2d_test tests segment_point_coords_2d.
!
!  Licensing:
!
!    This code is distributed under the GNU LGPL license. 
...
!
  ...
  real ( kind = rk ) p2(dim_num)
  real ( kind = rk ) s
  real ( kind = rk ), dimension ( test_num ) :: s_test = (/ &
    0.0D+00, 0.0D+00, 0.0D+00, 99.0D+00, 2.0D+00, 4.0D+00 /)
  real ( kind = rk ) t
  real ( kind = rk ), dimension ( test_num ) :: t_test = (/ &
  ...
  write ( *, '(a)' ) ''
  write ( *, '(a)' ) 'segment_point_coords_2d_test'
...
subroutine segment_point_dist_2d_test ( )
...
!
  ...
  write ( *, '(a)' ) ''
  write ( *, '(a)' ) 'segment_point_dist_2d_test'
  write ( *, '(a)' ) '  segment_point_dist_2d() computes the distance'
  write ( *, '(a)' ) '  between a line segment and point in 2D.'

  do test = 1, test_num

    call random_number ( harvest = p1(1:dim_num) )
    call random_number ( harvest = p2(1:dim_num) )
    call random_number ( harvest = p(1:dim_num) )
...
subroutine segment_point_dist_3d_test ( )
...
!
  ...
  write ( *, '(a)' ) ''
  write ( *, '(a)' ) 'segment_point_dist_3d_test'
...
subroutine segment_point_near_2d_test ( )
...
!
  ...
  write ( *, '(a)' ) ''
  write ( *, '(a)' ) 'segment_point_near_2d_test'
...
subroutine segment_point_near_3d_test ( )
...
!
  ...
  real ( kind = rk ), dimension(dim_num) :: p1 = (/ 2.0D+00, 3.0D+00, 0.0D+00 /)
  real ( kind = rk ), dimension(dim_num) :: p2 = (/ 8.0D+00, 6.0D+00, 0.0D+00 /)
  real ( kind = rk ) pn(dim_num)
  real ( kind = rk ) t
  integer test

  write ( *, '(a)' ) ''
  write ( *, '(a)' ) 'segment_point_near_3d_test'
...
subroutine segments_curvature_2d_test ( )

!*****************************************************************************80
!
!! segments_curvature_2d_test tests segments_curvature_2d.
!
!  Licensing:
!
!    This code is distributed under the GNU LGPL license. 
...
!
  ...
  write ( *, '(a)' ) ''
  write ( *, '(a)' ) 'segments_curvature_2d_test'
  ...
  do test = 1, test_num
    ...
    theta = 2.0D+00 * pi * real ( test     - 1, kind = rk ) &
                         / real ( test_num - 1, kind = rk )
...
subroutine segments_dist_2d_test ( )

!*****************************************************************************80
!
!! segments_dist_2d_test tests segments_dist_2d.
!
!  Discussion:
!
...
subroutine segments_dist_3d_test ( )

!*****************************************************************************80
!
!! segments_dist_3d_test tests segments_dist_3d.
!
!  Licensing:
!
!    This code is distributed under the GNU LGPL license. 
...
subroutine segments_int_1d_test ( )

!*****************************************************************************80
!
!! segments_int_1d_test tests segments_int_1d.
!
!  Licensing:
!
!    This code is distributed under the GNU LGPL license. 
...
subroutine segments_int_2d_test ( )

!*****************************************************************************80
!
!! segments_int_2d_test tests segments_int_2d.
!
!  Licensing:
!
!    This code is distributed under the GNU LGPL license. 
...
!
  ...
  integer flag
  real ( kind = rk ), dimension ( dim_num ) :: p1 = (/ -1.0D+00, 3.0D+00 /)
  real ( kind = rk ), dimension ( dim_num ) :: p2 = (/  1.0D+00, 1.0D+00 /)
  real ( kind = rk ) q1(dim_num)
  real ( kind = rk ), dimension ( dim_num, test_num ) :: q1_test = reshape ( (/ &
    -1.0D+00,  1.0D+00, &
     3.0D+00, -1.0D+00, &
     0.0D+00,  0.0D+00, &
     1.0D+00,  2.0D+00 /), (/ dim_num, test_num /) )
  real ( kind = rk ) q2(dim_num)
  real ( kind = rk ), dimension ( dim_num, test_num ) :: q2_test = reshape ( (/ &
    1.0D+00, -1.0D+00, &
    2.0D+00,  0.0D+00, &
    0.0D+00,  9.0D+00, &
...
!
  ...
  logical more
  integer n
  integer :: n_test(test_num) = (/ 1, 2, 3, 4 /)
  integer test
...
subroutine simplex_lattice_point_next_test ( )

!*****************************************************************************80
!
!! simplex_lattice_point_next_test tests simplex_lattice_point_next.
!
!  Licensing:
!
!    This code is distributed under the GNU LGPL license. 
...
!
  ...
  write ( *, '(a)' ) ''
  write ( *, '(a)' ) 'simplex_lattice_point_next_test'
...
!*****************************************************************************80
!
!! TEST1804 tests SIMPLEX01_LATTICE_POINT_NUM_ND.
!
!  Licensing:
!
!    This code is distributed under the GNU LGPL license. 
...
!
  ...
  integer dim_num
  integer, dimension ( test_num ) :: dim_num_test = (/ &
    2, 2, 2, 2, 3, 3, 3, 3, 4, 5, 6 /)
  integer t
  integer, dimension ( test_num ) :: t_test = (/ &
  ...
  write ( *, '(a)' ) '  SIMPLEX01_LATTICE_POINT_NUM_ND computes the lattice volume,'
  ...
  do test = 1, test_num
    ...
    t = t_test(test)
    call simplex01_lattice_point_num_nd ( dim_num, t, volume )
...
!
  ...
  do test = 0, test_num
    ...
    h = 2.0D+00 * r * real ( test, kind = rk ) / real ( test_num, kind = rk )
...
subroutine sphere_cap_volume_2d_test ( )

!*****************************************************************************80
!
!! sphere_cap_volume_2d_test tests SPHERE_CAP_VOLUME_2D.
!
!  Licensing:
!
!    This code is distributed under the GNU LGPL license. 
...
!
  ...
  write ( *, '(a)' ) ''
  write ( *, '(a)' ) 'sphere_cap_volume_2d_test'
  ...
  do test = 0, test_num
    ...
    write ( *, '(2x,6f12.6)' ) theta1, theta2, h, volume1, volume2
...
!
  ...
  character ( len = 18 ), dimension ( test_num ) :: name = (/ &
    ...
    'San Antonio, Texas', &
    'Savannah, Georgia ' /)
  integer, dimension ( test_num ) :: lat_d =  (/ 33, 90, -90, 16, 29, 32 /)
  integer, dimension ( test_num ) :: lat_m =  (/ 11,  0,   0, 49, 25,  5 /)
  integer, dimension ( test_num ) :: long_d = (/ 82,  0,   0,  3, 98, 81 /)
  integer, dimension ( test_num ) :: long_m = (/ 34,  0,   0,  0, 30,  6 /)
  real ( kind = rk ) lat1
  real ( kind = rk ) lat2
  real ( kind = rk ) long1
  real ( kind = rk ) long2
  real ( kind = rk ), parameter :: radius = 3957.0D+00
  integer test1
  integer test2
...
subroutine sphere_dia2imp_3d_test ( )
...
!
  ...
  write ( *, '(a)' ) ''
  write ( *, '(a)' ) 'sphere_dia2imp_3d_test'
...
subroutine sphere_exp2imp_nd_test ( )
...
!
  ...
  real ( kind = rk ), dimension (n,n+1) :: p = reshape ( (/ &
    4.0D+00, 2.0D+00, 3.0D+00, &
    1.0D+00, 5.0D+00, 3.0D+00, &
    1.0D+00, 2.0D+00, 6.0D+00, &
   -2.0D+00, 2.0D+00, 3.0D+00 /), (/ n, n + 1 /) )
  real ( kind = rk ) pc(n)
  real ( kind = rk ), dimension ( n ) :: pc_true = (/ &
    1.0D+00, 2.0D+00, 3.0D+00 /)
  real ( kind = rk ) r
  real ( kind = rk ) :: r_true = 3.0D+00

  write ( *, '(a)' ) ''
  write ( *, '(a)' ) 'sphere_exp2imp_nd_test'
...
subroutine sphere_imp_point_project_3d_test ( )

!*****************************************************************************80
!
!! sphere_imp_point_project_3d_test tests sphere_imp_point_project_3d.
!
!  Licensing:
!
!    This code is distributed under the GNU LGPL license. 
...
!
  ...
  write ( *, '(a)' ) ''
  write ( *, '(a)' ) 'sphere_imp_point_project_3d_test'
...
!
  ...
  write ( *, '(a)' ) ''
  write ( *, '(a)' ) 'TEST189'
  write ( *, '(a)' ) '  SPHERE_IMP_AREA_ND computes the area of a sphere in ND;'
  write ( *, '(a)' ) '  SPHERE_IMP_VOLUME_ND computes the volume of a sphere in ND.'
  write ( *, '(a)' ) ''
...
!*****************************************************************************80
!
!! TEST1895 tests SPHERE01_AREA_ND and SPHERE01_AREA_VALUES.
!
!  Licensing:
!
!    This code is distributed under the GNU LGPL license. 
...
!
  ...
  write ( *, '(a)' ) ''
  write ( *, '(a)' ) 'TEST1895:'
  write ( *, '(a)' ) '  SPHERE01_AREA_ND evaluates the area of the unit'
  write ( *, '(a)' ) '  sphere in N dimensions.'
  write ( *, '(a)' ) '  SPHERE01_AREA_VALUES returns some test values.'
  write ( *, '(a)' ) ''
  ...
  do
    ...
    call sphere01_area_values ( n_data, dim_num, area )
...
subroutine sphere01_sample_2d_test ( )
...
!
  ...
  write ( *, '(a)' ) ''
  write ( *, '(a)' ) 'sphere01_sample_2d_test'
  write ( *, '(a)' ) '  sphere01_sample_2d() samples the unit sphere'
  write ( *, '(a)' ) '  in 2D (the circle);'
  ...
  do j = 1, 5
    ...
    dot_average = dot_average / real ( sample_num, kind = rk )
...
subroutine sphere01_sample_3d_test ( )
...
!
  ...
  write ( *, '(a)' ) ''
  write ( *, '(a)' ) 'sphere01_sample_3d_test'
  write ( *, '(a)' ) '  sphere01_sample_3d() samples the unit sphere in 3D.'
...
!*****************************************************************************80
!
!! TEST192 tests SPHERE01_SAMPLE_3D_2.
!
!  Licensing:
!
!    This code is distributed under the GNU LGPL license. 
...
!
  ...
  write ( *, '(a)' ) '  SPHERE01_SAMPLE_3D_2 samples;'
  write ( *, '(a)' ) ''
  write ( *, '(a)' ) '  Warning: SPHERE01_SAMPLE_3D_2 is NOT a good code!'
...
!*****************************************************************************80
!
!! TEST193 tests SPHERE01_SAMPLE_ND.
!
!  Licensing:
!
!    This code is distributed under the GNU LGPL license. 
...
!
  ...
  write ( *, '(a)' ) '  SPHERE01_SAMPLE_ND samples;'
  ...
  do i = 1, 5
    call sphere01_sample_nd ( dim_num, x )
    write ( *, '(2x,3f8.4)' ) x(1:dim_num)
  end do
  ...
  do j = 1, 5
    ...
    call sphere01_sample_nd ( dim_num, v )
...
!*****************************************************************************80
!
!! TEST194 tests SPHERE01_SAMPLE_ND_2.
!
!  Licensing:
!
!    This code is distributed under the GNU LGPL license. 
...
!
  ...
  write ( *, '(a)' ) 'TEST194'
  write ( *, '(a)' ) '  For the unit sphere in N dimensions:'
  write ( *, '(a)' ) '  SPHERE01_SAMPLE_ND_2 samples;'
  ...
  do i = 1, 5
    call sphere01_sample_nd_2 ( dim_num, x )
    write ( *, '(2x,3f8.4)' ) x(1:dim_num)
  end do
  ...
  do j = 1, 5
    ...
    call sphere01_sample_nd_2 ( dim_num, v )
...
!*****************************************************************************80
!
!! TEST195 tests SPHERE01_SAMPLE_ND_3.
!
!  Licensing:
!
!    This code is distributed under the GNU LGPL license. 
...
!
  ...
  write ( *, '(a)' ) 'TEST195'
  write ( *, '(a)' ) '  For the unit sphere in N dimensions:'
  write ( *, '(a)' ) '  SPHERE01_SAMPLE_ND_3 samples;'
  ...
  do i = 1, 5
    call sphere01_sample_nd_3 ( dim_num, x )
    write ( *, '(2x,3f8.4)' ) x(1:dim_num)
  end do
  ...
  do j = 1, 5
    ...
    call sphere01_sample_nd_3 ( dim_num, v )
...
!*****************************************************************************80
!
!! TEST1955 tests SPHERE01_VOLUME_ND and SPHERE01_VOLUME_VALUES.
!
!  Licensing:
!
!    This code is distributed under the GNU LGPL license. 
...
!
  ...
  write ( *, '(a)' ) ''
  write ( *, '(a)' ) 'TEST1955:'
  write ( *, '(a)' ) '  SPHERE01_VOLUME_ND evaluates the area of the unit'
  write ( *, '(a)' ) '  sphere in N dimensions.'
  write ( *, '(a)' ) '  SPHERE01_VOLUME_VALUES returns some test values.'
  write ( *, '(a)' ) ''
  write ( *, '(a)' ) '     DIM_NUM    Exact          Computed'
  ...
  do
    ...
    call sphere01_volume_values ( n_data, dim_num, volume )
...
!
  ...
  real ( kind = rk ) dist
  real ( kind = rk ) p(1:dim_num)
  real ( kind = rk ),dimension ( dim_num ) :: p1 = (/ 5.0D+00, 0.0D+00 /)
  real ( kind = rk ), dimension ( dim_num ) :: pc = (/ 3.0D+00, 0.0D+00 /)
  real ( kind = rk ), dimension (dim_num,test_num) :: p_test = reshape ( (/ &
     3.0D+00,  0.0D+00, &
     5.0D+00,  0.0D+00, &
     4.0D+00,  0.0D+00, &
...
!
  ...
  real ( kind = rk ) dist
  real ( kind = rk ) p(1:dim_num)
  real ( kind = rk ), dimension(1:dim_num,test_num) :: p_test = &
    reshape ( (/ &
     3.0D+00, 0.0D+00, &
     5.0D+00, 0.0D+00, &
     4.0D+00, 0.0D+00, &
...
!
  ...
  real ( kind = rk ), dimension ( dim_num ) :: p1 = (/ 5.0D+00, 0.0D+00 /)
  real ( kind = rk ) pa(dim_num)
  real ( kind = rk ), dimension(dim_num,test_num) :: pa_test = reshape ( (/ &
    3.0D+00,  0.0D+00, &
    3.0D+00,  0.0D+00, &
    3.0D+00, -1.0D+00, &
    3.0D+00, -1.0D+00 /), (/ dim_num, test_num /) )
  real ( kind = rk ) pb(dim_num)
  real ( kind = rk ), dimension(dim_num,test_num) :: pb_test = reshape ( (/ &
    4.0D+00,  0.0D+00, &
    3.0D+00,  1.0D+00, &
    3.0D+00,  1.0D+00, &
...
subroutine sphere_triangle_sides_to_angles_test ( )
...
!
  ...
  real ( kind = rk ) cs
  real ( kind = rk ) degrees_to_radians
  real ( kind = rk ), parameter :: r = 10.0D+00
  real ( kind = rk ) radians_to_degrees

  write ( *, '(a)' ) ''
  write ( *, '(a)' ) 'SPHERE_TRIANGLE_SIDES_TO_ANGLES_TEST'
...
!
  ...
  integer, parameter :: dim_num = 2
  integer, parameter :: vec_num = 15

  integer i
  integer jstrng
  integer order(vec_num)
  real ( kind = rk ), dimension ( dim_num, vec_num ) :: p1 = reshape ( (/ &
    0.0D+00, 0.0D+00, &
    3.0D+00, 4.0D+00, &
    2.0D+00, 2.0D+00, &
    3.0D+00, 2.0D+00, &
  ...
  real ( kind = rk ), dimension ( dim_num, vec_num ) :: p2 = reshape ( (/ &
    1.0D+00, 1.0D+00, &
    2.0D+00, 4.0D+00, &
    1.0D+00, 3.0D+00, &
    2.0D+00, 3.0D+00, &
...
subroutine tetrahedron_centroid_3d_test ( )

!*****************************************************************************80
!
!! tetrahedron_centroid_3d_test tests tetrahedron_centroid_3d;
!
!  Licensing:
!
!    This code is distributed under the GNU LGPL license. 
...
!
  ...
  write ( *, '(a)' ) ''
  write ( *, '(a)' ) 'tetrahedron_centroid_3d_test'
  write ( *, '(a)' ) '  tetrahedron_centroid_3d() computes the centroid'
  write ( *, '(a)' ) '  of a tetrahedron in 3D.'
...
subroutine tetrahedron_circumsphere_3d_test ( )

!*****************************************************************************80
!
!! tetrahedron_circumsphere_3d_test tests tetrahedron_circumsphere_3d;
!
!  Licensing:
!
!    This code is distributed under the GNU LGPL license. 
...
!
  ...
  write ( *, '(a)' ) ''
  write ( *, '(a)' ) 'tetrahedron_circumsphere_3d_test'
...
subroutine tetrahedron_volume_3d_test ( )

!*****************************************************************************80
!
!! tetrahedron_volume_3d_test() tests tetrahedron_volume_3d().
!
!  Licensing:
!
!    This code is distributed under the GNU LGPL license. 
...
!
  ...
  write ( *, '(a)' ) ''
  write ( *, '(a)' ) 'tetrahedron_volume_3d_test():'
...
!
  ...
  character ( len = 2 ) axis2
  real ( kind = rk ) b(4,4)
  real ( kind = rk ), dimension ( dim_num, n ) :: point = reshape ( (/ &
    1.0D+00, 0.0D+00, 0.0D+00, &
    0.0D+00, 1.0D+00, 0.0D+00, &
    0.0D+00, 0.0D+00, 1.0D+00, &
    1.0D+00, 1.0D+00, 1.0D+00 /), (/ dim_num, n /) )
  real ( kind = rk ) point2(dim_num,n)
  real ( kind = rk ) s
  real ( kind = rk ) v(1:3)
...
!
  ...
  integer i
  real ( kind = rk ) radians_to_degrees
  real ( kind = rk ), dimension ( dim_num, 3 ) :: t = reshape ( (/ &
    0.0D+00, 1.0D+00, &
    0.0D+00, 0.0D+00, &
...
!
  ...
  real ( kind = rk ) pc(m)
  real ( kind = rk ) t(m,3)
  real ( kind = rk ), dimension(m,3,test_num) :: t_test = reshape ( (/ &
         10.0D+00,  5.0D+00, &
         11.0D+00,  5.0D+00, &
         10.0D+00,  6.0D+00, &
         10.0D+00,  5.0D+00, &
...
!
  ...
  real ( kind = rk ), allocatable :: a12(:,:)
  integer j
  integer m2
  real ( kind = rk ), allocatable :: o1(:)
  real ( kind = rk ), allocatable :: o2(:)
  real ( kind = rk ), allocatable :: pc2(:)
  real ( kind = rk ) r8vec_norm_affine
  real ( kind = rk ) t1(m1,3)
  real ( kind = rk ), allocatable :: t2(:,:)
  real ( kind = rk ), dimension(m1,3,test_num) :: t_test = reshape ( (/ &
         10.0D+00,  5.0D+00, &
         11.0D+00,  5.0D+00, &
         10.0D+00,  6.0D+00, &
         10.0D+00,  5.0D+00, &
...
!
    call random_number ( harvest = a12(1:m2,1:m1) )
    call random_number ( harvest = o1(1:m1) )
    call random_number ( harvest = o2(1:m2) )
!
...
!
  ...
  logical inside
  real ( kind = rk ) norm
  real ( kind = rk ), dimension(dim_num) :: p0 = (/ &
    3.0D+00, 0.0D+00, -7.0D+00 /)
  real ( kind = rk ), dimension(dim_num) :: pd = (/ &
...
!
  ...
  real ( kind = rk ), dimension ( dim_num, 3 ) :: t = reshape ( (/ &
    ...
    0.0D+00, 0.0D+00, &
    1.0D+00, 0.0D+00 /), (/ dim_num, 3 /) )
  real ( kind = rk ), dimension ( dim_num, 3 ) :: t2
  integer test
...
!
  ...
  write ( *, '(a)' ) '  from a point to a triangle in 2D;'
...
!
  ...
  write ( *, '(a)' ) '  distance from a point to a triangle in 2D;'
...
!
  ...
  write ( *, '(a)' ) '  from a point to a triangle in 3D;'
...
!
  ...
  write ( *, '(a)' ) ''
  write ( *, '(a)' ) 'TEST2115'
  write ( *, '(a)' ) '  TRIANGLE_QUALITY_2D computes the quality of a triangle.'
...
!
  ...
  integer nhi
  integer nlo
  integer, dimension ( test_num ) :: n_test = (/ 4, 5, 5, 5 /)
  real ( kind = rk ), allocatable, dimension(:,:) :: p
  real ( kind = rk ), dimension ( dim_num, 19 ) :: p_test = reshape ( (/ &
     0.0D+00,  0.0D+00, &
     4.0D+00,  3.0D+00, &
     4.0D+00,  0.0D+00, &
     0.0D+00,  0.0D+00, &
  ...
  real ( kind = rk ), allocatable, dimension(:,:) :: p1
  real ( kind = rk ), allocatable, dimension(:,:) :: p2
  integer test

  write ( *, '(a)' ) ''
  write ( *, '(a)' ) 'tube_2d_test'
...
!
  ...
  real ( kind = rk ) angle_degrees(dim_num)
  integer j
  real ( kind = rk ) radians_to_degrees
  integer test
  real ( kind = rk ) v(dim_num)
  real ( kind = rk ), dimension(dim_num,test_num) :: v_test = reshape ( (/ &
     1.0D+00,        0.0D+00, &
...
subroutine vector_directions_nd_test ( )
...
!
  ...
  write ( *, '(a)' ) ''
  write ( *, '(a)' ) 'vector_directions_nd_test'
  write ( *, '(a)' ) '  vector_directions_nd() computes the angles'
  write ( *, '(a)' ) '  that a vector makes with the axes.'
  write ( *, '(a)' ) ''
...
subroutine vector_rotate_2d_test ( )
...
subroutine vector_rotate_3d_test ( )
...
!
  ...
  integer test
  real ( kind = rk ) v1(dim_num)
  real ( kind = rk ), dimension(dim_num,test_num) :: v1_test = reshape ( (/ &
    1.0D+00,  0.0D+00,  0.0D+00, &
    0.0D+00,  2.0D+00,  0.0D+00, &
    0.0D+00,  0.0D+00,  3.0D+00, &
    1.0D+00,  1.0D+00,  1.0D+00, &
...
subroutine vector_rotate_base_2d_test ( )
...
!
  ...
  real ( kind = rk ) p1(dim_num)
  real ( kind = rk ) p2(dim_num)
  real ( kind = rk ), dimension(dim_num) :: pb = (/ 10.0D+00, 5.0D+00 /)
  real ( kind = rk ), dimension ( dim_num, test_num ) :: p_test = reshape ( (/ &
    11.0D+00, 5.0D+00, &
    10.0D+00, 7.0D+00, &
    11.0D+00, 6.0D+00, &
  ...
  write ( *, '(a)' ) ''
  write ( *, '(a)' ) 'vector_rotate_base_2d_test'
...
subroutine vector_separation_nd_test ( )
...
!
  ...
  write ( *, '(a)' ) ''
  write ( *, '(a)' ) 'vector_separation_nd_test'
  write ( *, '(a)' ) '  vector_separation_nd() computes the separation angle'
...
subroutine voxels_dist_l1_nd_test ( )
...
!
  ...
  integer dist
  integer, dimension(dim_num) :: p1 = (/ 1, 1, 5 /)
  integer, dimension(dim_num) :: p2 = (/ 9, 4, 4 /)
  integer voxels_dist_l1_nd

  write ( *, '(a)' ) ''
  write ( *, '(a)' ) 'VOXELS_DIST_L1_ND_TEST'
  write ( *, '(a)' ) '  VOXELS_DIST_L1_ND prints the voxels on a line in ND.'
...
subroutine voxels_line_3d_test ( )
...
subroutine voxels_region_3d_test ( )
...
!
  ...
  integer, parameter :: list_max = 100
  integer, parameter :: dim_num = 3
...
subroutine voxels_step_3d_test ( )
...
subroutine wedge01_volume_test ( )
...
!
  ...
  write ( *, '(a)' ) ''
  write ( *, '(a)' ) 'WEDGE01_VOLUME_TEST'
  write ( *, '(a)' ) '  WEDGE01_VOLUME returns the volume of the unit wedge.'

  volume = wedge01_volume ( )

  write ( *, '(a)' ) ''
  write ( *, '(a,g14.6)' ) '  Unit wedge volume = ', volume

  return
end
subroutine xy_to_polar_test ( )
...
subroutine xyz_to_radec_test ( )

!*****************************************************************************80
!
!! xyz_to_radec_test tests xyz_to_radec.
!
!  Licensing:
!
!    This code is distributed under the GNU LGPL license. 
...
!
  ...
  write ( *, '(a)' ) ''
  write ( *, '(a)' ) 'xyz_to_radec_test'
  write ( *, '(a)' ) '  xyz_to_radec() converts XYZ to RADEC coordinates.'
  write ( *, '(a)' ) ''
  write ( *, '(a)' ) '          P1          RA     DEC           P2'
  write ( *, '(a)' ) ''
...
subroutine xyz_to_rtp_test ( )

!*****************************************************************************80
!
!! xyz_to_rtp_test tests xyz_to_rtp.
!
!  Licensing:
!
!    This code is distributed under the GNU LGPL license. 
